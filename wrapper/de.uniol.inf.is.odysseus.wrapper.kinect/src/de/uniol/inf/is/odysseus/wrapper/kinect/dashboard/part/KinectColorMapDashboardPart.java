 ...
 * {@link KinectColorMap} in the stream.
 * @author Juergen Boger <juergen.boger@offis.de>
 */
public class KinectColorMapDashboardPart extends AbstractDashboardPart
    ...
    public void onStart(Collection<IPhysicalOperator> physicalRoots) throws Exception {
        for (IPhysicalOperator po : physicalRoots) {
            ...
            this.colorMapPos = -1;
            final SDFAttribute colorMapAttribute = schema
                    .findAttribute("colorMap");
    ...
    public void paintControl(PaintEvent e) {
        ...
        ImageData imgData = colorMap.getImageData();
