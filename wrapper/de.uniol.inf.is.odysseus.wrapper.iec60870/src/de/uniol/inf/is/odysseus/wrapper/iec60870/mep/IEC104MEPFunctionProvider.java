...
public class IEC104MEPFunctionProvider implements IFunctionProvider {
	 ...
	 */
	private static final IMepFunction<?>[] functions = new IMepFunction[] { new Get104ElementSequences(), new Get104TimeTag(), new Set104TimeTag(), new Transform104TimeTagToLong() };
