...
// TODO javaDoc
public class Split104ElementSequence extends AbstractFunction<Tuple<IMetaAttribute>> {

	private static final long serialVersionUID = -8607532470847864479L;

	private static final Logger logger = LoggerFactory.getLogger(Split104ElementSequence.class);

	/**
	 * The name of the MEP function to be used in query languages.
	 */
	private static final String name = Split104ElementSequence.class.getSimpleName();
	 ...
	 */
	public Split104ElementSequence() {
