...
// TODO javaDoc
public class Transform104TimeTagToLong extends AbstractFunction<Long> {

	private static final long serialVersionUID = -2969523156697135666L;

	private static final Logger logger = LoggerFactory.getLogger(Transform104TimeTagToLong.class);

	/**
	 * The name of the MEP function to be used in query languages.
	 */
	private static final String name = Transform104TimeTagToLong.class.getSimpleName();
	 ...
	 */
	public Transform104TimeTagToLong() {
...
//		int century = (int) getInputValue(2);
		...
		if(tt == null) {
			...
			return tt.getTimestamp(TimeZone.getDefault(), 2000);//tz, century);
		}
	}
