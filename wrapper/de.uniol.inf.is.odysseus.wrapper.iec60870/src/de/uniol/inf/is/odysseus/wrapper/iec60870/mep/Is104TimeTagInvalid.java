...
// TODO javaDoc
public class Is104TimeTagInvalid extends AbstractFunction<Boolean> {

	private static final long serialVersionUID = 4706634085890905150L;

	private static final Logger logger = LoggerFactory.getLogger(Is104TimeTagInvalid.class);

	/**
	 * The name of the MEP function to be used in query languages.
	 */
	private static final String name = Is104TimeTagInvalid.class.getSimpleName();
	...
	public Boolean getValue() {
		...
		if (tt instanceof ThreeOctetBinaryTime) {
			return ((ThreeOctetBinaryTime) tt).isInvalid();
		} else {
			return null;
		}
	}
