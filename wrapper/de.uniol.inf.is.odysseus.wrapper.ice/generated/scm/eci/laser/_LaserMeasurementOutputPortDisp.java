...
public abstract class _LaserMeasurementOutputPortDisp extends Ice.ObjectImpl implements LaserMeasurementOutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::laser::LaserMeasurementOutputPort",
    ...
    ___send(LaserMeasurementOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        LaserMeasurementHolder msg = new LaserMeasurementHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::laser::LaserMeasurementOutputPort was not generated with stream support";
        throw ex;
    }
