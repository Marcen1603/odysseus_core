...
public abstract class _RangeValueOutputPortDisp extends Ice.ObjectImpl implements RangeValueOutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::laser::RangeValueOutputPort",
    ...
    ___send(RangeValueOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        RangeValueHolder msg = new RangeValueHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::laser::RangeValueOutputPort was not generated with stream support";
        throw ex;
    }
