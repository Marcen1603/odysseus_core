...
public final class _LaserscannerDelM extends Ice._ObjectDelM implements _LaserscannerDel
{
    public int
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                LaserMeasurementOutputPortPrx __ret;
                __ret = LaserMeasurementOutputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
