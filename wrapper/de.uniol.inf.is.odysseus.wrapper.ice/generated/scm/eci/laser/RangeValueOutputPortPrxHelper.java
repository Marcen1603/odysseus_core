...
public final class RangeValueOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements RangeValueOutputPortPrx
{
    public void
    send(RangeValue msg)
    {
    ...
    private void
    send(RangeValue msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _RangeValueOutputPortDel __del = (_RangeValueOutputPortDel)__delBase;
    ...
    public static RangeValueOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        RangeValueOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (RangeValueOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::laser::RangeValueOutputPort"))
                {
                    RangeValueOutputPortPrxHelper __h = new RangeValueOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::laser::RangeValueOutputPort", __ctx))
                {
                    RangeValueOutputPortPrxHelper __h = new RangeValueOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::RangeValueOutputPort"))
                {
                    RangeValueOutputPortPrxHelper __h = new RangeValueOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::RangeValueOutputPort", __ctx))
                {
                    RangeValueOutputPortPrxHelper __h = new RangeValueOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _RangeValueOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _RangeValueOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, RangeValueOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            RangeValueOutputPortPrxHelper result = new RangeValueOutputPortPrxHelper();
