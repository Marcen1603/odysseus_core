...
public final class _LaserFacadeDelM extends Ice._ObjectDelM implements _LaserFacadeDel
{
    public LaserscannerPrx
    createNewLaserscanner(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("createNewLaserscanner", Ice.OperationMode.Normal, __ctx);
        try
        {
            ...
            try
            {
                ...
                LaserscannerPrx __ret;
                __ret = LaserscannerPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
