...
public abstract class _RangeValueInputPortDisp extends Ice.ObjectImpl implements RangeValueInputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::laser::RangeValueInputPort",
    ...
    public final RangeValueMessage
    getMessage()
    {
        return getMessage(null);
    }

    public final RangeValue
    getValue()
    {
    ...
    ___getMessage(RangeValueInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        RangeValueMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(RangeValueInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        RangeValue __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::laser::RangeValueInputPort was not generated with stream support";
        throw ex;
    }
