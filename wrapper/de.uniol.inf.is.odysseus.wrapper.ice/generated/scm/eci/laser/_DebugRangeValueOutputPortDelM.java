...
public final class _DebugRangeValueOutputPortDelM extends Ice._ObjectDelM implements _DebugRangeValueOutputPortDel
{
    public void
    send(DebugRangeValue msg, java.util.Map<String, String> __ctx)
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            {
                IceInternal.BasicStream __os = __og.os();
                scm.eci.rt.InputPortPrxHelper.__write(__os, target);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
    ...
    getAllowObserver(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getAllowObserver", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
    ...
    getListener(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getListener", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                scm.eci.rt.PortListenerPrx[] __ret;
                __ret = scm.eci.rt.PortListenerSeqHelper.read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
    ...
    getSync(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getSync", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
    ...
    getTargets(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getTargets", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            {
                IceInternal.BasicStream __os = __og.os();
                scm.eci.rt.PortListenerPrxHelper.__write(__os, listener);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
    ...
    setAllowObserver(boolean newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setAllowObserver", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
                IceInternal.BasicStream __os = __og.os();
                __os.writeBool(newValue);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
    ...
    setListener(scm.eci.rt.PortListenerPrx[] newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setListener", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
                IceInternal.BasicStream __os = __og.os();
                scm.eci.rt.PortListenerSeqHelper.write(__os, newValue);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
    ...
    setSync(boolean newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setSync", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
