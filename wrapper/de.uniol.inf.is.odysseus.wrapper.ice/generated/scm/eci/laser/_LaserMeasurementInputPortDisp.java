...
public abstract class _LaserMeasurementInputPortDisp extends Ice.ObjectImpl implements LaserMeasurementInputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::laser::LaserMeasurementInputPort",
    ...
    public final LaserMeasurementMessage
    getMessage()
    {
        return getMessage(null);
    }

    public final LaserMeasurement
    getValue()
    {
    ...
    ___getMessage(LaserMeasurementInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        LaserMeasurementMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(LaserMeasurementInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        LaserMeasurement __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::laser::LaserMeasurementInputPort was not generated with stream support";
        throw ex;
    }
