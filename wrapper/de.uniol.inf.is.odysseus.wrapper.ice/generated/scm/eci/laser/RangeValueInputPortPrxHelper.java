...
public final class RangeValueInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements RangeValueInputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _RangeValueInputPortDel __del = (_RangeValueInputPortDel)__delBase;
    ...
    public static RangeValueInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        RangeValueInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (RangeValueInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::laser::RangeValueInputPort"))
                {
                    RangeValueInputPortPrxHelper __h = new RangeValueInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::laser::RangeValueInputPort", __ctx))
                {
                    RangeValueInputPortPrxHelper __h = new RangeValueInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::RangeValueInputPort"))
                {
                    RangeValueInputPortPrxHelper __h = new RangeValueInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::RangeValueInputPort", __ctx))
                {
                    RangeValueInputPortPrxHelper __h = new RangeValueInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _RangeValueInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _RangeValueInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, RangeValueInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            RangeValueInputPortPrxHelper result = new RangeValueInputPortPrxHelper();
