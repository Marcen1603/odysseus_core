...
public abstract class _DebugRangeValueInputPortDisp extends Ice.ObjectImpl implements DebugRangeValueInputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::laser::DebugRangeValueInputPort",
    ...
    public final DebugRangeValueMessage
    getMessage()
    {
        return getMessage(null);
    }

    public final DebugRangeValue
    getValue()
    {
    ...
    ___getMessage(DebugRangeValueInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        DebugRangeValueMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(DebugRangeValueInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        DebugRangeValue __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::laser::DebugRangeValueInputPort was not generated with stream support";
        throw ex;
    }
