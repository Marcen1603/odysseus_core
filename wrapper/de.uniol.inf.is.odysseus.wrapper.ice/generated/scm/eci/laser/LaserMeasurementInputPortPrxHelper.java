...
public final class LaserMeasurementInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements LaserMeasurementInputPortPrx
{
    ...
    private LaserMeasurementMessage
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _LaserMeasurementInputPortDel __del = (_LaserMeasurementInputPortDel)__delBase;
    ...
    public static LaserMeasurementInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        LaserMeasurementInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (LaserMeasurementInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::laser::LaserMeasurementInputPort"))
                {
                    LaserMeasurementInputPortPrxHelper __h = new LaserMeasurementInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::laser::LaserMeasurementInputPort", __ctx))
                {
                    LaserMeasurementInputPortPrxHelper __h = new LaserMeasurementInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::LaserMeasurementInputPort"))
                {
                    LaserMeasurementInputPortPrxHelper __h = new LaserMeasurementInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::LaserMeasurementInputPort", __ctx))
                {
                    LaserMeasurementInputPortPrxHelper __h = new LaserMeasurementInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _LaserMeasurementInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _LaserMeasurementInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, LaserMeasurementInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            LaserMeasurementInputPortPrxHelper result = new LaserMeasurementInputPortPrxHelper();
