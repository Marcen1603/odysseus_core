...
public final class DebugRangeValueOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DebugRangeValueOutputPortPrx
{
    public void
    send(DebugRangeValue msg)
    {
        send(msg, null, false);
    }
    ...
    private void
    send(DebugRangeValue msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DebugRangeValueOutputPortDel __del = (_DebugRangeValueOutputPortDel)__delBase;
    ...
    public static DebugRangeValueOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DebugRangeValueOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DebugRangeValueOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::laser::DebugRangeValueOutputPort"))
                {
                    DebugRangeValueOutputPortPrxHelper __h = new DebugRangeValueOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::laser::DebugRangeValueOutputPort", __ctx))
                {
                    DebugRangeValueOutputPortPrxHelper __h = new DebugRangeValueOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::DebugRangeValueOutputPort"))
                {
                    DebugRangeValueOutputPortPrxHelper __h = new DebugRangeValueOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::DebugRangeValueOutputPort", __ctx))
                {
                    DebugRangeValueOutputPortPrxHelper __h = new DebugRangeValueOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DebugRangeValueOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DebugRangeValueOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DebugRangeValueOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DebugRangeValueOutputPortPrxHelper result = new DebugRangeValueOutputPortPrxHelper();
