...
public final class DebugRangeValueInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DebugRangeValueInputPortPrx
{
    ...
    private DebugRangeValueMessage
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DebugRangeValueInputPortDel __del = (_DebugRangeValueInputPortDel)__delBase;
    ...
    public static DebugRangeValueInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DebugRangeValueInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DebugRangeValueInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::laser::DebugRangeValueInputPort"))
                {
                    DebugRangeValueInputPortPrxHelper __h = new DebugRangeValueInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::laser::DebugRangeValueInputPort", __ctx))
                {
                    DebugRangeValueInputPortPrxHelper __h = new DebugRangeValueInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::DebugRangeValueInputPort"))
                {
                    DebugRangeValueInputPortPrxHelper __h = new DebugRangeValueInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::laser::DebugRangeValueInputPort", __ctx))
                {
                    DebugRangeValueInputPortPrxHelper __h = new DebugRangeValueInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DebugRangeValueInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DebugRangeValueInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DebugRangeValueInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DebugRangeValueInputPortPrxHelper result = new DebugRangeValueInputPortPrxHelper();
