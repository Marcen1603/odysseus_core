...
public final class DoubleInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DoubleInputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DoubleInputPortDel __del = (_DoubleInputPortDel)__delBase;
    ...
    public static DoubleInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DoubleInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DoubleInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::DoubleInputPort"))
                {
                    DoubleInputPortPrxHelper __h = new DoubleInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::DoubleInputPort", __ctx))
                {
                    DoubleInputPortPrxHelper __h = new DoubleInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::DoubleInputPort"))
                {
                    DoubleInputPortPrxHelper __h = new DoubleInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::DoubleInputPort", __ctx))
                {
                    DoubleInputPortPrxHelper __h = new DoubleInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DoubleInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DoubleInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DoubleInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DoubleInputPortPrxHelper result = new DoubleInputPortPrxHelper();
