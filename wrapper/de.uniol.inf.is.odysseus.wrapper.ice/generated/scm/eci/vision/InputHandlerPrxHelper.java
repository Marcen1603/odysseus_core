...
public final class InputHandlerPrxHelper extends Ice.ObjectPrxHelperBase implements InputHandlerPrx
{
    public int
    getFrequency()
    {
    ...
    getFrequency(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _InputHandlerDel __del = (_InputHandlerDel)__delBase;
    ...
    public static InputHandlerPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        InputHandlerPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (InputHandlerPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::InputHandler"))
                {
                    InputHandlerPrxHelper __h = new InputHandlerPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::InputHandler", __ctx))
                {
                    InputHandlerPrxHelper __h = new InputHandlerPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::InputHandler"))
                {
                    InputHandlerPrxHelper __h = new InputHandlerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::InputHandler", __ctx))
                {
                    InputHandlerPrxHelper __h = new InputHandlerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _InputHandlerDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _InputHandlerDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, InputHandlerPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            InputHandlerPrxHelper result = new InputHandlerPrxHelper();
