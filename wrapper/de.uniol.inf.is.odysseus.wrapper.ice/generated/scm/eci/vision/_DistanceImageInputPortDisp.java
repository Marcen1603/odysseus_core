...
public abstract class _DistanceImageInputPortDisp extends Ice.ObjectImpl implements DistanceImageInputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::DistanceImageInputPort"
    };
    ...
    public final DistanceImageMessage
    getMessage()
    {
        return getMessage(null);
    }

    public final DistanceImage
    getValue()
    {
    ...
    ___getMessage(DistanceImageInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        DistanceImageMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(DistanceImageInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        DistanceImage __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::DistanceImageInputPort was not generated with stream support";
        throw ex;
    }
