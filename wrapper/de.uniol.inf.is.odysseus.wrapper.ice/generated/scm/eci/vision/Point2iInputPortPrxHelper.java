...
public final class Point2iInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Point2iInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Point2iInputPortDel __del = (_Point2iInputPortDel)__delBase;
    ...
    public static Point2iInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Point2iInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Point2iInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::Point2iInputPort"))
                {
                    Point2iInputPortPrxHelper __h = new Point2iInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::Point2iInputPort", __ctx))
                {
                    Point2iInputPortPrxHelper __h = new Point2iInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Point2iInputPort"))
                {
                    Point2iInputPortPrxHelper __h = new Point2iInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Point2iInputPort", __ctx))
                {
                    Point2iInputPortPrxHelper __h = new Point2iInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Point2iInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Point2iInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Point2iInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Point2iInputPortPrxHelper result = new Point2iInputPortPrxHelper();
