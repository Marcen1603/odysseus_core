...
public abstract class _ImageInputPortDisp extends Ice.ObjectImpl implements ImageInputPort
{
    protected void
    ...
    ___getMessage(ImageInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        ImageMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(ImageInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Image __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::ImageInputPort was not generated with stream support";
        throw ex;
    }
