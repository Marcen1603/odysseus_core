...
public final class ImageOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements ImageOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ImageOutputPortDel __del = (_ImageOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(Image msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static ImageOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ImageOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ImageOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::ImageOutputPort"))
                {
                    ImageOutputPortPrxHelper __h = new ImageOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::ImageOutputPort", __ctx))
                {
                    ImageOutputPortPrxHelper __h = new ImageOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::ImageOutputPort"))
                {
                    ImageOutputPortPrxHelper __h = new ImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::ImageOutputPort", __ctx))
                {
                    ImageOutputPortPrxHelper __h = new ImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ImageOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ImageOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ImageOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ImageOutputPortPrxHelper result = new ImageOutputPortPrxHelper();
