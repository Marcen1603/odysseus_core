...
public final class _GrayImageServerDelD extends Ice._ObjectDelD implements _GrayImageServerDel
{
    public int
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    GrayImageServer __servant = null;
                    try
                    {
                        __servant = (GrayImageServer)__obj;
                    }
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "getGrayImageOutputPort", Ice.OperationMode.Normal, __ctx);
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getGrayImageOutputPort(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
