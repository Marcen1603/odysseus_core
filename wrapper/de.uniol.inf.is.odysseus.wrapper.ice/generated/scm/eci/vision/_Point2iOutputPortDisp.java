...
public abstract class _Point2iOutputPortDisp extends Ice.ObjectImpl implements Point2iOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::Point2iOutputPort"
    };
    ...
    ___send(Point2iOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        Point2iHolder msg = new Point2iHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::Point2iOutputPort was not generated with stream support";
        throw ex;
    }
