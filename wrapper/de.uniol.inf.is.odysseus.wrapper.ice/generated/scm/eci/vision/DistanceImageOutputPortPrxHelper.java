...
public final class DistanceImageOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DistanceImageOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DistanceImageOutputPortDel __del = (_DistanceImageOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(DistanceImage msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static DistanceImageOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DistanceImageOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DistanceImageOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::DistanceImageOutputPort"))
                {
                    DistanceImageOutputPortPrxHelper __h = new DistanceImageOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::DistanceImageOutputPort", __ctx))
                {
                    DistanceImageOutputPortPrxHelper __h = new DistanceImageOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::DistanceImageOutputPort"))
                {
                    DistanceImageOutputPortPrxHelper __h = new DistanceImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::DistanceImageOutputPort", __ctx))
                {
                    DistanceImageOutputPortPrxHelper __h = new DistanceImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DistanceImageOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DistanceImageOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DistanceImageOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DistanceImageOutputPortPrxHelper result = new DistanceImageOutputPortPrxHelper();
