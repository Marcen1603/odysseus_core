...
public final class _RGBThresholdDelD extends Ice._ObjectDelD implements _RGBThresholdDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    RGBThreshold __servant = null;
                    try
                    {
                        __servant = (RGBThreshold)__obj;
                    }
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final RGBImageInputPortPrxHolder __result = new RGBImageInputPortPrxHolder();
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
