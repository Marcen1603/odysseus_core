...
public final class AlgorithmPrxHelper extends Ice.ObjectPrxHelperBase implements AlgorithmPrx
{
    ...
    getInputPort(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _AlgorithmDel __del = (_AlgorithmDel)__delBase;
    ...
    public static AlgorithmPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        AlgorithmPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (AlgorithmPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::Algorithm"))
                {
                    AlgorithmPrxHelper __h = new AlgorithmPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::Algorithm", __ctx))
                {
                    AlgorithmPrxHelper __h = new AlgorithmPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Algorithm"))
                {
                    AlgorithmPrxHelper __h = new AlgorithmPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Algorithm", __ctx))
                {
                    AlgorithmPrxHelper __h = new AlgorithmPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _AlgorithmDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _AlgorithmDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, AlgorithmPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            AlgorithmPrxHelper result = new AlgorithmPrxHelper();
