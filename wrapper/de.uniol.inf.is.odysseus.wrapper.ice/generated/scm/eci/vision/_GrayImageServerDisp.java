...
public abstract class _GrayImageServerDisp extends Ice.ObjectImpl implements GrayImageServer
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::GrayImageServer",
    ...
    {
        return getGrayImageOutputPort(null);
    }
    ...
    ___getGrayImageOutputPort(GrayImageServer __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        GrayImageOutputPortPrx __ret = __obj.getGrayImageOutputPort(__current);
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 5:
            {
                return ___getGrayImageOutputPort(this, in, __current);
            }
            case 6:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::GrayImageServer was not generated with stream support";
        throw ex;
    }
