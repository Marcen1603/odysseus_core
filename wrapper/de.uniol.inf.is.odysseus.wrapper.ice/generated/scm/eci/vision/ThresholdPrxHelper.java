...
public final class ThresholdPrxHelper extends Ice.ObjectPrxHelperBase implements ThresholdPrx
{
    ...
    getInputPort(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ThresholdDel __del = (_ThresholdDel)__delBase;
    ...
    public static ThresholdPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ThresholdPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ThresholdPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::Threshold"))
                {
                    ThresholdPrxHelper __h = new ThresholdPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::Threshold", __ctx))
                {
                    ThresholdPrxHelper __h = new ThresholdPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Threshold"))
                {
                    ThresholdPrxHelper __h = new ThresholdPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Threshold", __ctx))
                {
                    ThresholdPrxHelper __h = new ThresholdPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ThresholdDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ThresholdDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ThresholdPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ThresholdPrxHelper result = new ThresholdPrxHelper();
