...
public final class MatrixOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements MatrixOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _MatrixOutputPortDel __del = (_MatrixOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(Matrix msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static MatrixOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        MatrixOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (MatrixOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::MatrixOutputPort"))
                {
                    MatrixOutputPortPrxHelper __h = new MatrixOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::MatrixOutputPort", __ctx))
                {
                    MatrixOutputPortPrxHelper __h = new MatrixOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::MatrixOutputPort"))
                {
                    MatrixOutputPortPrxHelper __h = new MatrixOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::MatrixOutputPort", __ctx))
                {
                    MatrixOutputPortPrxHelper __h = new MatrixOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _MatrixOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _MatrixOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, MatrixOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            MatrixOutputPortPrxHelper result = new MatrixOutputPortPrxHelper();
