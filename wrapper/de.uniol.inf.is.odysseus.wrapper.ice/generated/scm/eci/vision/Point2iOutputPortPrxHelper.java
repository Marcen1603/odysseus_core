...
public final class Point2iOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Point2iOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Point2iOutputPortDel __del = (_Point2iOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(Point2i msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static Point2iOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Point2iOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Point2iOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::Point2iOutputPort"))
                {
                    Point2iOutputPortPrxHelper __h = new Point2iOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::Point2iOutputPort", __ctx))
                {
                    Point2iOutputPortPrxHelper __h = new Point2iOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Point2iOutputPort"))
                {
                    Point2iOutputPortPrxHelper __h = new Point2iOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::Point2iOutputPort", __ctx))
                {
                    Point2iOutputPortPrxHelper __h = new Point2iOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Point2iOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Point2iOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Point2iOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Point2iOutputPortPrxHelper result = new Point2iOutputPortPrxHelper();
