...
public final class DistanceImageInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DistanceImageInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DistanceImageInputPortDel __del = (_DistanceImageInputPortDel)__delBase;
    ...
    public static DistanceImageInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DistanceImageInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DistanceImageInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::DistanceImageInputPort"))
                {
                    DistanceImageInputPortPrxHelper __h = new DistanceImageInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::DistanceImageInputPort", __ctx))
                {
                    DistanceImageInputPortPrxHelper __h = new DistanceImageInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::DistanceImageInputPort"))
                {
                    DistanceImageInputPortPrxHelper __h = new DistanceImageInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::DistanceImageInputPort", __ctx))
                {
                    DistanceImageInputPortPrxHelper __h = new DistanceImageInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DistanceImageInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DistanceImageInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DistanceImageInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DistanceImageInputPortPrxHelper result = new DistanceImageInputPortPrxHelper();
