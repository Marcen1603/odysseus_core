...
public abstract class _ImageOutputPortDisp extends Ice.ObjectImpl implements ImageOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::ImageOutputPort"
    };
    ...
    ___send(ImageOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ImageHolder msg = new ImageHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::ImageOutputPort was not generated with stream support";
        throw ex;
    }
