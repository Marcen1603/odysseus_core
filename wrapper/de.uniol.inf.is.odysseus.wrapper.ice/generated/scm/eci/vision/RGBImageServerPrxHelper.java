...
public final class RGBImageServerPrxHelper extends Ice.ObjectPrxHelperBase implements RGBImageServerPrx
{
    public int
    getFrequency()
    {
    ...
    getFrequency(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _RGBImageServerDel __del = (_RGBImageServerDel)__delBase;
    ...
    public static RGBImageServerPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        RGBImageServerPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (RGBImageServerPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::RGBImageServer"))
                {
                    RGBImageServerPrxHelper __h = new RGBImageServerPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::RGBImageServer", __ctx))
                {
                    RGBImageServerPrxHelper __h = new RGBImageServerPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::RGBImageServer"))
                {
                    RGBImageServerPrxHelper __h = new RGBImageServerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::RGBImageServer", __ctx))
                {
                    RGBImageServerPrxHelper __h = new RGBImageServerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _RGBImageServerDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _RGBImageServerDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, RGBImageServerPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            RGBImageServerPrxHelper result = new RGBImageServerPrxHelper();
