...
public abstract class _GrayThresholdDisp extends Ice.ObjectImpl implements GrayThreshold
{
    protected void
    ...
    public final GrayImageInputPortPrx
    getImgInputPort()
    {
    ...
    ___getThreshImgOutputPort(GrayThreshold __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        GrayImageOutputPortPrx __ret = __obj.getThreshImgOutputPort(__current);
        GrayImageOutputPortPrxHelper.__write(__os, __ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___getImgInputPort(GrayThreshold __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        GrayImageInputPortPrx __ret = __obj.getImgInputPort(__current);
        GrayImageInputPortPrxHelper.__write(__os, __ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::GrayThreshold was not generated with stream support";
        throw ex;
    }
