...
public final class GrayImageInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements GrayImageInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _GrayImageInputPortDel __del = (_GrayImageInputPortDel)__delBase;
    ...
    public static GrayImageInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        GrayImageInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (GrayImageInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::GrayImageInputPort"))
                {
                    GrayImageInputPortPrxHelper __h = new GrayImageInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::GrayImageInputPort", __ctx))
                {
                    GrayImageInputPortPrxHelper __h = new GrayImageInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::GrayImageInputPort"))
                {
                    GrayImageInputPortPrxHelper __h = new GrayImageInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::GrayImageInputPort", __ctx))
                {
                    GrayImageInputPortPrxHelper __h = new GrayImageInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _GrayImageInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _GrayImageInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, GrayImageInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            GrayImageInputPortPrxHelper result = new GrayImageInputPortPrxHelper();
