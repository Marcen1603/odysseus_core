...
public abstract class _GrayImageOutputPortDisp extends Ice.ObjectImpl implements GrayImageOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::GrayImageOutputPort"
    };
    ...
    ___send(GrayImageOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        GrayImageHolder msg = new GrayImageHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::GrayImageOutputPort was not generated with stream support";
        throw ex;
    }
