...
public final class _RGBThresholdDelM extends Ice._ObjectDelM implements _RGBThresholdDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                RGBImageInputPortPrx __ret;
                __ret = RGBImageInputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
