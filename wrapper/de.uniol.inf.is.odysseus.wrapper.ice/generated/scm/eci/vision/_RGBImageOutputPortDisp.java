...
public abstract class _RGBImageOutputPortDisp extends Ice.ObjectImpl implements RGBImageOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::RGBImageOutputPort"
    };
    ...
    ___send(RGBImageOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        RGBImageHolder msg = new RGBImageHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::RGBImageOutputPort was not generated with stream support";
        throw ex;
    }
