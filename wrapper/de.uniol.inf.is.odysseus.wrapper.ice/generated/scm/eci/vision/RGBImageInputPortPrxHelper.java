...
public final class RGBImageInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements RGBImageInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _RGBImageInputPortDel __del = (_RGBImageInputPortDel)__delBase;
    ...
    public static RGBImageInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        RGBImageInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (RGBImageInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::RGBImageInputPort"))
                {
                    RGBImageInputPortPrxHelper __h = new RGBImageInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::RGBImageInputPort", __ctx))
                {
                    RGBImageInputPortPrxHelper __h = new RGBImageInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::RGBImageInputPort"))
                {
                    RGBImageInputPortPrxHelper __h = new RGBImageInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::RGBImageInputPort", __ctx))
                {
                    RGBImageInputPortPrxHelper __h = new RGBImageInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _RGBImageInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _RGBImageInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, RGBImageInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            RGBImageInputPortPrxHelper result = new RGBImageInputPortPrxHelper();
