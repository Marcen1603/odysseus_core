...
public final class MatrixInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements MatrixInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _MatrixInputPortDel __del = (_MatrixInputPortDel)__delBase;
    ...
    public static MatrixInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        MatrixInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (MatrixInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::MatrixInputPort"))
                {
                    MatrixInputPortPrxHelper __h = new MatrixInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::MatrixInputPort", __ctx))
                {
                    MatrixInputPortPrxHelper __h = new MatrixInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::MatrixInputPort"))
                {
                    MatrixInputPortPrxHelper __h = new MatrixInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::MatrixInputPort", __ctx))
                {
                    MatrixInputPortPrxHelper __h = new MatrixInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _MatrixInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _MatrixInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, MatrixInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            MatrixInputPortPrxHelper result = new MatrixInputPortPrxHelper();
