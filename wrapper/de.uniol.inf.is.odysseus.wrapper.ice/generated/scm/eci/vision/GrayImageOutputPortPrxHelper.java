...
public final class GrayImageOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements GrayImageOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _GrayImageOutputPortDel __del = (_GrayImageOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(GrayImage msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static GrayImageOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        GrayImageOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (GrayImageOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::GrayImageOutputPort"))
                {
                    GrayImageOutputPortPrxHelper __h = new GrayImageOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::GrayImageOutputPort", __ctx))
                {
                    GrayImageOutputPortPrxHelper __h = new GrayImageOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::GrayImageOutputPort"))
                {
                    GrayImageOutputPortPrxHelper __h = new GrayImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::GrayImageOutputPort", __ctx))
                {
                    GrayImageOutputPortPrxHelper __h = new GrayImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _GrayImageOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _GrayImageOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, GrayImageOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            GrayImageOutputPortPrxHelper result = new GrayImageOutputPortPrxHelper();
