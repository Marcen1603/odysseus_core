...
public abstract class _MatrixOutputPortDisp extends Ice.ObjectImpl implements MatrixOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::MatrixOutputPort"
    };
    ...
    ___send(MatrixOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        MatrixHolder msg = new MatrixHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::MatrixOutputPort was not generated with stream support";
        throw ex;
    }
