...
public final class _GrayImageServerDelM extends Ice._ObjectDelM implements _GrayImageServerDel
{
    public int
    ...
    getGrayImageOutputPort(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getGrayImageOutputPort", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
