...
public final class RGBImageOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements RGBImageOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _RGBImageOutputPortDel __del = (_RGBImageOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(RGBImage msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static RGBImageOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        RGBImageOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (RGBImageOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::RGBImageOutputPort"))
                {
                    RGBImageOutputPortPrxHelper __h = new RGBImageOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::RGBImageOutputPort", __ctx))
                {
                    RGBImageOutputPortPrxHelper __h = new RGBImageOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::RGBImageOutputPort"))
                {
                    RGBImageOutputPortPrxHelper __h = new RGBImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::RGBImageOutputPort", __ctx))
                {
                    RGBImageOutputPortPrxHelper __h = new RGBImageOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _RGBImageOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _RGBImageOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, RGBImageOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            RGBImageOutputPortPrxHelper result = new RGBImageOutputPortPrxHelper();
