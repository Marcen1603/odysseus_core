...
public final class GrayThresholdPrxHelper extends Ice.ObjectPrxHelperBase implements GrayThresholdPrx
{
    ...
    getInputPort(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _GrayThresholdDel __del = (_GrayThresholdDel)__delBase;
    ...
    public static GrayThresholdPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        GrayThresholdPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (GrayThresholdPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::vision::GrayThreshold"))
                {
                    GrayThresholdPrxHelper __h = new GrayThresholdPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::vision::GrayThreshold", __ctx))
                {
                    GrayThresholdPrxHelper __h = new GrayThresholdPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::GrayThreshold"))
                {
                    GrayThresholdPrxHelper __h = new GrayThresholdPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::vision::GrayThreshold", __ctx))
                {
                    GrayThresholdPrxHelper __h = new GrayThresholdPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _GrayThresholdDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _GrayThresholdDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, GrayThresholdPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            GrayThresholdPrxHelper result = new GrayThresholdPrxHelper();
