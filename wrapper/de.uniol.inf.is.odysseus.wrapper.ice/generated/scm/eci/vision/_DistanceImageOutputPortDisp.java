...
public abstract class _DistanceImageOutputPortDisp extends Ice.ObjectImpl implements DistanceImageOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::vision::DistanceImageOutputPort"
    };
    ...
    ___send(DistanceImageOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        DistanceImageHolder msg = new DistanceImageHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::vision::DistanceImageOutputPort was not generated with stream support";
        throw ex;
    }
