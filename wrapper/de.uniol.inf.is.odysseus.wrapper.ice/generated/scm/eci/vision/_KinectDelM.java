...
public final class _KinectDelM extends Ice._ObjectDelM implements _KinectDel
{
    public int
    ...
    getImgOutputPort(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getImgOutputPort", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                ImageOutputPortPrx __ret;
                __ret = ImageOutputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
    ...
    getResolution(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getResolution", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                Point2iHolder __ret = new Point2iHolder();
    ...
    setResolution(Point2i newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setResolution", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
                IceInternal.BasicStream __os = __og.os();
                __os.writeObject(newValue);
                __os.writePendingObjects();
            }
            catch(Ice.LocalException __ex)
            {
    ...
    getDepthImgOutputPort(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getDepthImgOutputPort", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                GrayImageOutputPortPrx __ret;
                __ret = GrayImageOutputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
    ...
    getDistImgOutputPort(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getDistImgOutputPort", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                DistanceImageOutputPortPrx __ret;
                __ret = DistanceImageOutputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
    ...
    getLed(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getLed", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
    ...
    getMotorPos(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getMotorPos", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
    ...
    getRegMat(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getRegMat", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                MatrixHolder __ret = new MatrixHolder();
                __is.readObject(__ret.getPatcher());
                __is.readPendingObjects();
                __is.endReadEncaps();
                return __ret.value;
    ...
    getRegRGBImgOutputPort(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getRegRGBImgOutputPort", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                RGBImageOutputPortPrx __ret;
                __ret = RGBImageOutputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
    ...
    setLed(int newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setLed", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    setMotorPos(int newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setMotorPos", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    setRegMat(Matrix newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setRegMat", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    getColorImageOutputPort(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getColorImageOutputPort", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
