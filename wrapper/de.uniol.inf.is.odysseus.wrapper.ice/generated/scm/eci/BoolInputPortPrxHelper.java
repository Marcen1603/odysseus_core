...
public final class BoolInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements BoolInputPortPrx
{
    public BoolMessage
    getMessage()
    {
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _BoolInputPortDel __del = (_BoolInputPortDel)__delBase;
    ...
    public static BoolInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        BoolInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (BoolInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::BoolInputPort"))
                {
                    BoolInputPortPrxHelper __h = new BoolInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::BoolInputPort", __ctx))
                {
                    BoolInputPortPrxHelper __h = new BoolInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::BoolInputPort"))
                {
                    BoolInputPortPrxHelper __h = new BoolInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::BoolInputPort", __ctx))
                {
                    BoolInputPortPrxHelper __h = new BoolInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _BoolInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _BoolInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, BoolInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            BoolInputPortPrxHelper result = new BoolInputPortPrxHelper();
