...
public final class _JobDelD extends Ice._ObjectDelD implements _JobDel
{
    public boolean
    ...
    public boolean
    execute(final ExecutionContext ctx, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
    ...
    public boolean
    setActiveProcessor(final JobProcessorPrx newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
