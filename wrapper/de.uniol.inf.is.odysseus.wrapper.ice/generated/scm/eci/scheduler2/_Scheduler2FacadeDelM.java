...
public final class _Scheduler2FacadeDelM extends Ice._ObjectDelM implements _Scheduler2FacadeDel
{
    public SchedulerPrx
    createNewScheduler(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("createNewScheduler", Ice.OperationMode.Normal, __ctx);
        try
        {
            ...
            try
            {
                ...
                SchedulerPrx __ret;
                __ret = SchedulerPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
    ...
    createNewStrategie(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("createNewStrategie", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
