...
public final class _SchedulerDelM extends Ice._ObjectDelM implements _SchedulerDel
{
    public void
    executeNextJob(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("executeNextJob", Ice.OperationMode.Normal, __ctx);
        try
        {
    ...
    getDefaultProcessor(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getDefaultProcessor", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                JobProcessorPrx __ret;
                __ret = JobProcessorPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
    ...
    getStrategie(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getStrategie", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                __is.startReadEncaps();
                StrategiePrx __ret;
                __ret = StrategiePrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
    ...
    getTimestamp(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getTimestamp", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            {
                IceInternal.BasicStream __os = __og.os();
                SchedulerListenerPrxHelper.__write(__os, listener);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
    ...
    setStrategie(StrategiePrx newValue, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setStrategie", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
                IceInternal.BasicStream __os = __og.os();
                StrategiePrxHelper.__write(__os, newValue);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
