...
public final class ResourceInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements ResourceInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ResourceInputPortDel __del = (_ResourceInputPortDel)__delBase;
    ...
    public static ResourceInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ResourceInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ResourceInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::ResourceInputPort"))
                {
                    ResourceInputPortPrxHelper __h = new ResourceInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::ResourceInputPort", __ctx))
                {
                    ResourceInputPortPrxHelper __h = new ResourceInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::ResourceInputPort"))
                {
                    ResourceInputPortPrxHelper __h = new ResourceInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::ResourceInputPort", __ctx))
                {
                    ResourceInputPortPrxHelper __h = new ResourceInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ResourceInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ResourceInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ResourceInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ResourceInputPortPrxHelper result = new ResourceInputPortPrxHelper();
