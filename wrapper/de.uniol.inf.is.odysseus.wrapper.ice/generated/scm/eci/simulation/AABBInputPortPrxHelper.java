...
public final class AABBInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements AABBInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _AABBInputPortDel __del = (_AABBInputPortDel)__delBase;
    ...
    public static AABBInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        AABBInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (AABBInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::AABBInputPort"))
                {
                    AABBInputPortPrxHelper __h = new AABBInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::AABBInputPort", __ctx))
                {
                    AABBInputPortPrxHelper __h = new AABBInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::AABBInputPort"))
                {
                    AABBInputPortPrxHelper __h = new AABBInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::AABBInputPort", __ctx))
                {
                    AABBInputPortPrxHelper __h = new AABBInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _AABBInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _AABBInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, AABBInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            AABBInputPortPrxHelper result = new AABBInputPortPrxHelper();
