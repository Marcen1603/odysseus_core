...
public abstract class _ResourceOutputPortDisp extends Ice.ObjectImpl implements ResourceOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::ResourceOutputPort"
    };
    ...
    ___send(ResourceOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ResourceHolder msg = new ResourceHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::ResourceOutputPort was not generated with stream support";
        throw ex;
    }
