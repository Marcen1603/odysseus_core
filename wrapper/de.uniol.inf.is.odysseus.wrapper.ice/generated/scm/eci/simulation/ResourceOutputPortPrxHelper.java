...
public final class ResourceOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements ResourceOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ResourceOutputPortDel __del = (_ResourceOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(Resource msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static ResourceOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ResourceOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ResourceOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::ResourceOutputPort"))
                {
                    ResourceOutputPortPrxHelper __h = new ResourceOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::ResourceOutputPort", __ctx))
                {
                    ResourceOutputPortPrxHelper __h = new ResourceOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::ResourceOutputPort"))
                {
                    ResourceOutputPortPrxHelper __h = new ResourceOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::ResourceOutputPort", __ctx))
                {
                    ResourceOutputPortPrxHelper __h = new ResourceOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ResourceOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ResourceOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ResourceOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ResourceOutputPortPrxHelper result = new ResourceOutputPortPrxHelper();
