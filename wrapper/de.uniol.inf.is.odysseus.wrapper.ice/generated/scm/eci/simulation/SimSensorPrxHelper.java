...
public final class SimSensorPrxHelper extends Ice.ObjectPrxHelperBase implements SimSensorPrx
{
    public int
    getFrequency()
    {
    ...
    getFrequency(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _SimSensorDel __del = (_SimSensorDel)__delBase;
    ...
    {
        SimSensorPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (SimSensorPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::SimSensor"))
                {
                    SimSensorPrxHelper __h = new SimSensorPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::SimSensor", __ctx))
                {
                    SimSensorPrxHelper __h = new SimSensorPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::SimSensor"))
                {
                    SimSensorPrxHelper __h = new SimSensorPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::SimSensor", __ctx))
                {
                    SimSensorPrxHelper __h = new SimSensorPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _SimSensorDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _SimSensorDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, SimSensorPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            SimSensorPrxHelper result = new SimSensorPrxHelper();
