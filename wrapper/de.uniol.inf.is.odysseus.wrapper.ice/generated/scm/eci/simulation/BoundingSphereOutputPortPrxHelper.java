...
public final class BoundingSphereOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements BoundingSphereOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _BoundingSphereOutputPortDel __del = (_BoundingSphereOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(BoundingSphere msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static BoundingSphereOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        BoundingSphereOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (BoundingSphereOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::BoundingSphereOutputPort"))
                {
                    BoundingSphereOutputPortPrxHelper __h = new BoundingSphereOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::BoundingSphereOutputPort", __ctx))
                {
                    BoundingSphereOutputPortPrxHelper __h = new BoundingSphereOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::BoundingSphereOutputPort"))
                {
                    BoundingSphereOutputPortPrxHelper __h = new BoundingSphereOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::BoundingSphereOutputPort", __ctx))
                {
                    BoundingSphereOutputPortPrxHelper __h = new BoundingSphereOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _BoundingSphereOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _BoundingSphereOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, BoundingSphereOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            BoundingSphereOutputPortPrxHelper result = new BoundingSphereOutputPortPrxHelper();
