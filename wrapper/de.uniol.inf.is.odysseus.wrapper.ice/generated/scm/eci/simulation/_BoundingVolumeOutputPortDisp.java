...
public abstract class _BoundingVolumeOutputPortDisp extends Ice.ObjectImpl implements BoundingVolumeOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::BoundingVolumeOutputPort"
    };
    ...
    ___send(BoundingVolumeOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        BoundingVolumeHolder msg = new BoundingVolumeHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::BoundingVolumeOutputPort was not generated with stream support";
        throw ex;
    }
