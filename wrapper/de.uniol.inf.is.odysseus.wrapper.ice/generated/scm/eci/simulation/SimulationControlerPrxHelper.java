...
public final class SimulationControlerPrxHelper extends Ice.ObjectPrxHelperBase implements SimulationControlerPrx
{
    ...
    getInputPort(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
    ...
    {
        return createNewAgentWithCamera(null, false);
    }

    public SimAgentPrx
    createNewAgentWithCamera(java.util.Map<String, String> __ctx)
    {
        return createNewAgentWithCamera(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private SimAgentPrx
    createNewAgentWithCamera(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("createNewAgentWithCamera");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.createNewAgentWithCamera(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        return createNewCamera(name, null, false);
    }

    public Resource
    createNewCamera(String name, java.util.Map<String, String> __ctx)
    {
        return createNewCamera(name, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private Resource
    createNewCamera(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("createNewCamera");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.createNewCamera(name, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        doEvilRenderBypass(camera, null, false);
    }

    public void
    doEvilRenderBypass(SimCameraPrx camera, java.util.Map<String, String> __ctx)
    {
        doEvilRenderBypass(camera, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    doEvilRenderBypass(SimCameraPrx camera, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                __del.doEvilRenderBypass(camera, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    {
        enableEvilRenderBypass(enabled, null, false);
    }

    public void
    enableEvilRenderBypass(boolean enabled, java.util.Map<String, String> __ctx)
    {
        enableEvilRenderBypass(enabled, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    enableEvilRenderBypass(boolean enabled, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                __del.enableEvilRenderBypass(enabled, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    getActiveScenario()
    {
        return getActiveScenario(null, false);
    }

    public ScenarioPrx
    getActiveScenario(java.util.Map<String, String> __ctx)
    {
        return getActiveScenario(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private ScenarioPrx
    getActiveScenario(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getActiveScenario");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.getActiveScenario(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    public scm.eci.BoolOutputPortPrx
    getInitializedOutputPort()
    {
        return getInitializedOutputPort(null, false);
    }

    public scm.eci.BoolOutputPortPrx
    getInitializedOutputPort(java.util.Map<String, String> __ctx)
    {
        return getInitializedOutputPort(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private scm.eci.BoolOutputPortPrx
    getInitializedOutputPort(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getInitializedOutputPort");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.getInitializedOutputPort(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        return getObjectByName(name, null, false);
    }

    public SimObjectPrx
    getObjectByName(String name, java.util.Map<String, String> __ctx)
    {
        return getObjectByName(name, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private SimObjectPrx
    getObjectByName(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getObjectByName");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.getObjectByName(name, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    public scm.eci.base.FileOutputPortPrx
    getSceneLoadedOutputPort()
    {
        return getSceneLoadedOutputPort(null, false);
    }

    public scm.eci.base.FileOutputPortPrx
    getSceneLoadedOutputPort(java.util.Map<String, String> __ctx)
    {
        return getSceneLoadedOutputPort(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private scm.eci.base.FileOutputPortPrx
    getSceneLoadedOutputPort(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getSceneLoadedOutputPort");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.getSceneLoadedOutputPort(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    getScenes()
    {
        return getScenes(null, false);
    }

    public ScenePrx[]
    getScenes(java.util.Map<String, String> __ctx)
    {
        return getScenes(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private ScenePrx[]
    getScenes(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getScenes");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.getScenes(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    public scm.eci.scheduler2.SchedulerPrx
    getScheduler()
    {
        return getScheduler(null, false);
    }

    public scm.eci.scheduler2.SchedulerPrx
    getScheduler(java.util.Map<String, String> __ctx)
    {
        return getScheduler(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private scm.eci.scheduler2.SchedulerPrx
    getScheduler(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getScheduler");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.getScheduler(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        return instanceiateResource(res, parent, null, false);
    }

    public SimObjectPrx
    instanceiateResource(Resource res, SimAgentPrx parent, java.util.Map<String, String> __ctx)
    {
        return instanceiateResource(res, parent, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private SimObjectPrx
    instanceiateResource(Resource res, SimAgentPrx parent, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("instanceiateResource");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.instanceiateResource(res, parent, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        return instanceiateScene(sceneToInit, null, false);
    }

    public SimAgentPrx[]
    instanceiateScene(ScenePrx sceneToInit, java.util.Map<String, String> __ctx)
    {
        return instanceiateScene(sceneToInit, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private SimAgentPrx[]
    instanceiateScene(ScenePrx sceneToInit, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("instanceiateScene");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.instanceiateScene(sceneToInit, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    isDebugEnabled()
    {
        return isDebugEnabled(null, false);
    }

    public boolean
    isDebugEnabled(java.util.Map<String, String> __ctx)
    {
        return isDebugEnabled(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private boolean
    isDebugEnabled(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("isDebugEnabled");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.isDebugEnabled(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        return isEvilRenderBypassEnabled(null, false);
    }

    public boolean
    isEvilRenderBypassEnabled(java.util.Map<String, String> __ctx)
    {
        return isEvilRenderBypassEnabled(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private boolean
    isEvilRenderBypassEnabled(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("isEvilRenderBypassEnabled");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.isEvilRenderBypassEnabled(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        return loadScene(fileToLoad, null, false);
    }

    public ScenePrx
    loadScene(scm.eci.base.File fileToLoad, java.util.Map<String, String> __ctx)
    {
        return loadScene(fileToLoad, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private ScenePrx
    loadScene(scm.eci.base.File fileToLoad, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("loadScene");
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                return __del.loadScene(fileToLoad, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        renderFrame(camera, null, false);
    }

    public void
    renderFrame(SimCameraPrx camera, java.util.Map<String, String> __ctx)
    {
        renderFrame(camera, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    renderFrame(SimCameraPrx camera, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                __del.renderFrame(camera, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    {
        setDebugEnabled(enabled, null, false);
    }

    public void
    setDebugEnabled(boolean enabled, java.util.Map<String, String> __ctx)
    {
        setDebugEnabled(enabled, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    setDebugEnabled(boolean enabled, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __delBase = __getDelegate(false);
                _SimulationControlerDel __del = (_SimulationControlerDel)__delBase;
                __del.setDebugEnabled(enabled, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    public static SimulationControlerPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        SimulationControlerPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (SimulationControlerPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::SimulationControler"))
                {
                    SimulationControlerPrxHelper __h = new SimulationControlerPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::SimulationControler", __ctx))
                {
                    SimulationControlerPrxHelper __h = new SimulationControlerPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::SimulationControler"))
                {
                    SimulationControlerPrxHelper __h = new SimulationControlerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::SimulationControler", __ctx))
                {
                    SimulationControlerPrxHelper __h = new SimulationControlerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _SimulationControlerDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _SimulationControlerDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, SimulationControlerPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            SimulationControlerPrxHelper result = new SimulationControlerPrxHelper();
