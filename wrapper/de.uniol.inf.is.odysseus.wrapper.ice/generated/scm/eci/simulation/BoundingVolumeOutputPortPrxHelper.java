...
public final class BoundingVolumeOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements BoundingVolumeOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _BoundingVolumeOutputPortDel __del = (_BoundingVolumeOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(BoundingVolume msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static BoundingVolumeOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        BoundingVolumeOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (BoundingVolumeOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::BoundingVolumeOutputPort"))
                {
                    BoundingVolumeOutputPortPrxHelper __h = new BoundingVolumeOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::BoundingVolumeOutputPort", __ctx))
                {
                    BoundingVolumeOutputPortPrxHelper __h = new BoundingVolumeOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::BoundingVolumeOutputPort"))
                {
                    BoundingVolumeOutputPortPrxHelper __h = new BoundingVolumeOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::BoundingVolumeOutputPort", __ctx))
                {
                    BoundingVolumeOutputPortPrxHelper __h = new BoundingVolumeOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _BoundingVolumeOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _BoundingVolumeOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, BoundingVolumeOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            BoundingVolumeOutputPortPrxHelper result = new BoundingVolumeOutputPortPrxHelper();
