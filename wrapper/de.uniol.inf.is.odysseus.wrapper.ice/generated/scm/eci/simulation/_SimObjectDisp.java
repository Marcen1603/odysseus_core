...
public abstract class _SimObjectDisp extends Ice.ObjectImpl implements SimObject
{
    protected void
    ...
    ___getLocalTransform(SimObject __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        TransformState __ret = __obj.getLocalTransform(__current);
    ...
    public static Ice.DispatchStatus
    ___getWorldTransform(SimObject __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        TransformState __ret = __obj.getWorldTransform(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    public static Ice.DispatchStatus
    ___getTransformOutputPort(SimObject __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        TransformStateOutputPortPrx __ret = __obj.getTransformOutputPort(__current);
        TransformStateOutputPortPrxHelper.__write(__os, __ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___getResourceUID(SimObject __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        String __ret = __obj.getResourceUID(__current);
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 9:
            {
                return ___getLocalTransform(this, in, __current);
            }
            case 10:
            {
            ...
            case 17:
            {
                return ___getResourceUID(this, in, __current);
            }
            case 18:
            {
                return ___getTransformOutputPort(this, in, __current);
            }
            case 19:
            {
            ...
            case 20:
            {
                return ___getWorldTransform(this, in, __current);
            }
            case 21:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::SimObject was not generated with stream support";
        throw ex;
    }
