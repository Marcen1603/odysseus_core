...
public abstract class _BoundingSphereOutputPortDisp extends Ice.ObjectImpl implements BoundingSphereOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::BoundingSphereOutputPort"
    };
    ...
    ___send(BoundingSphereOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        BoundingSphereHolder msg = new BoundingSphereHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::BoundingSphereOutputPort was not generated with stream support";
        throw ex;
    }
