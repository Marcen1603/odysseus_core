...
public final class BoundingSphereInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements BoundingSphereInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _BoundingSphereInputPortDel __del = (_BoundingSphereInputPortDel)__delBase;
    ...
    public static BoundingSphereInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        BoundingSphereInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (BoundingSphereInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::BoundingSphereInputPort"))
                {
                    BoundingSphereInputPortPrxHelper __h = new BoundingSphereInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::BoundingSphereInputPort", __ctx))
                {
                    BoundingSphereInputPortPrxHelper __h = new BoundingSphereInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::BoundingSphereInputPort"))
                {
                    BoundingSphereInputPortPrxHelper __h = new BoundingSphereInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::BoundingSphereInputPort", __ctx))
                {
                    BoundingSphereInputPortPrxHelper __h = new BoundingSphereInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _BoundingSphereInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _BoundingSphereInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, BoundingSphereInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            BoundingSphereInputPortPrxHelper result = new BoundingSphereInputPortPrxHelper();
