...
public final class SimLaserscannerPrxHelper extends Ice.ObjectPrxHelperBase implements SimLaserscannerPrx
{
    public int
    getFrequency()
    {
    ...
    getFrequency(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _SimLaserscannerDel __del = (_SimLaserscannerDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private scm.eci.laser.LaserMeasurementOutputPortPrx
    ...
    {
        setRange(min, max, null, false);
    }

    public void
    setRange(double min, double max, java.util.Map<String, String> __ctx)
    {
        setRange(min, max, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    setRange(double min, double max, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static SimLaserscannerPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        SimLaserscannerPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (SimLaserscannerPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::SimLaserscanner"))
                {
                    SimLaserscannerPrxHelper __h = new SimLaserscannerPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::SimLaserscanner", __ctx))
                {
                    SimLaserscannerPrxHelper __h = new SimLaserscannerPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::SimLaserscanner"))
                {
                    SimLaserscannerPrxHelper __h = new SimLaserscannerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::SimLaserscanner", __ctx))
                {
                    SimLaserscannerPrxHelper __h = new SimLaserscannerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _SimLaserscannerDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _SimLaserscannerDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, SimLaserscannerPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            SimLaserscannerPrxHelper result = new SimLaserscannerPrxHelper();
