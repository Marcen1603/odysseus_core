...
public abstract class _BoundingSphereInputPortDisp extends Ice.ObjectImpl implements BoundingSphereInputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::BoundingSphereInputPort"
    };
    ...
    public final BoundingSphereMessage
    getMessage()
    {
        return getMessage(null);
    }

    public final BoundingSphere
    getValue()
    {
    ...
    ___getMessage(BoundingSphereInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        BoundingSphereMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(BoundingSphereInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        BoundingSphere __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::BoundingSphereInputPort was not generated with stream support";
        throw ex;
    }
