...
public abstract class _AABBOutputPortDisp extends Ice.ObjectImpl implements AABBOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::AABBOutputPort"
    };
    ...
    ___send(AABBOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        AABBHolder msg = new AABBHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::AABBOutputPort was not generated with stream support";
        throw ex;
    }
