...
public final class AABBOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements AABBOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _AABBOutputPortDel __del = (_AABBOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(AABB msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static AABBOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        AABBOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (AABBOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::AABBOutputPort"))
                {
                    AABBOutputPortPrxHelper __h = new AABBOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::AABBOutputPort", __ctx))
                {
                    AABBOutputPortPrxHelper __h = new AABBOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::AABBOutputPort"))
                {
                    AABBOutputPortPrxHelper __h = new AABBOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::AABBOutputPort", __ctx))
                {
                    AABBOutputPortPrxHelper __h = new AABBOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _AABBOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _AABBOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, AABBOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            AABBOutputPortPrxHelper result = new AABBOutputPortPrxHelper();
