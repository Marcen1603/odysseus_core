...
public final class TransformStateOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements TransformStateOutputPortPrx
{
    public boolean
    ...
    connect(scm.eci.rt.InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _TransformStateOutputPortDel __del = (_TransformStateOutputPortDel)__delBase;
    ...
    @SuppressWarnings("unchecked")
    private void
    send(TransformState msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static TransformStateOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        TransformStateOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (TransformStateOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::TransformStateOutputPort"))
                {
                    TransformStateOutputPortPrxHelper __h = new TransformStateOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::TransformStateOutputPort", __ctx))
                {
                    TransformStateOutputPortPrxHelper __h = new TransformStateOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::TransformStateOutputPort"))
                {
                    TransformStateOutputPortPrxHelper __h = new TransformStateOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::TransformStateOutputPort", __ctx))
                {
                    TransformStateOutputPortPrxHelper __h = new TransformStateOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _TransformStateOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _TransformStateOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, TransformStateOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            TransformStateOutputPortPrxHelper result = new TransformStateOutputPortPrxHelper();
