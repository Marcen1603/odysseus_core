...
public final class ScenarioPrxHelper extends Ice.ObjectPrxHelperBase implements ScenarioPrx
{
    ...
    getInputPort(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ScenarioDel __del = (_ScenarioDel)__delBase;
    ...
    public scm.eci.StringOutputPortPrx
    getAgentCreatedOutputPort()
    {
        return getAgentCreatedOutputPort(null, false);
    }

    public scm.eci.StringOutputPortPrx
    getAgentCreatedOutputPort(java.util.Map<String, String> __ctx)
    {
        return getAgentCreatedOutputPort(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private scm.eci.StringOutputPortPrx
    getAgentCreatedOutputPort(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getAgentCreatedOutputPort");
                __delBase = __getDelegate(false);
                _ScenarioDel __del = (_ScenarioDel)__delBase;
                return __del.getAgentCreatedOutputPort(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    {
        return getAgentDeletedOutputPort(null, false);
    }

    public scm.eci.StringOutputPortPrx
    getAgentDeletedOutputPort(java.util.Map<String, String> __ctx)
    {
        return getAgentDeletedOutputPort(__ctx, true);
    }

    @SuppressWarnings("unchecked")
    private scm.eci.StringOutputPortPrx
    getAgentDeletedOutputPort(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getAgentDeletedOutputPort");
                __delBase = __getDelegate(false);
                _ScenarioDel __del = (_ScenarioDel)__delBase;
                return __del.getAgentDeletedOutputPort(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    public SimAgentPrx[]
    getAgents(java.util.Map<String, String> __ctx)
    {
    ...
    @SuppressWarnings("unchecked")
    private SimAgentPrx[]
    getAgents(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    {
        return getObjectByName(uid, null, false);
    }

    public SimObjectPrx
    getObjectByName(String uid, java.util.Map<String, String> __ctx)
    {
        return getObjectByName(uid, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private SimObjectPrx
    getObjectByName(String uid, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                ...
                __delBase = __getDelegate(false);
                _ScenarioDel __del = (_ScenarioDel)__delBase;
                return __del.getObjectByName(uid, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
    ...
    public static ScenarioPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ScenarioPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ScenarioPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::Scenario"))
                {
                    ScenarioPrxHelper __h = new ScenarioPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::Scenario", __ctx))
                {
                    ScenarioPrxHelper __h = new ScenarioPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::Scenario"))
                {
                    ScenarioPrxHelper __h = new ScenarioPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::Scenario", __ctx))
                {
                    ScenarioPrxHelper __h = new ScenarioPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ScenarioDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ScenarioDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ScenarioPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ScenarioPrxHelper result = new ScenarioPrxHelper();
