...
public abstract class _TransformStateInputPortDisp extends Ice.ObjectImpl implements TransformStateInputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::TransformStateInputPort"
    };
    ...
    public final TransformStateMessage
    getMessage()
    {
    ...
    ___getMessage(TransformStateInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        TransformStateMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(TransformStateInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        TransformState __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::TransformStateInputPort was not generated with stream support";
        throw ex;
    }
