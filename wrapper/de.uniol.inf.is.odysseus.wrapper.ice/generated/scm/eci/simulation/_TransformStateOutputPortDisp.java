...
public abstract class _TransformStateOutputPortDisp extends Ice.ObjectImpl implements TransformStateOutputPort
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::TransformStateOutputPort"
    };
    ...
    ___send(TransformStateOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        TransformStateHolder msg = new TransformStateHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::TransformStateOutputPort was not generated with stream support";
        throw ex;
    }
