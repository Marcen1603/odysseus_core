...
public final class TransformStateInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements TransformStateInputPortPrx
{
    public boolean
    getCycle()
    {
    ...
    getCycle(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _TransformStateInputPortDel __del = (_TransformStateInputPortDel)__delBase;
    ...
    public static TransformStateInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        TransformStateInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (TransformStateInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::simulation::TransformStateInputPort"))
                {
                    TransformStateInputPortPrxHelper __h = new TransformStateInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::simulation::TransformStateInputPort", __ctx))
                {
                    TransformStateInputPortPrxHelper __h = new TransformStateInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::TransformStateInputPort"))
                {
                    TransformStateInputPortPrxHelper __h = new TransformStateInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::simulation::TransformStateInputPort", __ctx))
                {
                    TransformStateInputPortPrxHelper __h = new TransformStateInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _TransformStateInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _TransformStateInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, TransformStateInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            TransformStateInputPortPrxHelper result = new TransformStateInputPortPrxHelper();
