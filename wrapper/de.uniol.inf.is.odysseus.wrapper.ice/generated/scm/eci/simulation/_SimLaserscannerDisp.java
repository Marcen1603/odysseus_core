...
public abstract class _SimLaserscannerDisp extends Ice.ObjectImpl implements SimLaserscanner
{
    protected void
    ...
    public static final String[] __ids =
    {
        ...
        "::scm::eci::simulation::SimLaserscanner",
    ...
    public final scm.eci.laser.LaserMeasurementOutputPortPrx
    getScanOutputPort()
    {
    ...
    ___setRange(SimLaserscanner __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        max = __is.readDouble();
        __is.endReadEncaps();
        __obj.setRange(min, max, __current);
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 6:
            {
                return scm.eci.laser._LaserscannerDisp.___getAngleResolution(this, in, __current);
            }
            case 7:
            {
            ...
            case 15:
            {
                return scm.eci.laser._LaserscannerDisp.___getMaxRange(this, in, __current);
            }
            case 16:
            {
                return scm.eci.laser._LaserscannerDisp.___getMinRange(this, in, __current);
            }
            case 17:
            {
            ...
            case 25:
            {
                return scm.eci.laser._LaserscannerDisp.___getScanAngle(this, in, __current);
            }
            case 26:
            {
                return scm.eci.laser._LaserscannerDisp.___getScanOutputPort(this, in, __current);
            }
            case 27:
            {
            ...
            case 43:
            {
                return scm.eci.laser._LaserscannerDisp.___setAngleResolution(this, in, __current);
            }
            case 44:
            {
            ...
            case 45:
            {
                return ___setRange(this, in, __current);
            }
            case 46:
            {
                return scm.eci.laser._LaserscannerDisp.___setScanAngle(this, in, __current);
            }
        }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::simulation::SimLaserscanner was not generated with stream support";
        throw ex;
    }
