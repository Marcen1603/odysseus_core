...
public final class StringOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements StringOutputPortPrx
{
    public void
    send(String msg)
    {
    ...
    private void
    send(String msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _StringOutputPortDel __del = (_StringOutputPortDel)__delBase;
    ...
    public static StringOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        StringOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (StringOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::StringOutputPort"))
                {
                    StringOutputPortPrxHelper __h = new StringOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::StringOutputPort", __ctx))
                {
                    StringOutputPortPrxHelper __h = new StringOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::StringOutputPort"))
                {
                    StringOutputPortPrxHelper __h = new StringOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::StringOutputPort", __ctx))
                {
                    StringOutputPortPrxHelper __h = new StringOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _StringOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _StringOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, StringOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            StringOutputPortPrxHelper result = new StringOutputPortPrxHelper();
