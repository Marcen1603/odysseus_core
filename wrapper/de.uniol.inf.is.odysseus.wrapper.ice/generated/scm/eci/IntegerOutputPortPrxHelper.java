...
public final class IntegerOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements IntegerOutputPortPrx
{
    public void
    send(int msg)
    {
    ...
    private void
    send(int msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _IntegerOutputPortDel __del = (_IntegerOutputPortDel)__delBase;
    ...
    public static IntegerOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        IntegerOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (IntegerOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::IntegerOutputPort"))
                {
                    IntegerOutputPortPrxHelper __h = new IntegerOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::IntegerOutputPort", __ctx))
                {
                    IntegerOutputPortPrxHelper __h = new IntegerOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::IntegerOutputPort"))
                {
                    IntegerOutputPortPrxHelper __h = new IntegerOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::IntegerOutputPort", __ctx))
                {
                    IntegerOutputPortPrxHelper __h = new IntegerOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _IntegerOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _IntegerOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, IntegerOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            IntegerOutputPortPrxHelper result = new IntegerOutputPortPrxHelper();
