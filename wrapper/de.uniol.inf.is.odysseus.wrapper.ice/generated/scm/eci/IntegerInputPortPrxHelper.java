...
public final class IntegerInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements IntegerInputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _IntegerInputPortDel __del = (_IntegerInputPortDel)__delBase;
    ...
    public static IntegerInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        IntegerInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (IntegerInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::IntegerInputPort"))
                {
                    IntegerInputPortPrxHelper __h = new IntegerInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::IntegerInputPort", __ctx))
                {
                    IntegerInputPortPrxHelper __h = new IntegerInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::IntegerInputPort"))
                {
                    IntegerInputPortPrxHelper __h = new IntegerInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::IntegerInputPort", __ctx))
                {
                    IntegerInputPortPrxHelper __h = new IntegerInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _IntegerInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _IntegerInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, IntegerInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            IntegerInputPortPrxHelper result = new IntegerInputPortPrxHelper();
