...
public abstract class _Matrix3x3OutputPortDisp extends Ice.ObjectImpl implements Matrix3x3OutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Matrix3x3OutputPort",
    ...
    ___send(Matrix3x3OutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        Matrix3x3Holder msg = new Matrix3x3Holder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Matrix3x3OutputPort was not generated with stream support";
        throw ex;
    }
