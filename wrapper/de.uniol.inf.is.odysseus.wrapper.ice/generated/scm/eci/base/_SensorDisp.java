...
public abstract class _SensorDisp extends Ice.ObjectImpl implements Sensor
{
    ...
    ___getFrequency(Sensor __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getFrequency(__current);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___setFrequency(Sensor __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        ...
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        boolean __ret = __obj.setFrequency(newValue, __current);
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 4:
            {
                return ___getFrequency(this, in, __current);
            }
            case 5:
            {
            ...
            case 24:
            {
                return ___setFrequency(this, in, __current);
            }
        }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Sensor was not generated with stream support";
        throw ex;
    }
