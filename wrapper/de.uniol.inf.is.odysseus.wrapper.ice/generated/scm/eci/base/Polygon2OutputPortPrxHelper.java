...
public final class Polygon2OutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Polygon2OutputPortPrx
{
    public void
    send(Polygon2 msg)
    {
    ...
    private void
    send(Polygon2 msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Polygon2OutputPortDel __del = (_Polygon2OutputPortDel)__delBase;
    ...
    public static Polygon2OutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Polygon2OutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Polygon2OutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon2OutputPort"))
                {
                    Polygon2OutputPortPrxHelper __h = new Polygon2OutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon2OutputPort", __ctx))
                {
                    Polygon2OutputPortPrxHelper __h = new Polygon2OutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon2OutputPort"))
                {
                    Polygon2OutputPortPrxHelper __h = new Polygon2OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon2OutputPort", __ctx))
                {
                    Polygon2OutputPortPrxHelper __h = new Polygon2OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Polygon2OutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Polygon2OutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Polygon2OutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Polygon2OutputPortPrxHelper result = new Polygon2OutputPortPrxHelper();
