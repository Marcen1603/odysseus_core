...
public final class Vector3OutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Vector3OutputPortPrx
{
    public void
    send(Vector3 msg)
    {
    ...
    private void
    send(Vector3 msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Vector3OutputPortDel __del = (_Vector3OutputPortDel)__delBase;
    ...
    public static Vector3OutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Vector3OutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Vector3OutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Vector3OutputPort"))
                {
                    Vector3OutputPortPrxHelper __h = new Vector3OutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Vector3OutputPort", __ctx))
                {
                    Vector3OutputPortPrxHelper __h = new Vector3OutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector3OutputPort"))
                {
                    Vector3OutputPortPrxHelper __h = new Vector3OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector3OutputPort", __ctx))
                {
                    Vector3OutputPortPrxHelper __h = new Vector3OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Vector3OutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Vector3OutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Vector3OutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Vector3OutputPortPrxHelper result = new Vector3OutputPortPrxHelper();
