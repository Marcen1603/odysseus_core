...
public final class PoseOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements PoseOutputPortPrx
{
    public void
    send(Pose msg)
    {
    ...
    private void
    send(Pose msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _PoseOutputPortDel __del = (_PoseOutputPortDel)__delBase;
    ...
    public static PoseOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        PoseOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (PoseOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::PoseOutputPort"))
                {
                    PoseOutputPortPrxHelper __h = new PoseOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::PoseOutputPort", __ctx))
                {
                    PoseOutputPortPrxHelper __h = new PoseOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::PoseOutputPort"))
                {
                    PoseOutputPortPrxHelper __h = new PoseOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::PoseOutputPort", __ctx))
                {
                    PoseOutputPortPrxHelper __h = new PoseOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _PoseOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _PoseOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, PoseOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            PoseOutputPortPrxHelper result = new PoseOutputPortPrxHelper();
