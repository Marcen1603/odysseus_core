...
public abstract class _Polygon2InputPortDisp extends Ice.ObjectImpl implements Polygon2InputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Polygon2InputPort",
    ...
    public final Polygon2Message
    getMessage()
    {
        return getMessage(null);
    }

    public final Polygon2
    getValue()
    {
    ...
    ___getMessage(Polygon2InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Polygon2Message __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(Polygon2InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Polygon2 __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Polygon2InputPort was not generated with stream support";
        throw ex;
    }
