...
public final class Vector2InputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Vector2InputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Vector2InputPortDel __del = (_Vector2InputPortDel)__delBase;
    ...
    public static Vector2InputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Vector2InputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Vector2InputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Vector2InputPort"))
                {
                    Vector2InputPortPrxHelper __h = new Vector2InputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Vector2InputPort", __ctx))
                {
                    Vector2InputPortPrxHelper __h = new Vector2InputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector2InputPort"))
                {
                    Vector2InputPortPrxHelper __h = new Vector2InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector2InputPort", __ctx))
                {
                    Vector2InputPortPrxHelper __h = new Vector2InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Vector2InputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Vector2InputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Vector2InputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Vector2InputPortPrxHelper result = new Vector2InputPortPrxHelper();
