...
public final class Matrix4x4InputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Matrix4x4InputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Matrix4x4InputPortDel __del = (_Matrix4x4InputPortDel)__delBase;
    ...
    public static Matrix4x4InputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Matrix4x4InputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Matrix4x4InputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix4x4InputPort"))
                {
                    Matrix4x4InputPortPrxHelper __h = new Matrix4x4InputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix4x4InputPort", __ctx))
                {
                    Matrix4x4InputPortPrxHelper __h = new Matrix4x4InputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix4x4InputPort"))
                {
                    Matrix4x4InputPortPrxHelper __h = new Matrix4x4InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix4x4InputPort", __ctx))
                {
                    Matrix4x4InputPortPrxHelper __h = new Matrix4x4InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Matrix4x4InputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Matrix4x4InputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Matrix4x4InputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Matrix4x4InputPortPrxHelper result = new Matrix4x4InputPortPrxHelper();
