...
public final class Vector2OutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Vector2OutputPortPrx
{
    public void
    send(Vector2 msg)
    {
    ...
    private void
    send(Vector2 msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Vector2OutputPortDel __del = (_Vector2OutputPortDel)__delBase;
    ...
    public static Vector2OutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Vector2OutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Vector2OutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Vector2OutputPort"))
                {
                    Vector2OutputPortPrxHelper __h = new Vector2OutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Vector2OutputPort", __ctx))
                {
                    Vector2OutputPortPrxHelper __h = new Vector2OutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector2OutputPort"))
                {
                    Vector2OutputPortPrxHelper __h = new Vector2OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector2OutputPort", __ctx))
                {
                    Vector2OutputPortPrxHelper __h = new Vector2OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Vector2OutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Vector2OutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Vector2OutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Vector2OutputPortPrxHelper result = new Vector2OutputPortPrxHelper();
