...
public abstract class _FileOutputPortDisp extends Ice.ObjectImpl implements FileOutputPort
{
    protected void
    ...
    ___send(FileOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        FileHolder msg = new FileHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::FileOutputPort was not generated with stream support";
        throw ex;
    }
