...
public final class Polygon3InputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Polygon3InputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Polygon3InputPortDel __del = (_Polygon3InputPortDel)__delBase;
    ...
    public static Polygon3InputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Polygon3InputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Polygon3InputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon3InputPort"))
                {
                    Polygon3InputPortPrxHelper __h = new Polygon3InputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon3InputPort", __ctx))
                {
                    Polygon3InputPortPrxHelper __h = new Polygon3InputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon3InputPort"))
                {
                    Polygon3InputPortPrxHelper __h = new Polygon3InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon3InputPort", __ctx))
                {
                    Polygon3InputPortPrxHelper __h = new Polygon3InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Polygon3InputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Polygon3InputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Polygon3InputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Polygon3InputPortPrxHelper result = new Polygon3InputPortPrxHelper();
