...
public abstract class _DistanceOutputPortDisp extends Ice.ObjectImpl implements DistanceOutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::DistanceOutputPort",
    ...
    ___send(DistanceOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        DistanceHolder msg = new DistanceHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::DistanceOutputPort was not generated with stream support";
        throw ex;
    }
