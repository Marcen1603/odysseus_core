...
public abstract class _Matrix4x4OutputPortDisp extends Ice.ObjectImpl implements Matrix4x4OutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Matrix4x4OutputPort",
    ...
    ___send(Matrix4x4OutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        Matrix4x4Holder msg = new Matrix4x4Holder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Matrix4x4OutputPort was not generated with stream support";
        throw ex;
    }
