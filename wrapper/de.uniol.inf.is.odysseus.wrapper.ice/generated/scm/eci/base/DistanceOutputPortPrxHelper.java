...
public final class DistanceOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DistanceOutputPortPrx
{
    public void
    send(Distance msg)
    {
    ...
    private void
    send(Distance msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DistanceOutputPortDel __del = (_DistanceOutputPortDel)__delBase;
    ...
    public static DistanceOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DistanceOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DistanceOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::DistanceOutputPort"))
                {
                    DistanceOutputPortPrxHelper __h = new DistanceOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::DistanceOutputPort", __ctx))
                {
                    DistanceOutputPortPrxHelper __h = new DistanceOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::DistanceOutputPort"))
                {
                    DistanceOutputPortPrxHelper __h = new DistanceOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::DistanceOutputPort", __ctx))
                {
                    DistanceOutputPortPrxHelper __h = new DistanceOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DistanceOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DistanceOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DistanceOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DistanceOutputPortPrxHelper result = new DistanceOutputPortPrxHelper();
