...
public abstract class _PoseOutputPortDisp extends Ice.ObjectImpl implements PoseOutputPort
{
    protected void
    ...
    ___send(PoseOutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        PoseHolder msg = new PoseHolder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::PoseOutputPort was not generated with stream support";
        throw ex;
    }
