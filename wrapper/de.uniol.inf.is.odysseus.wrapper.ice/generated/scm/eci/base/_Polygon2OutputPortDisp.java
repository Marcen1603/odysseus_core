...
public abstract class _Polygon2OutputPortDisp extends Ice.ObjectImpl implements Polygon2OutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Polygon2OutputPort",
    ...
    ___send(Polygon2OutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        Polygon2Holder msg = new Polygon2Holder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Polygon2OutputPort was not generated with stream support";
        throw ex;
    }
