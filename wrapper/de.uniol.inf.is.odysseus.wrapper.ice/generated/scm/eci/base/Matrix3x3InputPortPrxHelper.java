...
public final class Matrix3x3InputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Matrix3x3InputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Matrix3x3InputPortDel __del = (_Matrix3x3InputPortDel)__delBase;
    ...
    public static Matrix3x3InputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Matrix3x3InputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Matrix3x3InputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix3x3InputPort"))
                {
                    Matrix3x3InputPortPrxHelper __h = new Matrix3x3InputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix3x3InputPort", __ctx))
                {
                    Matrix3x3InputPortPrxHelper __h = new Matrix3x3InputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix3x3InputPort"))
                {
                    Matrix3x3InputPortPrxHelper __h = new Matrix3x3InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix3x3InputPort", __ctx))
                {
                    Matrix3x3InputPortPrxHelper __h = new Matrix3x3InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Matrix3x3InputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Matrix3x3InputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Matrix3x3InputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Matrix3x3InputPortPrxHelper result = new Matrix3x3InputPortPrxHelper();
