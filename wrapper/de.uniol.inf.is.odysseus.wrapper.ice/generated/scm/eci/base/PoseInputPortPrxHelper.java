...
public final class PoseInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements PoseInputPortPrx
{
    public PoseMessage
    getMessage()
    {
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _PoseInputPortDel __del = (_PoseInputPortDel)__delBase;
    ...
    public static PoseInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        PoseInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (PoseInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::PoseInputPort"))
                {
                    PoseInputPortPrxHelper __h = new PoseInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::PoseInputPort", __ctx))
                {
                    PoseInputPortPrxHelper __h = new PoseInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::PoseInputPort"))
                {
                    PoseInputPortPrxHelper __h = new PoseInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::PoseInputPort", __ctx))
                {
                    PoseInputPortPrxHelper __h = new PoseInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _PoseInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _PoseInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, PoseInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            PoseInputPortPrxHelper result = new PoseInputPortPrxHelper();
