...
public abstract class _Matrix4x4InputPortDisp extends Ice.ObjectImpl implements Matrix4x4InputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Matrix4x4InputPort",
    ...
    public final Matrix4x4Message
    getMessage()
    {
        return getMessage(null);
    }

    public final Matrix4x4
    getValue()
    {
    ...
    ___getMessage(Matrix4x4InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Matrix4x4Message __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(Matrix4x4InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Matrix4x4 __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Matrix4x4InputPort was not generated with stream support";
        throw ex;
    }
