...
public abstract class _BaseFacadeDisp extends Ice.ObjectImpl implements BaseFacade
{
    protected void
    ...
    ___getObjectByUID(BaseFacade __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus
    ___releaseObjectByUID(BaseFacade __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::BaseFacade was not generated with stream support";
        throw ex;
    }
