...
public abstract class _PoseInputPortDisp extends Ice.ObjectImpl implements PoseInputPort
{
    protected void
    ...
    ___getMessage(PoseInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        PoseMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(PoseInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Pose __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::PoseInputPort was not generated with stream support";
        throw ex;
    }
