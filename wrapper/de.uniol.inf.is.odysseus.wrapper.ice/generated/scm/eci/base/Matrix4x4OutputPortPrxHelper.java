...
public final class Matrix4x4OutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Matrix4x4OutputPortPrx
{
    public void
    send(Matrix4x4 msg)
    {
    ...
    private void
    send(Matrix4x4 msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Matrix4x4OutputPortDel __del = (_Matrix4x4OutputPortDel)__delBase;
    ...
    public static Matrix4x4OutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Matrix4x4OutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Matrix4x4OutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix4x4OutputPort"))
                {
                    Matrix4x4OutputPortPrxHelper __h = new Matrix4x4OutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix4x4OutputPort", __ctx))
                {
                    Matrix4x4OutputPortPrxHelper __h = new Matrix4x4OutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix4x4OutputPort"))
                {
                    Matrix4x4OutputPortPrxHelper __h = new Matrix4x4OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix4x4OutputPort", __ctx))
                {
                    Matrix4x4OutputPortPrxHelper __h = new Matrix4x4OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Matrix4x4OutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Matrix4x4OutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Matrix4x4OutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Matrix4x4OutputPortPrxHelper result = new Matrix4x4OutputPortPrxHelper();
