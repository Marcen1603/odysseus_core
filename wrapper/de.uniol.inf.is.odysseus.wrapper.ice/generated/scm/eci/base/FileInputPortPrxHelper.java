...
public final class FileInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements FileInputPortPrx
{
    public FileMessage
    getMessage()
    {
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _FileInputPortDel __del = (_FileInputPortDel)__delBase;
    ...
    public static FileInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        FileInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (FileInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::FileInputPort"))
                {
                    FileInputPortPrxHelper __h = new FileInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::FileInputPort", __ctx))
                {
                    FileInputPortPrxHelper __h = new FileInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::FileInputPort"))
                {
                    FileInputPortPrxHelper __h = new FileInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::FileInputPort", __ctx))
                {
                    FileInputPortPrxHelper __h = new FileInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _FileInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _FileInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, FileInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            FileInputPortPrxHelper result = new FileInputPortPrxHelper();
