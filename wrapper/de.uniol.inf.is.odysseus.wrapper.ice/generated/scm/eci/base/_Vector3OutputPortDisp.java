...
public abstract class _Vector3OutputPortDisp extends Ice.ObjectImpl implements Vector3OutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Vector3OutputPort",
    ...
    ___send(Vector3OutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        Vector3Holder msg = new Vector3Holder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Vector3OutputPort was not generated with stream support";
        throw ex;
    }
