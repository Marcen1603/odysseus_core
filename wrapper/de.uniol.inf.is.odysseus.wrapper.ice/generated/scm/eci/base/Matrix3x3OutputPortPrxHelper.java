...
public final class Matrix3x3OutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Matrix3x3OutputPortPrx
{
    public void
    send(Matrix3x3 msg)
    {
    ...
    private void
    send(Matrix3x3 msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Matrix3x3OutputPortDel __del = (_Matrix3x3OutputPortDel)__delBase;
    ...
    public static Matrix3x3OutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Matrix3x3OutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Matrix3x3OutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix3x3OutputPort"))
                {
                    Matrix3x3OutputPortPrxHelper __h = new Matrix3x3OutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Matrix3x3OutputPort", __ctx))
                {
                    Matrix3x3OutputPortPrxHelper __h = new Matrix3x3OutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix3x3OutputPort"))
                {
                    Matrix3x3OutputPortPrxHelper __h = new Matrix3x3OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Matrix3x3OutputPort", __ctx))
                {
                    Matrix3x3OutputPortPrxHelper __h = new Matrix3x3OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Matrix3x3OutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Matrix3x3OutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Matrix3x3OutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Matrix3x3OutputPortPrxHelper result = new Matrix3x3OutputPortPrxHelper();
