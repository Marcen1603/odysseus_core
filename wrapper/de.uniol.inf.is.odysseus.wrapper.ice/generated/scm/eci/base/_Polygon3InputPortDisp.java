...
public abstract class _Polygon3InputPortDisp extends Ice.ObjectImpl implements Polygon3InputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Polygon3InputPort",
    ...
    public final Polygon3Message
    getMessage()
    {
        return getMessage(null);
    }

    public final Polygon3
    getValue()
    {
    ...
    ___getMessage(Polygon3InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Polygon3Message __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(Polygon3InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Polygon3 __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Polygon3InputPort was not generated with stream support";
        throw ex;
    }
