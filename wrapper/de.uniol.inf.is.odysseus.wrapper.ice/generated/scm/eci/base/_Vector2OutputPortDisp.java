...
public abstract class _Vector2OutputPortDisp extends Ice.ObjectImpl implements Vector2OutputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Vector2OutputPort",
    ...
    ___send(Vector2OutputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        Vector2Holder msg = new Vector2Holder();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Vector2OutputPort was not generated with stream support";
        throw ex;
    }
