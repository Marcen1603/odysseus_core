...
public final class FileOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements FileOutputPortPrx
{
    public void
    send(File msg)
    {
    ...
    private void
    send(File msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _FileOutputPortDel __del = (_FileOutputPortDel)__delBase;
    ...
    public static FileOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        FileOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (FileOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::FileOutputPort"))
                {
                    FileOutputPortPrxHelper __h = new FileOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::FileOutputPort", __ctx))
                {
                    FileOutputPortPrxHelper __h = new FileOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::FileOutputPort"))
                {
                    FileOutputPortPrxHelper __h = new FileOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::FileOutputPort", __ctx))
                {
                    FileOutputPortPrxHelper __h = new FileOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _FileOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _FileOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, FileOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            FileOutputPortPrxHelper result = new FileOutputPortPrxHelper();
