...
public final class Polygon3OutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Polygon3OutputPortPrx
{
    public void
    send(Polygon3 msg)
    {
    ...
    private void
    send(Polygon3 msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Polygon3OutputPortDel __del = (_Polygon3OutputPortDel)__delBase;
    ...
    public static Polygon3OutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Polygon3OutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Polygon3OutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon3OutputPort"))
                {
                    Polygon3OutputPortPrxHelper __h = new Polygon3OutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon3OutputPort", __ctx))
                {
                    Polygon3OutputPortPrxHelper __h = new Polygon3OutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon3OutputPort"))
                {
                    Polygon3OutputPortPrxHelper __h = new Polygon3OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon3OutputPort", __ctx))
                {
                    Polygon3OutputPortPrxHelper __h = new Polygon3OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Polygon3OutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Polygon3OutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Polygon3OutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Polygon3OutputPortPrxHelper result = new Polygon3OutputPortPrxHelper();
