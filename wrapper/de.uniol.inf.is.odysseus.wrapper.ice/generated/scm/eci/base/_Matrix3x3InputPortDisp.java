...
public abstract class _Matrix3x3InputPortDisp extends Ice.ObjectImpl implements Matrix3x3InputPort
{
    protected void
    ...
    {
        "::Ice::Object",
        "::scm::eci::base::Matrix3x3InputPort",
    ...
    public final Matrix3x3Message
    getMessage()
    {
        return getMessage(null);
    }

    public final Matrix3x3
    getValue()
    {
    ...
    ___getMessage(Matrix3x3InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Matrix3x3Message __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(Matrix3x3InputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        Matrix3x3 __ret = __obj.getValue(__current);
        __os.writeObject(__ret);
        __os.writePendingObjects();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::base::Matrix3x3InputPort was not generated with stream support";
        throw ex;
    }
