...
public final class DistanceInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DistanceInputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DistanceInputPortDel __del = (_DistanceInputPortDel)__delBase;
    ...
    public static DistanceInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DistanceInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DistanceInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::DistanceInputPort"))
                {
                    DistanceInputPortPrxHelper __h = new DistanceInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::DistanceInputPort", __ctx))
                {
                    DistanceInputPortPrxHelper __h = new DistanceInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::DistanceInputPort"))
                {
                    DistanceInputPortPrxHelper __h = new DistanceInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::DistanceInputPort", __ctx))
                {
                    DistanceInputPortPrxHelper __h = new DistanceInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DistanceInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DistanceInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DistanceInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DistanceInputPortPrxHelper result = new DistanceInputPortPrxHelper();
