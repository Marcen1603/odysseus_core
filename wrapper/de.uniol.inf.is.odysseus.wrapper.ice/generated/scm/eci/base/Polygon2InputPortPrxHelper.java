...
public final class Polygon2InputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Polygon2InputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Polygon2InputPortDel __del = (_Polygon2InputPortDel)__delBase;
    ...
    public static Polygon2InputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Polygon2InputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Polygon2InputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon2InputPort"))
                {
                    Polygon2InputPortPrxHelper __h = new Polygon2InputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Polygon2InputPort", __ctx))
                {
                    Polygon2InputPortPrxHelper __h = new Polygon2InputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon2InputPort"))
                {
                    Polygon2InputPortPrxHelper __h = new Polygon2InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Polygon2InputPort", __ctx))
                {
                    Polygon2InputPortPrxHelper __h = new Polygon2InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Polygon2InputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Polygon2InputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Polygon2InputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Polygon2InputPortPrxHelper result = new Polygon2InputPortPrxHelper();
