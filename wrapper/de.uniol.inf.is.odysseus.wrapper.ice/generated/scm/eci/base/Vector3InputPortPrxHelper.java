...
public final class Vector3InputPortPrxHelper extends Ice.ObjectPrxHelperBase implements Vector3InputPortPrx
{
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _Vector3InputPortDel __del = (_Vector3InputPortDel)__delBase;
    ...
    public static Vector3InputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        Vector3InputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (Vector3InputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::base::Vector3InputPort"))
                {
                    Vector3InputPortPrxHelper __h = new Vector3InputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::base::Vector3InputPort", __ctx))
                {
                    Vector3InputPortPrxHelper __h = new Vector3InputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector3InputPort"))
                {
                    Vector3InputPortPrxHelper __h = new Vector3InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::base::Vector3InputPort", __ctx))
                {
                    Vector3InputPortPrxHelper __h = new Vector3InputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _Vector3InputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _Vector3InputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, Vector3InputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            Vector3InputPortPrxHelper result = new Vector3InputPortPrxHelper();
