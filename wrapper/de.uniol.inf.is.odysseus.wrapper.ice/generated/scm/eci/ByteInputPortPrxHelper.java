...
public final class ByteInputPortPrxHelper extends Ice.ObjectPrxHelperBase implements ByteInputPortPrx
{
    public ByteMessage
    getMessage()
    {
    ...
    getMessage(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ByteInputPortDel __del = (_ByteInputPortDel)__delBase;
    ...
    public static ByteInputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ByteInputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ByteInputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::ByteInputPort"))
                {
                    ByteInputPortPrxHelper __h = new ByteInputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::ByteInputPort", __ctx))
                {
                    ByteInputPortPrxHelper __h = new ByteInputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::ByteInputPort"))
                {
                    ByteInputPortPrxHelper __h = new ByteInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::ByteInputPort", __ctx))
                {
                    ByteInputPortPrxHelper __h = new ByteInputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ByteInputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ByteInputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ByteInputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ByteInputPortPrxHelper result = new ByteInputPortPrxHelper();
