...
public abstract class _DoubleInputPortDisp extends Ice.ObjectImpl implements DoubleInputPort
{
    protected void
    ...
    ___getMessage(DoubleInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        DoubleMessage __ret = __obj.getMessage(__current);
    ...
    public static Ice.DispatchStatus
    ___getValue(DoubleInputPort __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        double __ret = __obj.getValue(__current);
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type scm::eci::DoubleInputPort was not generated with stream support";
        throw ex;
    }
