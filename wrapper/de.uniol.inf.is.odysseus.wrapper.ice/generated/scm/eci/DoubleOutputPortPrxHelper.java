...
public final class DoubleOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements DoubleOutputPortPrx
{
    public void
    send(double msg)
    {
    ...
    private void
    send(double msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _DoubleOutputPortDel __del = (_DoubleOutputPortDel)__delBase;
    ...
    public static DoubleOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        DoubleOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (DoubleOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::DoubleOutputPort"))
                {
                    DoubleOutputPortPrxHelper __h = new DoubleOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::DoubleOutputPort", __ctx))
                {
                    DoubleOutputPortPrxHelper __h = new DoubleOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::DoubleOutputPort"))
                {
                    DoubleOutputPortPrxHelper __h = new DoubleOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::DoubleOutputPort", __ctx))
                {
                    DoubleOutputPortPrxHelper __h = new DoubleOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _DoubleOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _DoubleOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, DoubleOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            DoubleOutputPortPrxHelper result = new DoubleOutputPortPrxHelper();
