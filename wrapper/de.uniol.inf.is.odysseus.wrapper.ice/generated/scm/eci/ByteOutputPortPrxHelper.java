...
public final class ByteOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements ByteOutputPortPrx
{
    public void
    send(byte msg)
    {
    ...
    private void
    send(byte msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ByteOutputPortDel __del = (_ByteOutputPortDel)__delBase;
    ...
    public static ByteOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ByteOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ByteOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::ByteOutputPort"))
                {
                    ByteOutputPortPrxHelper __h = new ByteOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::ByteOutputPort", __ctx))
                {
                    ByteOutputPortPrxHelper __h = new ByteOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::ByteOutputPort"))
                {
                    ByteOutputPortPrxHelper __h = new ByteOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::ByteOutputPort", __ctx))
                {
                    ByteOutputPortPrxHelper __h = new ByteOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ByteOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ByteOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ByteOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ByteOutputPortPrxHelper result = new ByteOutputPortPrxHelper();
