...
public final class _ComponentDelM extends Ice._ObjectDelM implements _ComponentDel
{
    public InputPortPrx
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                InputPortPrx __ret;
                __ret = InputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                __is.startReadEncaps();
                InputPortPrx[] __ret;
                __ret = InputPortSeqHelper.read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                __is.startReadEncaps();
                OutputPortPrx __ret;
                __ret = OutputPortPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                __is.startReadEncaps();
                OutputPortPrx[] __ret;
                __ret = OutputPortSeqHelper.read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                __is.startReadEncaps();
                PropertyPrx __ret;
                __ret = PropertyPrxHelper.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
            catch(Ice.LocalException __ex)
