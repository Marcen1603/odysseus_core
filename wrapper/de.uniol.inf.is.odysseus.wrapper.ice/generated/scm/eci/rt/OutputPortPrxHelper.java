...
public final class OutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements OutputPortPrx
{
    public boolean
    ...
    public boolean
    connect(InputPortPrx target, java.util.Map<String, String> __ctx)
    {
    ...
    private boolean
    connect(InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _OutputPortDel __del = (_OutputPortDel)__delBase;
    ...
    public boolean
    disconnect(InputPortPrx target, java.util.Map<String, String> __ctx)
    {
    ...
    @SuppressWarnings("unchecked")
    private boolean
    disconnect(InputPortPrx target, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public boolean
    registerListener(PortListenerPrx listener, java.util.Map<String, String> __ctx)
    {
    ...
    @SuppressWarnings("unchecked")
    private boolean
    registerListener(PortListenerPrx listener, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public boolean
    removeListener(PortListenerPrx listener, java.util.Map<String, String> __ctx)
    {
    ...
    @SuppressWarnings("unchecked")
    private boolean
    removeListener(PortListenerPrx listener, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public void
    sendMessage(IMessage msg, java.util.Map<String, String> __ctx)
    {
    ...
    @SuppressWarnings("unchecked")
    private void
    sendMessage(IMessage msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public boolean
    setListener(PortListenerPrx[] newValue, java.util.Map<String, String> __ctx)
    {
    ...
    @SuppressWarnings("unchecked")
    private boolean
    setListener(PortListenerPrx[] newValue, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public static OutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        OutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (OutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::rt::OutputPort"))
                {
                    OutputPortPrxHelper __h = new OutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::rt::OutputPort", __ctx))
                {
                    OutputPortPrxHelper __h = new OutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::rt::OutputPort"))
                {
                    OutputPortPrxHelper __h = new OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::rt::OutputPort", __ctx))
                {
                    OutputPortPrxHelper __h = new OutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _OutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _OutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, OutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            OutputPortPrxHelper result = new OutputPortPrxHelper();
