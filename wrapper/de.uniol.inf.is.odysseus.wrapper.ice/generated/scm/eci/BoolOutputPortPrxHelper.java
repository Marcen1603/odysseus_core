...
public final class BoolOutputPortPrxHelper extends Ice.ObjectPrxHelperBase implements BoolOutputPortPrx
{
    public void
    send(boolean msg)
    {
    ...
    private void
    send(boolean msg, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _BoolOutputPortDel __del = (_BoolOutputPortDel)__delBase;
    ...
    public static BoolOutputPortPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        BoolOutputPortPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (BoolOutputPortPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::scm::eci::BoolOutputPort"))
                {
                    BoolOutputPortPrxHelper __h = new BoolOutputPortPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::scm::eci::BoolOutputPort", __ctx))
                {
                    BoolOutputPortPrxHelper __h = new BoolOutputPortPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::BoolOutputPort"))
                {
                    BoolOutputPortPrxHelper __h = new BoolOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::scm::eci::BoolOutputPort", __ctx))
                {
                    BoolOutputPortPrxHelper __h = new BoolOutputPortPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _BoolOutputPortDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _BoolOutputPortDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, BoolOutputPortPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            BoolOutputPortPrxHelper result = new BoolOutputPortPrxHelper();
