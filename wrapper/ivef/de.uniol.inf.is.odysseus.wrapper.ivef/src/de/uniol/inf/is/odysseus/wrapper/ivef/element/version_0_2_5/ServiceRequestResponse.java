 ...
 *
 */
public class ServiceRequestResponse implements IIvefElement { 
	...
	public void fillMap(KeyValueObject<? extends IMetaAttribute> map) {
		if(m_reasonPresent)
			map.addAttributeValue("serviceRequestResponse_reason", m_reason);
		if(m_responseOnPresent)
			map.addAttributeValue("serviceRequestResponse_responseOn", m_responseOn);
		if(m_resultPresent)
			map.addAttributeValue("serviceRequestResponse_result", m_result);
	}
}