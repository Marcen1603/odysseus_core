...
/**
 * The IEC60870-5-104 server transport handler implements the server stack of
 ...
 *
 */
public class IEC104ServerTransportHandler extends AbstractIEC104TransportHandler {

	/**
	 * The name of the transport handler for query languages.
	 */
	private static final String name = "IEC60870-5-104_Server";
	...
	/**
	 * The listener new IEC60870-5-104 clients.
	 */
	private IEC104ServerListener serverListener = new IEC104ServerListener(this);

	/**
	 * Empty default constructor. Needed to run as an OSGi service.
	 */
	public IEC104ServerTransportHandler() {
	}
	 ...
	 */
	public IEC104ServerTransportHandler(IProtocolHandler<?> protocolHandler, OptionMap options)
			throws UnknownHostException {
	...
	public ITransportHandler createInstance(IProtocolHandler<?> protocolHandler, OptionMap options) {
		try {
			return new IEC104ServerTransportHandler(protocolHandler, options);
	...
	private void startServer() throws IOException {
		server = new Server.Builder().setBindAddr(getHost()).setPort(getPort()).build();
	...
	public void send(Object message) throws IOException {
		if (message instanceof Tuple) {
			...
			serverListener.sendTuple(tuple);
		}
	}

	@Override
	public boolean isSemanticallyEqualImpl(ITransportHandler obj) {
		if (obj == null || !(obj instanceof IEC104ServerTransportHandler)) {
			return false;
		}

		IEC104ServerTransportHandler other = (IEC104ServerTransportHandler) obj;
