...
public class Measurement {
	...
	public String toString() {
		return "Measurement [version=" + this.version + ", device="
				+ this.device + ", serial=" + this.serial + ", status="
				+ this.status + ", messageCount=" + this.messageCount
				+ ", scanCount=" + this.scanCount + ", powerUpDuration="
				+ this.powerUpDuration + ", transmissionDuration="
				+ this.transmissionDuration + ", inputStatus="
				+ this.inputStatus + ", outputStatus=" + this.outputStatus
				+ ", scanningFrequency=" + this.scanningFrequency
				+ ", measurementFrequency=" + this.measurementFrequency
				+ ", encoders=" + this.encoders + ", encoderPosition="
				+ this.encoderPosition + ", encoderSpeed=" + this.encoderSpeed
				+ ", samples=" + Arrays.toString(this.samples) + "]";
	}
