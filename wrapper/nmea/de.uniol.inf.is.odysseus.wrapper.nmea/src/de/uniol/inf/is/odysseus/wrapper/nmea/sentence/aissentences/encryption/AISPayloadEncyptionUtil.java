...
public class AISPayloadEncyptionUtil {
	...
	public static StaticAndVoyageData decodeStaticAndVoyageData(EncodedAISPayload encodedMessage) {
		...
		ShipType shipType = ShipType.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(232, 240)));
		...
		PositionFixingDevice positionFixingDevice = PositionFixingDevice.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(270, 274)));
	...
	public static PositionReportClassA decodePositionReportClassA(EncodedAISPayload encodedMessage) {
		...
		return new PositionReportClassA(encodedMessage.getOriginalNmea(), AISMessageType.PositionReportClassA, repeatIndicator,
	...
	public static BaseStationReport decodeBaseStationReport(EncodedAISPayload encodedMessage) {
		...
		PositionFixingDevice positionFixingDevice = PositionFixingDevice.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(134, 138)));
		Boolean raimFlag = AISPayloadEncyptionUtil.convertToBoolean(encodedMessage.getBits(148, 149));
	...
	public static BinaryAddressedMessage decodeBinaryAddressedMessage(EncodedAISPayload encodedMessage) {
		...
		MMSI destinationMmsi = MMSI.valueOf(AISPayloadEncyptionUtil.convertToUnsignedLong(encodedMessage.getBits(40, 70)));
	...
	public static BinaryAcknowledge decodeBinaryAcknowledge(EncodedAISPayload encodedMessage) {
		...
		return new BinaryAcknowledge(encodedMessage.getOriginalNmea(), repeatIndicator, sourceMmsi, mmsi1, mmsi2, mmsi3, mmsi4);
	}
	...
	public static BinaryBroadcastMessage decodeBinaryBroadcastMessage(EncodedAISPayload encodedMessage) {
		...
		return new BinaryBroadcastMessage(encodedMessage.getOriginalNmea(), repeatIndicator, sourceMmsi, designatedAreaCode, functionalId, binaryData);
	}
	
	/**
	 *  StandardSARAircraftPositionReport
	 * */
	public static StandardSARAircraftPositionReport decodeStandardSARAircraftPositionReport(EncodedAISPayload encodedMessage) {
		if (! encodedMessage.isValid())
			throw new InvalidEncodedPayload(encodedMessage);
		...
		return new StandardSARAircraftPositionReport(encodedMessage.getOriginalNmea(), repeatIndicator,
	...
	public static AddressedSafetyRelatedMessage decodeAddressedSafetyRelatedMessage(EncodedAISPayload encodedMessage) {
		...
		return new AddressedSafetyRelatedMessage(encodedMessage.getOriginalNmea(), repeatIndicator, sourceMmsi, sequenceNumber, destinationMmsi, retransmit, text);
	}
	...
	public static Interrogation decodeInterrogation(EncodedAISPayload encodedMessage) {
		...
		Integer type1_2 = messageLength > 88 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(90, 96)) : null;
		Integer offset1_2 = messageLength > 88 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(96, 108)) : null;
		
		MMSI mmsi2 = messageLength > 160 ? MMSI.valueOf(AISPayloadEncyptionUtil.convertToUnsignedLong(encodedMessage.getBits(110, 140))) : null;
		Integer type2_1 = messageLength > 160 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(140, 146)) : null;
		Integer offset2_1 = messageLength > 160 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(146, 158)) : null;
	...
	public static AssignedModeCommand decodeAssignedModeCommand(EncodedAISPayload encodedMessage) {
		...
		MMSI destinationMmsiA = MMSI.valueOf(AISPayloadEncyptionUtil.convertToUnsignedLong(encodedMessage.getBits(40, 70)));
		...
		MMSI destinationMmsiB = messageLength >= 144 ? MMSI.valueOf(AISPayloadEncyptionUtil.convertToUnsignedLong(encodedMessage.getBits(92, 122))) : null;
		Integer offsetB = messageLength >= 144 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(122, 134)) : null;
		Integer incrementB = messageLength >= 144 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(134, 144)) : null;
	...
	public static DGNSSBinaryBroadcastMessage decodeDGNSSBinaryBroadcastMessage(EncodedAISPayload encodedMessage) {
		...
		return new DGNSSBinaryBroadcastMessage(encodedMessage.getOriginalNmea(), repeatIndicator, sourceMmsi, latitude, longitude, binaryData);
	}
	...
	public static ExtendedClassBEquipmentPositionReport decodeExtendedClassBEquipmentPositionReport(EncodedAISPayload encodedMessage) {
		...
		ShipType shipType = ShipType.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(263, 271)));
		...
		PositionFixingDevice positionFixingDevice = PositionFixingDevice.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(301, 305)));
	...
	public static DataLinkManagement decodeDataLinkManagement(EncodedAISPayload encodedMessage) {
		...
		Integer offsetNumber2 = n >= 100 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(70, 82)) : null;
		Integer reservedSlots2 = n >= 100 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(82, 86)) : null;
		Integer timeout2 = n >= 100 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(86, 89)) : null;
		Integer increment2 = n >= 100 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(89, 100)) : null;
		Integer offsetNumber3 = n >= 130 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(100, 112)) : null;
		Integer reservedSlots3 = n >= 130 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(112,116)) : null;
		Integer timeout3 = n >= 130 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(116, 119)) : null;
		Integer increment3 = n >= 130 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(119, 130)) : null;
		Integer offsetNumber4 = n >= 160 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(130, 142)) : null;
		Integer reservedSlots4 = n >= 160 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(142, 146)) : null;
		Integer timeout4 = n >= 160 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(146, 149)) : null;
		Integer increment4 = n >= 160 ? AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(149, 160)) : null;
	...
	public static AidToNavigationReport decodeAidToNavigationReport(EncodedAISPayload encodedMessage) {
		...
		AidType aidType = AidType.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(38, 43)));
		...
		PositionFixingDevice positionFixingDevice = PositionFixingDevice.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(249, 253)));
		...
		String nameExtension = AISPayloadEncyptionUtil.convertToString(encodedMessage.getBits(272, 361));
	...
	public static ChannelManagement decodeChannelManagement(EncodedAISPayload encodedMessage) {
		...
		TxRxMode transmitReceiveMode = TxRxMode.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(64, 68)));
		...
		MMSI destinationMmsi1 = !addressed ? null : MMSI.valueOf(AISPayloadEncyptionUtil.convertToUnsignedLong(encodedMessage.getBits(69, 99)));
		MMSI destinationMmsi2 = !addressed ? null : MMSI.valueOf(AISPayloadEncyptionUtil.convertToUnsignedLong(encodedMessage.getBits(104, 134)));
		Float northEastLatitude = addressed ? null : AISPayloadEncyptionUtil.convertToFloat(encodedMessage.getBits(87, 104)) / 10f;
		Float northEastLongitude = addressed ? null : AISPayloadEncyptionUtil.convertToFloat(encodedMessage.getBits(69, 87)) / 10f;
		Float southWestLatitude = addressed ? null : AISPayloadEncyptionUtil.convertToFloat(encodedMessage.getBits(122, 138)) / 10f;
		Float southWestLongitude = addressed ? null : AISPayloadEncyptionUtil.convertToFloat(encodedMessage.getBits(104, 122)) / 10f;
	...
	public static GroupAssignmentCommand decodeGroupAssignmentCommand(EncodedAISPayload encodedMessage) {
		...
		StationType stationType = StationType.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(143, 145)));
		ShipType shipType = ShipType.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(143, 145)));
		TxRxMode transmitReceiveMode = TxRxMode.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(128, 137)));
		ReportingInterval reportingInterval = ReportingInterval.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(143, 145)));
	...
	public static StaticDataReport decodeStaticDataReport(EncodedAISPayload encodedMessage) {
		...
		String shipName = partNumber == 1 ? null : AISPayloadEncyptionUtil.convertToString(encodedMessage.getBits(40, 160));
		ShipType shipType = partNumber == 0 ? null : ShipType.fromInteger(AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(40, 48)));
		String vendorId = partNumber == 0 ? null : AISPayloadEncyptionUtil.convertToString(encodedMessage.getBits(48, 90));
		String callsign = partNumber == 0 ? null : AISPayloadEncyptionUtil.convertToString(encodedMessage.getBits(90, 132));
		Integer toBow = partNumber == 0 ? null : AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(132, 141));
		Integer toStern = partNumber == 0 ? null : AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(141, 150));
		Integer toPort = partNumber == 0 ? null : AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(150, 156));
		Integer toStarboard = partNumber == 0 ? null : AISPayloadEncyptionUtil.convertToUnsignedInteger(encodedMessage.getBits(156, 162));
		MMSI mothershipMmsi = partNumber == 0 ? null : MMSI.valueOf(AISPayloadEncyptionUtil.convertToUnsignedLong(encodedMessage.getBits(132, 162)));
		
		return new StaticDataReport(encodedMessage.getOriginalNmea(), repeatIndicator, sourceMmsi, partNumber, shipName, shipType, vendorId, callsign, toBow, toStern, toStarboard, toPort, mothershipMmsi);
	}
