...
/**
 * A function to get the error of an OPC value.
 */
public class ErrorFunction extends AbstractFunction<Long> implements IMepFunction<Long> {
	...
	/**
	 * Instantiates a new error function.
	 */
