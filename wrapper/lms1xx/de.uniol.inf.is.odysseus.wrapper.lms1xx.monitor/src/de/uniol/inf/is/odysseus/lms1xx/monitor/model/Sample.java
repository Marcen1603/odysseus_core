 ...
 *******************************************************************************/
package de.uniol.inf.is.odysseus.lms1xx.monitor.model;
...
public class Sample {
    ...
    /**
     * @return The first distance vector in mm.
     */
    public Point2D getDist1Vector() {
        final double angle = this.getAngle();
        final Point2D vector = new Point2D.Double(this.getDist1() * Math.cos(angle), this.getDist1() * Math.sin(angle));
        return vector;
    }
    ...
    /**
     * 
     * @return The second distance vector in mm.
     */
    public Point2D getDist2Vector() {
        final double angle = this.getAngle();
        final Point2D vector = new Point2D.Double(this.getDist2() * Math.cos(angle), this.getDist2() * Math.sin(angle));
        return vector;
    }
    ...
    public String toCSVString() {
        ...
        sb.append(this.dist1).append(",");
        sb.append(this.rssi1).append(",");
        sb.append(this.dist2).append(",");
        sb.append(this.rssi2);
        return sb.toString();
    }
