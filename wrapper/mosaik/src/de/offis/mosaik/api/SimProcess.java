...
public class SimProcess {
    ...
    public static void startSimulation(Socket sock, Simulator sim) throws Exception {
        LogManager.getLogManager().addLogger(SimProcess.logger);
        SimProcess.logger.setLevel(Level.FINE);
        try {
//            SimProcess.logger.info("Starting " + sim.getSimName() + " ...");
    ...
    private static Logger logger = Logger.getLogger(SimProcess.class.getName());
    ...
    public SimProcess(Socket sock, Simulator sim) throws Exception {
        this.sock = new SimpyIoSocket(sock);
        this.sim = sim;
        this.stop = false;
