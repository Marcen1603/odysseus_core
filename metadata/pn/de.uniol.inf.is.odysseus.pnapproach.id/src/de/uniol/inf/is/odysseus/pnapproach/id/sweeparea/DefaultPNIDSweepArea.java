 ...
 * @author Andre Bolles
 */
public class DefaultPNIDSweepArea<T extends IMetaAttribute<? extends IPosNeg>>
		extends SweepArea<T> {
...
//			}
			...
			// Nur negative Elemente, die entweder keine falsch erzeugten Ergebnisse gelöscht haben oder
			// Wildcards in der ID enthalten werden hinzugefügt.
