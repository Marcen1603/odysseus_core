 ...
 */
public class EmptyRelationalTupleDataFactory<M_In extends IClone, 
										M_Out extends IClone> implements IDataFactory<M_In, M_Out, RelationalTuple<M_In>, RelationalTuple<M_Out>> {
