...
/**
 * abstract sla conformance super class for pipe operators. extends {@link AbstractSource} so the sla
 ...
 * @param <T>
 */
public abstract class AbstractSLAPipeConformance<R extends IStreamObject<?>, W extends IStreamObject<?>>
	extends AbstractPipe<R, W> implements ISLAConformance {
	/**
	 ...
	 *            the related query
	 */
	public AbstractSLAPipeConformance(ISLAViolationEventDistributor dist, SLA sla,
	 ...
	 * @param conformance
	 */
	protected AbstractSLAPipeConformance(AbstractSLAPipeConformance<R, W> conformance) {
	...
	public double getMetricValue() {
		return this.sla.getMetric().getValue();
	}
