...
//	private static final String TESTS_NAME = "Tuple Compare Test";
...
//		checkArgument(args.length == 3, "A Test Component needs exactly three arguments: [User], [Password], [FolderWithQueries]");
//		
