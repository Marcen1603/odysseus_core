...
abstract class ColumnViewerSorter extends ViewerComparator {
    ...
    public int compare(Viewer viewer, Object e1, Object e2) {
        return direction * doCompare(viewer, (OperatorStatistic)e1, (OperatorStatistic)e2);
    }

    protected abstract int doCompare(Viewer viewer, OperatorStatistic e1, OperatorStatistic e2);
}
