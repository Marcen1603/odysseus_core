...
public class SecurityPunctuationQueryBuildConfigurationTemplate extends
		AbstractQueryBuildConfigurationTemplate {

	public SecurityPunctuationQueryBuildConfigurationTemplate() {
	...
	public SecurityPunctuationQueryBuildConfigurationTemplate(List<IQueryBuildSetting<?>> settings) {
	...
	public IQueryBuildConfigurationTemplate clone() {		
		return new SecurityPunctuationQueryBuildConfigurationTemplate(settings);
	}
