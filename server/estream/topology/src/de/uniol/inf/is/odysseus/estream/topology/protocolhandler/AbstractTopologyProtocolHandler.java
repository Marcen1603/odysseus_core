...
abstract public class AbstractTopologyProtocolHandler<T extends KeyValueObject<?>> extends AbstractProtocolHandler<T> {
	...
	static Logger LOG = LoggerFactory.getLogger(AbstractTopologyProtocolHandler.class);

	public AbstractTopologyProtocolHandler() {
	}

	public AbstractTopologyProtocolHandler(ITransportDirection direction, IAccessPattern access,
	...
	public boolean isSemanticallyEqualImpl(IProtocolHandler<?> o) {
		if (!(o instanceof TopologyProtocolHandler)) {
			return false;
		}
