...
public class Measurement {
    ...
    public String toCSVString() {
        ...
        sb.append(this.messageCount).append(",");
        sb.append(this.scanCount).append(",");
        sb.append(this.powerUpDuration).append(",");
        sb.append(this.transmissionDuration).append(",");
        sb.append(this.inputStatus).append(",");
        sb.append(this.outputStatus).append(",");
        sb.append(this.scanningFrequency).append(",");
        sb.append(this.measurementFrequency).append(",");
