...
public class Measurement {
    ...
    public void set16BitSamples(final Sample[] samples) {
        this.samples16Bit = samples;
    }

    public void set8BitSamples(final Sample[] samples) {
        this.samples8Bit = samples;
    }
    ...
    public String toString() {
        return "Measurement [version=" + this.version + ", device=" + this.device + ", serial=" + this.serial
                + ", status=" + this.status + ", messageCount=" + this.messageCount + ", scanCount=" + this.scanCount
                + ", powerUpDuration=" + this.powerUpDuration + ", transmissionDuration=" + this.transmissionDuration
                + ", inputStatus=" + this.inputStatus + ", outputStatus=" + this.outputStatus + ", scanningFrequency="
                + this.scanningFrequency + ", measurementFrequency=" + this.measurementFrequency + ", encoders="
                + this.encoders + ", encoderPosition=" + this.encoderPosition + ", encoderSpeed=" + this.encoderSpeed
                + ", samples=" + Arrays.toString(this.samples16Bit) + "]";
    }
