...
public class TSASelectAORule extends AbstractTransformationRule<SelectAO> {
	...
	public boolean isExecutable(SelectAO operator, TransformationConfiguration transformConfig) {
		return operator.isAllPhysicalInputSet() && (transformConfig.getOption("isSecurityAware") != null) && (Boolean.parseBoolean((String)transformConfig.getOption("isSecurityAware")) ) ;
	}

	@Override
	public String getName() {
		return "SelectAO -> SASelectPO";
	}
