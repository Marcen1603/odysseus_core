...
public class TBufferedFilterPOAddDatarateMetadataMergeRule extends AbstractTransformationRule<BufferedFilterPO<?,?>> {
	...
	public String getName() {
		return "BufferedFilterPO add MetadataMerge (IDatarate)";
	}
}
