...
public class DestroyDistributedDataWithNodeIDMessage implements IMessage {

	private OdysseusNodeID nodeID;

	public DestroyDistributedDataWithNodeIDMessage() {
	}

	public DestroyDistributedDataWithNodeIDMessage(OdysseusNodeID nodeID) {
