...
public final class ParameterHelper {
	...
	private static List<InterfaceNameParametersPair> determineDefaultPostProcessors() throws QueryDistributionException {
		Optional<String> optDefaultPostProcessors = OdysseusNetConfiguration.get(DEFAULT_POSTPROCESSORS_CONFIG_KEY);
		List<InterfaceNameParametersPair> result = Lists.newArrayList();
		if( optDefaultPostProcessors.isPresent() ) {
			String defaultPostProcessors = optDefaultPostProcessors.get();
