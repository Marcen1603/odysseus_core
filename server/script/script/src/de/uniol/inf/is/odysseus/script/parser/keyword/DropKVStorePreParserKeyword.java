...
public class DropKVStorePreParserKeyword extends AbstractPreParserKeyword {

	public static final String KEYWORD = "DROP_KV_STORE";
	...
	public List<IExecutorCommand> execute(Map<String, Object> variables, String parameter, ISession caller,
		...
		cmds.add(new DropKVStoreCommand(name, caller));
		return cmds;
	}
