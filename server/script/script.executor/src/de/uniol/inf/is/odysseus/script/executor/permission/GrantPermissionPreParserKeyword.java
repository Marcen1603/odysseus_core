 ...
 */
public class GrantPermissionPreParserKeyword extends AbstractPreParserKeyword {

	public static final String NAME = "GRANTPERMISSIONS";
	...
	public List<IExecutorCommand>  execute(Map<String, Object> variables, String parameter, ISession caller, Context context, IServerExecutor executor) throws OdysseusScriptException {
		...
		cmds.add(new GrantPermissionCommand(userName, operations, object, caller));
		return cmds;
	}
