...
public class SuspendQueryPreParserKeyword extends AbstractPreParserKeyword {

	public static final String NAME = "SUSPENDQUERY";
	...
	public List<IExecutorCommand> execute(Map<String, Object> variables,
		...
		ret.add(new SuspendQueryCommand(caller, name));
		return ret;
	}
