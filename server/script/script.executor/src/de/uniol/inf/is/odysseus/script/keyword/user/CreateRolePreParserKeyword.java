 ...
 */
public class CreateRolePreParserKeyword extends AbstractPreParserKeyword {

	public static final String NAME = "CREATEROLE";
	...
	public List<IExecutorCommand>  execute(Map<String, Object> variables, String parameter, ISession caller, Context context, IServerExecutor executor) throws OdysseusScriptException {
		...
		String roleName = para[0];
		
		cmds.add(new CreateRoleCommand(roleName, caller));
		return cmds;
	}
