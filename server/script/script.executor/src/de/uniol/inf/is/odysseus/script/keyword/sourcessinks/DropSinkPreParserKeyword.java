 ...
 */
public class DropSinkPreParserKeyword extends AbstractPreParserKeyword {

	public static final String NAME = "DROPSINK";
	...
	public List<IExecutorCommand>  execute(Map<String, Object> variables, String parameter, ISession caller, Context context, IServerExecutor executor) throws OdysseusScriptException {
		...
		cmds.add(new DropSinkCommand(parameter, true, caller));
		return cmds;
	}
