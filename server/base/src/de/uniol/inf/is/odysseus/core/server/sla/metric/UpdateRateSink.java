...
/**
 * This Metric is a measure for the update rate of the result stream.
 * 
 * @author Lena Eylert
 * 
 */
public class UpdateRateSink extends Metric<TimeUnit>{

	/**
	 * creates a new metric for update rate of a sink
	 * @param value the metric's value
	 * @param unit the metric's unit
	 */
	public UpdateRateSink(double value, TimeUnit unit) {
		super(value, unit);
	}
