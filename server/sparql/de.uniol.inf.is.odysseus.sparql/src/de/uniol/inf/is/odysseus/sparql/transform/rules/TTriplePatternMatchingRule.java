...
public class TTriplePatternMatchingRule<M extends IMetaAttribute> extends AbstractTransformationRule<TriplePatternMatchingAO> {
	...
	@Override
	public void execute(TriplePatternMatchingAO tpmAO, TransformationConfiguration transformConfig) throws RuleException {
	...
	@Override
	public boolean isExecutable(TriplePatternMatchingAO operator, TransformationConfiguration transformConfig) {
