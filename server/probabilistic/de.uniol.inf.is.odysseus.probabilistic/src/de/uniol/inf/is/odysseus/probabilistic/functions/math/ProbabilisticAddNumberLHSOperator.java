 ...
 * 
 */
public class ProbabilisticAddNumberLHSOperator extends AbstractProbabilisticAddNumberOperator {
    /**
	 * 
	 */
    ...
    public ProbabilisticAddNumberLHSOperator() {
        super(ProbabilisticAddNumberLHSOperator.ACC_TYPES);
    }
