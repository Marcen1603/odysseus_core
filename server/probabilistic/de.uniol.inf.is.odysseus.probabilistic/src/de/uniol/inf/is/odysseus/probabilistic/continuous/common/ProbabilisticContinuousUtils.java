...
package de.uniol.inf.is.odysseus.probabilistic.continuous.common;
...
public final class ProbabilisticContinuousUtils {
    /**
     * Calculates the cumulative probability of the given normal distribution
     * mixture.
     * 
     * @param mixtures
     ...
     * @param upperBound
     *            The upper bound
     * @return The cumulative probability of the given normal distribution
     *         mixture.
     */
    ...
    /**
     * Calculates the cumulative probability of the given univariate normal
    ...
    /**
     * Calculates the cumulative probability of the given multivariate normal
     * distribution mixture.
     * 
     * @param distribution
     *            The normal distribution mixture
