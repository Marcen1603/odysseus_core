 ...
 * 
 */
public class ProbabilisticDivideNumberRHSOperator extends AbstractProbabilisticDivisideNumberOperator {
    ...
    public ProbabilisticDivideNumberRHSOperator() {
        super(ProbabilisticDivideNumberRHSOperator.ACC_TYPES);
    }

    /*
     * 
     * @see de.uniol.inf.is.odysseus.probabilistic.continuous.functions.math.
     * AbstractProbabilisticContinuousDivisionNumberOperator#isCommutative()
     */
    @Override
