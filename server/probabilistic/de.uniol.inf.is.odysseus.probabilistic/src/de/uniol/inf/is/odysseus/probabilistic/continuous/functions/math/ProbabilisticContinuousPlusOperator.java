    ...
    protected final IMultivariateDistribution getValueInternal(final MultivariateMixtureDistribution a, final MultivariateMixtureDistribution b) {
        ...
        for (final Pair<Double, IMultivariateDistribution> aEntry : a.getComponents()) {
            ...
            for (final Pair<Double, IMultivariateDistribution> bEntry : b.getComponents()) {
                ...
                final IMultivariateDistribution distribution = new MultivariateNormalDistribution(aMean.add(bMean).getColumn(0), aCovarianceMatrix.add(bCovarianceMatrix).getData());
