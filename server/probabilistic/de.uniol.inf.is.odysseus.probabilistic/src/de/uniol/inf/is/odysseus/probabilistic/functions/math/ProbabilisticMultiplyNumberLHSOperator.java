 ...
 * 
 */
public class ProbabilisticMultiplyNumberLHSOperator extends AbstractProbabilisticMultiplyNumberOperator {
    ...
    public ProbabilisticMultiplyNumberLHSOperator() {
        super(ProbabilisticMultiplyNumberLHSOperator.ACC_TYPES);
    }
