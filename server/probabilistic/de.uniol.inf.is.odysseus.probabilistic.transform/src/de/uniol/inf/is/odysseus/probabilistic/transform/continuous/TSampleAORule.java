...
public class TSampleAORule extends AbstractTransformationRule<SampleAO> {
	 ...
	 */
	@Override
	public final void execute(final SampleAO operator,
			final TransformationConfiguration config) {
		final IPhysicalOperator samplePO = new SamplePO<ITimeInterval>(
				operator.determineAttributesList(), operator.getSamples());
