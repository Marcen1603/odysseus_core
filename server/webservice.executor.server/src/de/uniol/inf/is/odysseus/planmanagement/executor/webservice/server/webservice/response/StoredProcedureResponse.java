 ...
 */
public class StoredProcedureResponse extends Response {

	private StoredProcedure responseValue;

	public StoredProcedureResponse() {
		super();
	}

	public StoredProcedureResponse(StoredProcedure responseValue, boolean success) {
		super(success);
