...
public interface RecommenderData extends Serializable {
	...
	public void addUser(int userID, List<Integer> ratedItems,
			List<Double> ratings);

	public void removeUser(int userID);

	public void addItem(int itemID, List<Integer> ratingUsers,
			List<Double> ratings);
	...
	public SparseVector getRatingsUser(int userID); // TODO:Iterator version for
	// this?

	public SparseVector getRatingsItem(int itemID); // TODO:Iterator version for
	// this?
