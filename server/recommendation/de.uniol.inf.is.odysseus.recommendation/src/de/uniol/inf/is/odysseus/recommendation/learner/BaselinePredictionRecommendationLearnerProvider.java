...
/**
 * This provider provides a {@link BaselinePredictionRecommendationLearner}.
 * 
 * @author Cornelius Ludmann
 * 
 */
public class BaselinePredictionRecommendationLearnerProvider<T extends ITimeInterval>
implements RecommendationLearnerProvider<T> {
	...
	public String getLearnerName() {
		return BaselinePredictionRecommendationLearner.NAME;
	}
	 ...
	 */
	@Override
	public RecommendationLearner<T> newInstanceOfLearner(
		...
		return new BaselinePredictionRecommendationLearner<T>(inputschema,
