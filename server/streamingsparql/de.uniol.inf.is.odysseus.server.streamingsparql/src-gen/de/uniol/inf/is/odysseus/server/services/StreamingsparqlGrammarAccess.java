...
public class StreamingsparqlGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class SelectQueryElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cIsDistinctAssignment_5_0 = (Assignment)cAlternatives_5.eContents().get(0);
		private final Keyword cIsDistinctDISTINCTKeyword_5_0_0 = (Keyword)cIsDistinctAssignment_5_0.eContents().get(0);
		private final Assignment cIsReducedAssignment_5_1 = (Assignment)cAlternatives_5.eContents().get(1);
		private final Keyword cIsReducedREDUCEDKeyword_5_1_0 = (Keyword)cIsReducedAssignment_5_1.eContents().get(0);
		...
		private final Assignment cFilterclauseAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cFilterclauseFilterclauseParserRuleCall_9_0 = (RuleCall)cFilterclauseAssignment_9.eContents().get(0);
		private final Assignment cAggregateClauseAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cAggregateClauseAggregateParserRuleCall_10_0 = (RuleCall)cAggregateClauseAssignment_10.eContents().get(0);
		private final Assignment cFilesinkclauseAssignment_11 = (Assignment)cGroup.eContents().get(11);
		private final RuleCall cFilesinkclauseFilesinkclauseParserRuleCall_11_0 = (RuleCall)cFilesinkclauseAssignment_11.eContents().get(0);
		
		//SelectQuery:
		//	(method="#ADDQUERY" | "#RUNQUERY")? base=Base? prefixes+=Prefix* datasetClauses+=DatasetClause* "SELECT"
		//	(isDistinct?="DISTINCT" | isReduced?="REDUCED")? variables+=Variable variables+=Variable* whereClause=WhereClause
		//	filterclause=Filterclause? //	(groupClause=GroupClause)?
		...
		//isDistinct?="DISTINCT"
		public Assignment getIsDistinctAssignment_5_0() { return cIsDistinctAssignment_5_0; }

		//"DISTINCT"
		public Keyword getIsDistinctDISTINCTKeyword_5_0_0() { return cIsDistinctDISTINCTKeyword_5_0_0; }

		//isReduced?="REDUCED"
		public Assignment getIsReducedAssignment_5_1() { return cIsReducedAssignment_5_1; }

		//"REDUCED"
		public Keyword getIsReducedREDUCEDKeyword_5_1_0() { return cIsReducedREDUCEDKeyword_5_1_0; }
		...
		public Assignment getFilterclauseAssignment_9() { return cFilterclauseAssignment_9; }

		//Filterclause
		public RuleCall getFilterclauseFilterclauseParserRuleCall_9_0() { return cFilterclauseFilterclauseParserRuleCall_9_0; }

		//aggregateClause=Aggregate?
		public Assignment getAggregateClauseAssignment_10() { return cAggregateClauseAssignment_10; }

		//Aggregate
		public RuleCall getAggregateClauseAggregateParserRuleCall_10_0() { return cAggregateClauseAggregateParserRuleCall_10_0; }

		//filesinkclause=Filesinkclause?
		public Assignment getFilesinkclauseAssignment_11() { return cFilesinkclauseAssignment_11; }

		//Filesinkclause
		public RuleCall getFilesinkclauseFilesinkclauseParserRuleCall_11_0() { return cFilesinkclauseFilesinkclauseParserRuleCall_11_0; }
	}
	...
	public class AggregateElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cAggregationsKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Assignment cAggregationsAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cAggregationsAggregationParserRuleCall_1_1_0 = (RuleCall)cAggregationsAssignment_1_1.eContents().get(0);
		private final Keyword cRightSquareBracketKeyword_1_2 = (Keyword)cGroup_1.eContents().get(2);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cCommaKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Assignment cGroupbyAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cGroupbyGroupByParserRuleCall_2_1_0 = (RuleCall)cGroupbyAssignment_2_1.eContents().get(0);
		...
		//"aggregations = ["
		public Keyword getAggregationsKeyword_1_0() { return cAggregationsKeyword_1_0; }

		//aggregations+=Aggregation*
		public Assignment getAggregationsAssignment_1_1() { return cAggregationsAssignment_1_1; }

		//Aggregation
		public RuleCall getAggregationsAggregationParserRuleCall_1_1_0() { return cAggregationsAggregationParserRuleCall_1_1_0; }
		...
		//groupby=GroupBy
		public Assignment getGroupbyAssignment_2_1() { return cGroupbyAssignment_2_1; }

		//GroupBy
		public RuleCall getGroupbyGroupByParserRuleCall_2_1_0() { return cGroupbyGroupByParserRuleCall_2_1_0; }
	...
	public class GroupByElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "GroupBy");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FilesinkclauseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Filesinkclause");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FilterclauseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Filterclause");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DatasetClauseElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeWINDOWTYPETerminalRuleCall_4_1_0 = (RuleCall)cTypeAssignment_4_1.eContents().get(0);
		private final Keyword cSIZEKeyword_4_2 = (Keyword)cGroup_4.eContents().get(2);
		private final Assignment cSizeAssignment_4_3 = (Assignment)cGroup_4.eContents().get(3);
		private final RuleCall cSizeINTTerminalRuleCall_4_3_0 = (RuleCall)cSizeAssignment_4_3.eContents().get(0);
		private final Group cGroup_4_4 = (Group)cGroup_4.eContents().get(4);
		private final Keyword cADVANCEKeyword_4_4_0 = (Keyword)cGroup_4_4.eContents().get(0);
		private final Assignment cAdvanceAssignment_4_4_1 = (Assignment)cGroup_4_4.eContents().get(1);
		private final RuleCall cAdvanceINTTerminalRuleCall_4_4_1_0 = (RuleCall)cAdvanceAssignment_4_4_1.eContents().get(0);
		private final Group cGroup_4_5 = (Group)cGroup_4.eContents().get(5);
		private final Keyword cUNITKeyword_4_5_0 = (Keyword)cGroup_4_5.eContents().get(0);
		private final Assignment cUnitAssignment_4_5_1 = (Assignment)cGroup_4_5.eContents().get(1);
		private final RuleCall cUnitUNITTYPETerminalRuleCall_4_5_1_0 = (RuleCall)cUnitAssignment_4_5_1.eContents().get(0);
		...
		//WINDOWTYPE
		public RuleCall getTypeWINDOWTYPETerminalRuleCall_4_1_0() { return cTypeWINDOWTYPETerminalRuleCall_4_1_0; }

		//"SIZE "
		public Keyword getSIZEKeyword_4_2() { return cSIZEKeyword_4_2; }

		//size=INT
		public Assignment getSizeAssignment_4_3() { return cSizeAssignment_4_3; }

		//INT
		public RuleCall getSizeINTTerminalRuleCall_4_3_0() { return cSizeINTTerminalRuleCall_4_3_0; }

		//("ADVANCE" advance=INT)?
		public Group getGroup_4_4() { return cGroup_4_4; }

		//"ADVANCE"
		public Keyword getADVANCEKeyword_4_4_0() { return cADVANCEKeyword_4_4_0; }

		//advance=INT
		public Assignment getAdvanceAssignment_4_4_1() { return cAdvanceAssignment_4_4_1; }

		//INT
		public RuleCall getAdvanceINTTerminalRuleCall_4_4_1_0() { return cAdvanceINTTerminalRuleCall_4_4_1_0; }

		//("UNIT " unit=UNITTYPE)?
		public Group getGroup_4_5() { return cGroup_4_5; }

		//"UNIT "
		public Keyword getUNITKeyword_4_5_0() { return cUNITKeyword_4_5_0; }

		//unit=UNITTYPE
		public Assignment getUnitAssignment_4_5_1() { return cUnitAssignment_4_5_1; }

		//UNITTYPE
		public RuleCall getUnitUNITTYPETerminalRuleCall_4_5_1_0() { return cUnitUNITTYPETerminalRuleCall_4_5_1_0; }
	...
	public class InnerWhereClauseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "InnerWhereClause");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public StreamingsparqlGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tAGG_FUNCTION = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "AGG_FUNCTION");
		this.tIRI_TERMINAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "IRI_TERMINAL");
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "STRING");
		this.tWINDOWTYPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "WINDOWTYPE");
		this.tUNITTYPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "UNITTYPE");
	}
