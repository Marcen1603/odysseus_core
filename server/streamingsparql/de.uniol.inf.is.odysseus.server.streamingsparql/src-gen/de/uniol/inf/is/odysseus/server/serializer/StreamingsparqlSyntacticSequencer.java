...
public class StreamingsparqlSyntacticSequencer extends AbstractSyntacticSequencer {

	protected StreamingsparqlGrammarAccess grammarAccess;
	protected AbstractElementAlias match_Aggregate_CommaKeyword_2_0_q;
	protected AbstractElementAlias match_Aggregate___AggregationsKeyword_1_0_RightSquareBracketKeyword_1_2__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Aggregate_CommaKeyword_2_0_q = new TokenAlias(false, true, grammarAccess.getAggregateAccess().getCommaKeyword_2_0());
		match_Aggregate___AggregationsKeyword_1_0_RightSquareBracketKeyword_1_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getAggregateAccess().getAggregationsKeyword_1_0()), new TokenAlias(false, false, grammarAccess.getAggregateAccess().getRightSquareBracketKeyword_1_2()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Aggregate_CommaKeyword_2_0_q.equals(syntax))
				emit_Aggregate_CommaKeyword_2_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_Aggregate___AggregationsKeyword_1_0_RightSquareBracketKeyword_1_2__q.equals(syntax))
				emit_Aggregate___AggregationsKeyword_1_0_RightSquareBracketKeyword_1_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_Aggregate_CommaKeyword_2_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 */
	protected void emit_Aggregate___AggregationsKeyword_1_0_RightSquareBracketKeyword_1_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) 'SELECT' isDistinct?='DISTINCT'
	 *     (rule start) (ambiguity) 'SELECT' isReduced?='REDUCED'
