...
public class CQLGeneratorQueryTest {
  ...
  public void SelectAllTest5() {
    ...
    this.assertCorrectGenerated(
      ...
      "operator_1 = SELECT({predicate=\'attr1>2&&attr2==\'Test\'\'}, stream1)", _cQLDictionaryHelper);
  }
