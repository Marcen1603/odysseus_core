 ...
 * </p>
 * <ul>
 *   <li>{@link de.uniol.inf.is.odysseus.parser.novel.cql.cQL.impl.Create_StatementImpl#getChannelformat <em>Channelformat</em>}</li>
 *   <li>{@link de.uniol.inf.is.odysseus.parser.novel.cql.cQL.impl.Create_StatementImpl#getAccessframework <em>Accessframework</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Create_StatementImpl extends MinimalEObjectImpl.Container implements Create_Statement
{
  ...
  public NotificationChain basicSetChannelformat(ChannelFormat newChannelformat, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CQLPackage.CREATE_STATEMENT__CHANNELFORMAT, oldChannelformat, newChannelformat);
  ...
  public void setChannelformat(ChannelFormat newChannelformat)
  {
    if (newChannelformat != channelformat)
    {
      ...
      if (channelformat != null)
        msgs = ((InternalEObject)channelformat).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CQLPackage.CREATE_STATEMENT__CHANNELFORMAT, null, msgs);
      if (newChannelformat != null)
        msgs = ((InternalEObject)newChannelformat).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CQLPackage.CREATE_STATEMENT__CHANNELFORMAT, null, msgs);
      msgs = basicSetChannelformat(newChannelformat, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CQLPackage.CREATE_STATEMENT__CHANNELFORMAT, newChannelformat, newChannelformat));
  }
  ...
  public NotificationChain basicSetAccessframework(AccessFramework newAccessframework, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CQLPackage.CREATE_STATEMENT__ACCESSFRAMEWORK, oldAccessframework, newAccessframework);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAccessframework(AccessFramework newAccessframework)
  {
    if (newAccessframework != accessframework)
    {
      ...
      if (accessframework != null)
        msgs = ((InternalEObject)accessframework).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CQLPackage.CREATE_STATEMENT__ACCESSFRAMEWORK, null, msgs);
      if (newAccessframework != null)
        msgs = ((InternalEObject)newAccessframework).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CQLPackage.CREATE_STATEMENT__ACCESSFRAMEWORK, null, msgs);
      msgs = basicSetAccessframework(newAccessframework, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CQLPackage.CREATE_STATEMENT__ACCESSFRAMEWORK, newAccessframework, newAccessframework));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CQLPackage.CREATE_STATEMENT__CHANNELFORMAT:
        return basicSetChannelformat(null, msgs);
      case CQLPackage.CREATE_STATEMENT__ACCESSFRAMEWORK:
