 ...
 * </p>
 * <ul>
 *   <li>{@link de.uniol.inf.is.odysseus.parser.novel.cql.cQL.impl.StringConstantImpl#getAlias <em>Alias</em>}</li>
...
public class StringConstantImpl extends ConstantImpl implements StringConstant
{
  ...
  public NotificationChain basicSetAlias(Alias newAlias, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CQLPackage.STRING_CONSTANT__ALIAS, oldAlias, newAlias);
  ...
  public void setAlias(Alias newAlias)
  {
    if (newAlias != alias)
    {
      ...
      if (alias != null)
        msgs = ((InternalEObject)alias).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CQLPackage.STRING_CONSTANT__ALIAS, null, msgs);
      if (newAlias != null)
        msgs = ((InternalEObject)newAlias).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CQLPackage.STRING_CONSTANT__ALIAS, null, msgs);
      msgs = basicSetAlias(newAlias, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CQLPackage.STRING_CONSTANT__ALIAS, newAlias, newAlias));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CQLPackage.STRING_CONSTANT__ALIAS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == Expression.class)
    {
      ...
      {
        case CQLPackage.STRING_CONSTANT__ALIAS: return CQLPackage.EXPRESSION__ALIAS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == Expression.class)
    {
      ...
      {
        case CQLPackage.EXPRESSION__ALIAS: return CQLPackage.STRING_CONSTANT__ALIAS;
        default: return -1;
      }
    }
