 ...
 * </ul>
 *
 * @see de.uniol.inf.is.odysseus.parser.novel.cql.cQL.CQLPackage#getUserManagement()
 * @model
 * @generated
 */
public interface UserManagement extends Command
{
   ...
   * @see de.uniol.inf.is.odysseus.parser.novel.cql.cQL.CQLPackage#getUserManagement_Subject()
   * @model
   * @generated
   */
  String getSubject();
  ...
  /**
   * Sets the value of the '{@link de.uniol.inf.is.odysseus.parser.novel.cql.cQL.UserManagement#getSubject <em>Subject</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uniol.inf.is.odysseus.parser.novel.cql.cQL.CQLPackage#getUserManagement_SubjectName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uniol.inf.is.odysseus.parser.novel.cql.cQL.UserManagement#getSubjectName <em>Subject Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uniol.inf.is.odysseus.parser.novel.cql.cQL.CQLPackage#getUserManagement_Password()
   * @model
   * @generated
   */
  String getPassword();
  ...
  /**
   * Sets the value of the '{@link de.uniol.inf.is.odysseus.parser.novel.cql.cQL.UserManagement#getPassword <em>Password</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
