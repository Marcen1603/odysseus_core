 ...
 * </p>
 * <ul>
 *   <li>{@link de.uniol.inf.is.odysseus.parser.novel.cql.cQL.impl.CreateSink1Impl#getKeyword <em>Keyword</em>}</li>
...
public class CreateSink1Impl extends MinimalEObjectImpl.Container implements CreateSink1
{
  ...
  public void setKeyword(CreateKeyword newKeyword)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CQLPackage.CREATE_SINK1__KEYWORD, oldKeyword, keyword));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CQLPackage.CREATE_SINK1__KEYWORD:
        return getKeyword();
      case CQLPackage.CREATE_SINK1__ATTRIBUTES:
