...
:
	(
		{ before(grammarAccess.getSourceAccess().getNameSourceNameParserRuleCall_0_0_0_0()); }
		ruleSourceName
		{ after(grammarAccess.getSourceAccess().getNameSourceNameParserRuleCall_0_0_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
