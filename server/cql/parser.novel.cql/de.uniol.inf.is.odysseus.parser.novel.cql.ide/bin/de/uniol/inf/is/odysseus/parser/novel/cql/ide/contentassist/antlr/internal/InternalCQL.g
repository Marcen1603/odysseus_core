...
:
(
	{ before(grammarAccess.getChannelFormatViewAccess().getRightParenthesisKeyword_5()); }
	')'
	{ after(grammarAccess.getChannelFormatViewAccess().getRightParenthesisKeyword_5()); }
)
;
finally {
	restoreStackSize(stackSize);
