...
@members {
	...
	
	{
		...
		tokenNameToValue.put("IDFIED", "'IDFIED'");
...
:
(
	{ before(grammarAccess.getUserManagementAccess().getIDFIEDKeyword_4_0()); }
	IDFIED
	{ after(grammarAccess.getUserManagementAccess().getIDFIEDKeyword_4_0()); }
)
;
finally {
	restoreStackSize(stackSize);
