		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSelect_StatementAccess().getAlternatives_2_1_0(), "rule__Select_Statement__Alternatives_2_1_0");
					put(grammarAccess.getSelect_StatementAccess().getAlternatives_4_0(), "rule__Select_Statement__Alternatives_4_0");
					...
					put(grammarAccess.getSelect_StatementAccess().getGroup_2_1_2(), "rule__Select_Statement__Group_2_1_2__0");
					...
					put(grammarAccess.getSelect_StatementAccess().getGroup_6_3(), "rule__Select_Statement__Group_6_3__0");
					...
					put(grammarAccess.getSourceAccess().getAliasAssignment_2_1(), "rule__Source__AliasAssignment_2_1");
					...
					put(grammarAccess.getSelect_StatementAccess().getDistinctAssignment_1(), "rule__Select_Statement__DistinctAssignment_1");
					put(grammarAccess.getSelect_StatementAccess().getAttributesAssignment_2_1_0_0(), "rule__Select_Statement__AttributesAssignment_2_1_0_0");
					put(grammarAccess.getSelect_StatementAccess().getAggregationsAssignment_2_1_0_1(), "rule__Select_Statement__AggregationsAssignment_2_1_0_1");
					...
					put(grammarAccess.getSelect_StatementAccess().getAggregationsAssignment_2_1_2_1(), "rule__Select_Statement__AggregationsAssignment_2_1_2_1");
					put(grammarAccess.getSelect_StatementAccess().getSourcesAssignment_4_0_0(), "rule__Select_Statement__SourcesAssignment_4_0_0");
					put(grammarAccess.getSelect_StatementAccess().getNestedAssignment_4_0_1(), "rule__Select_Statement__NestedAssignment_4_0_1");
					put(grammarAccess.getSelect_StatementAccess().getSourcesAssignment_4_1_1(), "rule__Select_Statement__SourcesAssignment_4_1_1");
					put(grammarAccess.getSelect_StatementAccess().getNestedAssignment_4_2_1(), "rule__Select_Statement__NestedAssignment_4_2_1");
					put(grammarAccess.getSelect_StatementAccess().getNestedAliasesAssignment_4_2_3(), "rule__Select_Statement__NestedAliasesAssignment_4_2_3");
					put(grammarAccess.getSelect_StatementAccess().getPredicatesAssignment_5_1(), "rule__Select_Statement__PredicatesAssignment_5_1");
					put(grammarAccess.getSelect_StatementAccess().getOrderAssignment_6_2(), "rule__Select_Statement__OrderAssignment_6_2");
					put(grammarAccess.getSelect_StatementAccess().getOrderAssignment_6_3_1(), "rule__Select_Statement__OrderAssignment_6_3_1");
					put(grammarAccess.getSelect_StatementAccess().getHavingAssignment_7_1(), "rule__Select_Statement__HavingAssignment_7_1");
					...
					put(grammarAccess.getSelect_StatementAccess().getUnorderedGroup_2_1(), "rule__Select_Statement__UnorderedGroup_2_1");
					put(grammarAccess.getSelect_StatementAccess().getUnorderedGroup_4(), "rule__Select_Statement__UnorderedGroup_4");
				}
			};
		}
