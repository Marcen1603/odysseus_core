		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSelect_StatementAccess().getAlternatives_1_1_0(), "rule__Select_Statement__Alternatives_1_1_0");
					put(grammarAccess.getSelect_StatementAccess().getAlternatives_3_0(), "rule__Select_Statement__Alternatives_3_0");
					put(grammarAccess.getOrderAccess().getDirectionAlternatives_1_0(), "rule__Order__DirectionAlternatives_1_0");
					put(grammarAccess.getCreate_StatementAccess().getAlternatives_0(), "rule__Create_Statement__Alternatives_0");
					...
					put(grammarAccess.getNested_StatementAccess().getGroup(), "rule__Nested_Statement__Group__0");
					...
					put(grammarAccess.getSelect_StatementAccess().getGroup_1_1_1(), "rule__Select_Statement__Group_1_1_1__0");
					put(grammarAccess.getSelect_StatementAccess().getGroup_1_1_2(), "rule__Select_Statement__Group_1_1_2__0");
					put(grammarAccess.getSelect_StatementAccess().getGroup_3_1(), "rule__Select_Statement__Group_3_1__0");
					put(grammarAccess.getSelect_StatementAccess().getGroup_3_2(), "rule__Select_Statement__Group_3_2__0");
					...
					put(grammarAccess.getSelect_StatementAccess().getGroup_5_3(), "rule__Select_Statement__Group_5_3__0");
					...
					put(grammarAccess.getScalar_FunctionAccess().getGroup(), "rule__Scalar_Function__Group__0");
					...
					put(grammarAccess.getSelect_StatementAccess().getAttributesAssignment_1_1_0_0(), "rule__Select_Statement__AttributesAssignment_1_1_0_0");
					put(grammarAccess.getSelect_StatementAccess().getAggregationsAssignment_1_1_0_1(), "rule__Select_Statement__AggregationsAssignment_1_1_0_1");
					put(grammarAccess.getSelect_StatementAccess().getAttributesAssignment_1_1_1_1(), "rule__Select_Statement__AttributesAssignment_1_1_1_1");
					put(grammarAccess.getSelect_StatementAccess().getAggregationsAssignment_1_1_2_1(), "rule__Select_Statement__AggregationsAssignment_1_1_2_1");
					put(grammarAccess.getSelect_StatementAccess().getSourcesAssignment_3_0_0(), "rule__Select_Statement__SourcesAssignment_3_0_0");
					put(grammarAccess.getSelect_StatementAccess().getNestedAssignment_3_0_1(), "rule__Select_Statement__NestedAssignment_3_0_1");
					put(grammarAccess.getSelect_StatementAccess().getSourcesAssignment_3_1_1(), "rule__Select_Statement__SourcesAssignment_3_1_1");
					put(grammarAccess.getSelect_StatementAccess().getNestedAssignment_3_2_1(), "rule__Select_Statement__NestedAssignment_3_2_1");
					put(grammarAccess.getSelect_StatementAccess().getNestedAliasesAssignment_3_2_3(), "rule__Select_Statement__NestedAliasesAssignment_3_2_3");
					put(grammarAccess.getSelect_StatementAccess().getPredicatesAssignment_4_1(), "rule__Select_Statement__PredicatesAssignment_4_1");
					put(grammarAccess.getSelect_StatementAccess().getOrderAssignment_5_2(), "rule__Select_Statement__OrderAssignment_5_2");
					put(grammarAccess.getSelect_StatementAccess().getOrderAssignment_5_3_1(), "rule__Select_Statement__OrderAssignment_5_3_1");
					put(grammarAccess.getSelect_StatementAccess().getHavingAssignment_6_1(), "rule__Select_Statement__HavingAssignment_6_1");
					put(grammarAccess.getOrderAccess().getAttributeAssignment_0(), "rule__Order__AttributeAssignment_0");
					put(grammarAccess.getOrderAccess().getDirectionAssignment_1(), "rule__Order__DirectionAssignment_1");
					...
					put(grammarAccess.getScalar_FunctionAccess().getNameAssignment_1(), "rule__Scalar_Function__NameAssignment_1");
					put(grammarAccess.getSelect_StatementAccess().getUnorderedGroup_1_1(), "rule__Select_Statement__UnorderedGroup_1_1");
					put(grammarAccess.getSelect_StatementAccess().getUnorderedGroup_3(), "rule__Select_Statement__UnorderedGroup_3");
				}
			};
		}
