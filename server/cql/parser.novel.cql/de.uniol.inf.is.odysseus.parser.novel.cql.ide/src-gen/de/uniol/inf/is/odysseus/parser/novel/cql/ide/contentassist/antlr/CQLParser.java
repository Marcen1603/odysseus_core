		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getArgumentAccess().getAggregationAssignment_1(), "rule__Argument__AggregationAssignment_1");
					put(grammarAccess.getArgumentAccess().getExpressionAssignment_2(), "rule__Argument__ExpressionAssignment_2");
