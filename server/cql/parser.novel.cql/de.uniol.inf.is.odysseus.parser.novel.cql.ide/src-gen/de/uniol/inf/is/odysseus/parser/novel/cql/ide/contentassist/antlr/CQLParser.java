		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDropCommandAccess().getNameAlternatives_2_0(), "rule__DropCommand__NameAlternatives_2_0");
					put(grammarAccess.getUserCommandAccess().getNameAlternatives_1_0(), "rule__UserCommand__NameAlternatives_1_0");
					put(grammarAccess.getUserCommandAccess().getSubjectAlternatives_2_0(), "rule__UserCommand__SubjectAlternatives_2_0");
					put(grammarAccess.getRightsCommandAccess().getAlternatives(), "rule__RightsCommand__Alternatives");
					put(grammarAccess.getRightsRoleCommandAccess().getAlternatives(), "rule__RightsRoleCommand__Alternatives");
					...
					put(grammarAccess.getDropCommandAccess().getGroup(), "rule__DropCommand__Group__0");
					put(grammarAccess.getDropCommandAccess().getGroup_4(), "rule__DropCommand__Group_4__0");
					put(grammarAccess.getUserCommandAccess().getGroup(), "rule__UserCommand__Group__0");
					put(grammarAccess.getUserCommandAccess().getGroup_4(), "rule__UserCommand__Group_4__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_0(), "rule__RightsCommand__Group_0__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_0_3(), "rule__RightsCommand__Group_0_3__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_0_4(), "rule__RightsCommand__Group_0_4__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_0_4_2(), "rule__RightsCommand__Group_0_4_2__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_1(), "rule__RightsCommand__Group_1__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_1_3(), "rule__RightsCommand__Group_1_3__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_1_4(), "rule__RightsCommand__Group_1_4__0");
					put(grammarAccess.getRightsCommandAccess().getGroup_1_4_2(), "rule__RightsCommand__Group_1_4_2__0");
					put(grammarAccess.getRightsRoleCommandAccess().getGroup_0(), "rule__RightsRoleCommand__Group_0__0");
					put(grammarAccess.getRightsRoleCommandAccess().getGroup_0_4(), "rule__RightsRoleCommand__Group_0_4__0");
					put(grammarAccess.getRightsRoleCommandAccess().getGroup_1(), "rule__RightsRoleCommand__Group_1__0");
					put(grammarAccess.getRightsRoleCommandAccess().getGroup_1_4(), "rule__RightsRoleCommand__Group_1_4__0");
					...
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_0(), "rule__Statement__TypeAssignment_1_0");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_1(), "rule__Statement__TypeAssignment_1_1");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_2(), "rule__Statement__TypeAssignment_1_2");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_3(), "rule__Statement__TypeAssignment_1_3");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_4(), "rule__Statement__TypeAssignment_1_4");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_5(), "rule__Statement__TypeAssignment_1_5");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_6(), "rule__Statement__TypeAssignment_1_6");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_7(), "rule__Statement__TypeAssignment_1_7");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_8(), "rule__Statement__TypeAssignment_1_8");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_9(), "rule__Statement__TypeAssignment_1_9");
					put(grammarAccess.getStatementAccess().getTypeAssignment_1_10(), "rule__Statement__TypeAssignment_1_10");
					...
					put(grammarAccess.getDropCommandAccess().getNameAssignment_2(), "rule__DropCommand__NameAssignment_2");
					put(grammarAccess.getDropCommandAccess().getStreamAssignment_3(), "rule__DropCommand__StreamAssignment_3");
					put(grammarAccess.getDropCommandAccess().getExistsAssignment_4_0(), "rule__DropCommand__ExistsAssignment_4_0");
					put(grammarAccess.getUserCommandAccess().getNameAssignment_1(), "rule__UserCommand__NameAssignment_1");
					put(grammarAccess.getUserCommandAccess().getSubjectAssignment_2(), "rule__UserCommand__SubjectAssignment_2");
					put(grammarAccess.getUserCommandAccess().getSubjectNameAssignment_3(), "rule__UserCommand__SubjectNameAssignment_3");
					put(grammarAccess.getUserCommandAccess().getPasswordAssignment_4_2(), "rule__UserCommand__PasswordAssignment_4_2");
					put(grammarAccess.getRightsCommandAccess().getNameAssignment_0_1(), "rule__RightsCommand__NameAssignment_0_1");
					put(grammarAccess.getRightsCommandAccess().getOperationsAssignment_0_2(), "rule__RightsCommand__OperationsAssignment_0_2");
					put(grammarAccess.getRightsCommandAccess().getOperationsAssignment_0_3_1(), "rule__RightsCommand__OperationsAssignment_0_3_1");
					put(grammarAccess.getRightsCommandAccess().getOperations2Assignment_0_4_1(), "rule__RightsCommand__Operations2Assignment_0_4_1");
					put(grammarAccess.getRightsCommandAccess().getOperations2Assignment_0_4_2_1(), "rule__RightsCommand__Operations2Assignment_0_4_2_1");
					put(grammarAccess.getRightsCommandAccess().getUserAssignment_0_6(), "rule__RightsCommand__UserAssignment_0_6");
					put(grammarAccess.getRightsCommandAccess().getNameAssignment_1_1(), "rule__RightsCommand__NameAssignment_1_1");
					put(grammarAccess.getRightsCommandAccess().getOperationsAssignment_1_2(), "rule__RightsCommand__OperationsAssignment_1_2");
					put(grammarAccess.getRightsCommandAccess().getOperationsAssignment_1_3_1(), "rule__RightsCommand__OperationsAssignment_1_3_1");
					put(grammarAccess.getRightsCommandAccess().getOperations2Assignment_1_4_1(), "rule__RightsCommand__Operations2Assignment_1_4_1");
					put(grammarAccess.getRightsCommandAccess().getOperations2Assignment_1_4_2_1(), "rule__RightsCommand__Operations2Assignment_1_4_2_1");
					put(grammarAccess.getRightsCommandAccess().getUserAssignment_1_6(), "rule__RightsCommand__UserAssignment_1_6");
					put(grammarAccess.getRightsRoleCommandAccess().getNameAssignment_0_1(), "rule__RightsRoleCommand__NameAssignment_0_1");
					put(grammarAccess.getRightsRoleCommandAccess().getOperationsAssignment_0_3(), "rule__RightsRoleCommand__OperationsAssignment_0_3");
					put(grammarAccess.getRightsRoleCommandAccess().getOperationsAssignment_0_4_1(), "rule__RightsRoleCommand__OperationsAssignment_0_4_1");
					put(grammarAccess.getRightsRoleCommandAccess().getUserAssignment_0_6(), "rule__RightsRoleCommand__UserAssignment_0_6");
					put(grammarAccess.getRightsRoleCommandAccess().getNameAssignment_1_1(), "rule__RightsRoleCommand__NameAssignment_1_1");
					put(grammarAccess.getRightsRoleCommandAccess().getOperationsAssignment_1_3(), "rule__RightsRoleCommand__OperationsAssignment_1_3");
					put(grammarAccess.getRightsRoleCommandAccess().getOperationsAssignment_1_4_1(), "rule__RightsRoleCommand__OperationsAssignment_1_4_1");
					put(grammarAccess.getRightsRoleCommandAccess().getUserAssignment_1_6(), "rule__RightsRoleCommand__UserAssignment_1_6");
