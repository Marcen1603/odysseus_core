		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCreate_StreamAccess().getAlternatives_0(), "rule__Create_Stream__Alternatives_0");
					...
					put(grammarAccess.getCreate_SinkAccess().getGroup(), "rule__Create_Sink__Group__0");
					put(grammarAccess.getCreate_SinkAccess().getGroup_5(), "rule__Create_Sink__Group_5__0");
					put(grammarAccess.getCreate_SinkAccess().getGroup_17(), "rule__Create_Sink__Group_17__0");
					put(grammarAccess.getCreate_SinkAccess().getGroup_18(), "rule__Create_Sink__Group_18__0");
					put(grammarAccess.getCreate_StreamAccess().getGroup(), "rule__Create_Stream__Group__0");
					put(grammarAccess.getCreate_StreamAccess().getGroup_5(), "rule__Create_Stream__Group_5__0");
					...
					put(grammarAccess.getCreate_StatementAccess().getStreamAssignment_1_0(), "rule__Create_Statement__StreamAssignment_1_0");
					put(grammarAccess.getCreate_StatementAccess().getSinkAssignment_1_1(), "rule__Create_Statement__SinkAssignment_1_1");
					put(grammarAccess.getCreate_SinkAccess().getNameAssignment_1(), "rule__Create_Sink__NameAssignment_1");
					put(grammarAccess.getCreate_SinkAccess().getAttributesAssignment_3(), "rule__Create_Sink__AttributesAssignment_3");
					put(grammarAccess.getCreate_SinkAccess().getDatatypesAssignment_4(), "rule__Create_Sink__DatatypesAssignment_4");
					put(grammarAccess.getCreate_SinkAccess().getAttributesAssignment_5_1(), "rule__Create_Sink__AttributesAssignment_5_1");
					put(grammarAccess.getCreate_SinkAccess().getDatatypesAssignment_5_2(), "rule__Create_Sink__DatatypesAssignment_5_2");
					put(grammarAccess.getCreate_SinkAccess().getWrapperAssignment_8(), "rule__Create_Sink__WrapperAssignment_8");
					put(grammarAccess.getCreate_SinkAccess().getProtocolAssignment_10(), "rule__Create_Sink__ProtocolAssignment_10");
					put(grammarAccess.getCreate_SinkAccess().getTransportAssignment_12(), "rule__Create_Sink__TransportAssignment_12");
					put(grammarAccess.getCreate_SinkAccess().getDatahandlerAssignment_14(), "rule__Create_Sink__DatahandlerAssignment_14");
					put(grammarAccess.getCreate_SinkAccess().getKeysAssignment_17_0(), "rule__Create_Sink__KeysAssignment_17_0");
					put(grammarAccess.getCreate_SinkAccess().getValuesAssignment_17_1(), "rule__Create_Sink__ValuesAssignment_17_1");
					put(grammarAccess.getCreate_SinkAccess().getKeysAssignment_18_1(), "rule__Create_Sink__KeysAssignment_18_1");
					put(grammarAccess.getCreate_SinkAccess().getValuesAssignment_18_2(), "rule__Create_Sink__ValuesAssignment_18_2");
					put(grammarAccess.getCreate_StreamAccess().getNameAssignment_1(), "rule__Create_Stream__NameAssignment_1");
					put(grammarAccess.getCreate_StreamAccess().getAttributesAssignment_3(), "rule__Create_Stream__AttributesAssignment_3");
					put(grammarAccess.getCreate_StreamAccess().getDatatypesAssignment_4(), "rule__Create_Stream__DatatypesAssignment_4");
					put(grammarAccess.getCreate_StreamAccess().getAttributesAssignment_5_1(), "rule__Create_Stream__AttributesAssignment_5_1");
					put(grammarAccess.getCreate_StreamAccess().getDatatypesAssignment_5_2(), "rule__Create_Stream__DatatypesAssignment_5_2");
					put(grammarAccess.getCreate_StreamAccess().getHostAssignment_8(), "rule__Create_Stream__HostAssignment_8");
					put(grammarAccess.getCreate_StreamAccess().getPortAssignment_10(), "rule__Create_Stream__PortAssignment_10");
				}
			};
		}
