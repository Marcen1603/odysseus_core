...
import de.uniol.inf.is.odysseus.parser.cql2.parser.antlr.CQLAntlrTokenFileProvider;
import de.uniol.inf.is.odysseus.parser.cql2.parser.antlr.CQLParser;
import de.uniol.inf.is.odysseus.parser.cql2.parser.antlr.lexer.InternalCQLLexer;
import de.uniol.inf.is.odysseus.parser.cql2.scoping.CQLScopeProvider;
import de.uniol.inf.is.odysseus.parser.cql2.serializer.CQLSemanticSequencer;
import de.uniol.inf.is.odysseus.parser.cql2.serializer.CQLSyntacticSequencer;
import de.uniol.inf.is.odysseus.parser.cql2.services.CQLGrammarAccess;
import de.uniol.inf.is.odysseus.parser.cql2.validation.CQLValidator;
...
public abstract class AbstractCQLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/uniol/inf/is/odysseus/parser/cql2/CQL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.uniol.inf.is.odysseus.parser.cql2.CQL");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("cql");
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalCQLLexer> provideInternalCQLLexer() {
