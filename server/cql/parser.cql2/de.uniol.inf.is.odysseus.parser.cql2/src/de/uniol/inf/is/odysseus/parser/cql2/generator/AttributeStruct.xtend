...
class AttributeStruct {
	...
	override toString() {
		return "attributename " + attributename + System.getProperty("line.separator") + " sourcename " + sourcename +
			System.getProperty("line.separator") + " datatype " + datatype + System.getProperty("line.separator") +
