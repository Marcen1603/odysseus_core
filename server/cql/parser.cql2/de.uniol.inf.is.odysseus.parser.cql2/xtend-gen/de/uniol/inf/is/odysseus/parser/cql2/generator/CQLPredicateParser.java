...
public class CQLPredicateParser {
  ...
  public CharSequence parse(final Expression e) {
    try {
        ...
        if (!_matched) {
          if (e instanceof ComplexPredicateRef) {
            ...
            if (((quantification = complexPredicate.getQuantification()) != null)) {
              ...
              Set<Map.Entry<String, List<String>>> _entrySet = CQLGeneratorUtil.getQueryAttributes(select).entrySet();
              ...
              if (((exists = complexPredicate.getExists()) != null)) {
                ...
                if (((in = complexPredicate.getIn()) != null)) {
                  ...
                  Set<Map.Entry<String, List<String>>> _entrySet_1 = CQLGeneratorUtil.getQueryAttributes(select_1).entrySet();
      ...
      if (_t instanceof NullPointerException) {
        ...
        this.log.error((("while parsing predicate an object was null: following predicate string was constructed \"" + this.predicateString) + "\""));
      } else {
  ...
  public List<String> parseComplexPredicate(final ComplexPredicate complexPredicate, final String type) {
    List<String> _xblockexpression = null;
    {
      ...
      Set<Map.Entry<String, List<String>>> _entrySet = CQLGeneratorUtil.getQueryAttributes(subQuery).entrySet();
      for (final Map.Entry<String, List<String>> l : _entrySet) {
