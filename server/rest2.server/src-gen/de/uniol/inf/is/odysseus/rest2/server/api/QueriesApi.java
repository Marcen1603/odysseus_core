...
public class QueriesApi extends AbstractApi{
	...
	public Response queriesIdDelete(@Context Request request,
			@ApiParam(value = "The ID of the query.", required = true) @PathParam("id") Integer id) {
		final String securityToken = (String) request.getSession()
				.getAttribute(SecurityAuthInterceptor.SESSION_ATTRIBUTE_NAME);
		final Optional<ISession> session = Optional.ofNullable(SessionManagement.instance.login(securityToken));
	...
	public Response queriesIdGet(@Context Request request,
			@ApiParam(value = "The ID of the query.", required = true) @PathParam("id") Integer id) {
		final String securityToken = (String) request.getSession()
				.getAttribute(SecurityAuthInterceptor.SESSION_ATTRIBUTE_NAME);
		final Optional<ISession> session = Optional.ofNullable(SessionManagement.instance.login(securityToken));
	...
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = Query.class) })
	public Response queriesIdPut(@Context Request request,
			@ApiParam(value = "The ID of the query.", required = true) @PathParam("id") Integer id,
	...
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "Deleted", response = Void.class) })
	public Response queriesNameDelete(@Context Request request,
			@ApiParam(value = "The name of the query.", required = true) @PathParam("name") String name) {
		final String securityToken = (String) request.getSession()
				.getAttribute(SecurityAuthInterceptor.SESSION_ATTRIBUTE_NAME);
		final Optional<ISession> session = Optional.ofNullable(SessionManagement.instance.login(securityToken));
	...
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = Query.class) })
	public Response queriesNameGet(@Context Request request,
			@ApiParam(value = "The name of the query.", required = true) @PathParam("name") String name) {
		final String securityToken = (String) request.getSession()
				.getAttribute(SecurityAuthInterceptor.SESSION_ATTRIBUTE_NAME);
		final Optional<ISession> session = Optional.ofNullable(SessionManagement.instance.login(securityToken));
	...
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = Query.class) })
	public Response queriesNamePut(@Context Request request,
			@ApiParam(value = "The name of the query.", required = true) @PathParam("name") String name,
			@ApiParam(value = "", required = true) Query query) {
		final String securityToken = (String) request.getSession()
				.getAttribute(SecurityAuthInterceptor.SESSION_ATTRIBUTE_NAME);
