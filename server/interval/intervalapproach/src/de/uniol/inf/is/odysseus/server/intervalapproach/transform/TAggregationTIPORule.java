...
import de.uniol.inf.is.odysseus.server.intervalapproach.simpleaggregate.RelationalSimpleAggregatePO;
...
public class TAggregationTIPORule extends AbstractIntervalTransformationRule<AggregateAO> {
	...
	public void execute(AggregateAO aggregateAO, TransformationConfiguration transformConfig) throws RuleException {
		...
		if(aggregateAO.isSimpleAggregate()) {
			RelationalSimpleAggregatePO<ITimeInterval, Tuple<ITimeInterval>> po = null;
			po = new RelationalSimpleAggregatePO<>(aggregateAO.getInputSchema(),
