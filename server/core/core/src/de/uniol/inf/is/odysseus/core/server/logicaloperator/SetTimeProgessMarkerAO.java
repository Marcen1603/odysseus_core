...
@LogicalOperator(maxInputPorts = 1, minInputPorts = 1, name = "SetTimeProgressMarker", doc = "This operator updates the time order marker flag for each tuple. It can be used to state that an input stream should not be used to determine time progess.", url = "", category = { LogicalOperatorCategory.PROCESSING })
