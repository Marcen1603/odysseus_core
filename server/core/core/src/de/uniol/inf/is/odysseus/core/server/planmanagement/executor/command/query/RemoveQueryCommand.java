...
public class RemoveQueryCommand extends AbstractExecutorCommand {

	private String queryName;

	public RemoveQueryCommand(ISession caller, String queryName) {
		super(caller);
	...
	public void execute(IDataDictionaryWritable dd, IUserManagementWritable um,
		...
		executor.removeQuery(queryName, getCaller());
	}
