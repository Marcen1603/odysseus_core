...
/**
 * {@code IExecutorCommandListener} describes an object which will be informed
 * if an {@code IExecutorCommand} is executed.
 * 
...
public interface IExecutorCommandListener {
	...
	/**
	 * The method is called if an {@code IExecutorCommand} is executed.
	 * 
	 * @param command
