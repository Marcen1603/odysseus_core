 ...
 *
 */
@LogicalOperator(maxInputPorts=1, minInputPorts=1, name="AppendTo", doc="Attach a subplan to another operator with a specific id", category={LogicalOperatorCategory.PLAN}, hidden = true)
