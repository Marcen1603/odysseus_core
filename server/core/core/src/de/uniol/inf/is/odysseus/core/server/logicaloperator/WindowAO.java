...
@LogicalOperator(minInputPorts = 1, maxInputPorts = 1, name = "WINDOW", category={LogicalOperatorCategory.BASE}, doc="use TimeWindow, ElementWindow or PredicateWindow instead", hidden=true, deprecation=true)
