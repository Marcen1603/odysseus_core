...
@LogicalOperator(name="TupleAggregate", minInputPorts=1, maxInputPorts=1, category={LogicalOperatorCategory.ADVANCED},doc="Select from all elements of a window on with the given method")
