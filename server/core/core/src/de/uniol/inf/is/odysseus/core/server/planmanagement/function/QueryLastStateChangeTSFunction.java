...
public class QueryLastStateChangeTSFunction extends
		AbstractQueryInformationFunction<Long> {

	private static final long serialVersionUID = -948427057065250120L;

	public QueryLastStateChangeTSFunction() {
		super("QueryLastStateChangeTS", SDFDatatype.LONG);
	}
	...
	public Long getValue() {
		...
		return query.getLastQueryStateChangeTS();
	}
}
