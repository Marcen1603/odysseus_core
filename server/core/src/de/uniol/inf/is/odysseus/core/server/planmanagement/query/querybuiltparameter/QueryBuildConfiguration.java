...
/**
 * QueryBuildConfiguration provides a set of {@link IQueryBuildSetting}. Each
 * standard Parameter has a default value. This class also provides some methods
 * for a simple access to some standard parameters.
 * 
...
public class QueryBuildConfiguration extends
	...
	public QueryBuildConfiguration(IQueryBuildSetting<?>[] parameters,
		...
		if (!contains(ParameterTransformationConfiguration.class)) {
			set(new ParameterTransformationConfiguration(
		...
		if (!contains(ParameterRecursionConnectSink.class)) {
			set(ParameterRecursionConnectSink.FALSE);
		}
	}
	...
	public TransformationConfiguration getTransformationConfiguration() {
		return get(ParameterTransformationConfiguration.class).getValue();
	}
