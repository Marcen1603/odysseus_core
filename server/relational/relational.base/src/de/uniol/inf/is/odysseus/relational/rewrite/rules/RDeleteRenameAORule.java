...
public class RDeleteRenameAORule extends AbstractRewriteRule<RenameAO> {
	...
	@Override
	public void execute(RenameAO rename, RewriteConfiguration transformConfig) throws RuleException {
	...
	@Override
	public boolean isExecutable(RenameAO operator, RewriteConfiguration transformConfig) {
