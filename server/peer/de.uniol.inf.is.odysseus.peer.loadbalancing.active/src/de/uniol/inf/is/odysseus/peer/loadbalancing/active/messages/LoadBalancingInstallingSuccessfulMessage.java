 ...
 *
 */
public class LoadBalancingInstallingSuccessfulMessage implements IMessage {
	 ...
	 * Default Constructor
	 */
	public LoadBalancingInstallingSuccessfulMessage() {
	}
	 ...
	 */
	public LoadBalancingInstallingSuccessfulMessage(int loadBalancingProcessId) {
