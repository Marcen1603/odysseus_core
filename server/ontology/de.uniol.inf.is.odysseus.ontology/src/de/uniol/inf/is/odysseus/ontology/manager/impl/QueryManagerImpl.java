...
public class QueryManagerImpl implements QueryManager {
    ...
    public List<SensingDevice> getSensingDevices(final SDFAttribute attribute) {
        final List<SensingDevice> sensingDevices = new ArrayList<SensingDevice>();
        final String featureOfInterestLabel = SDFUtils.getFeatureOfInterestLabel(attribute);
    ...
    private MeasurementProperty getMeasurementProperty(final OntResource measurementProperty) {
        ...
        return new MeasurementProperty(URI.create(measurementProperty.getURI()), measurementProperty, expression);
