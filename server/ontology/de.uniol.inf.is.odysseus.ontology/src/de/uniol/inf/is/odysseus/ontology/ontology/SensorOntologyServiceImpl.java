    ...
    private void createSensingDevice(final String name, final SDFSchema schema) {
        ...
        for (final SDFAttribute attribute : schema.getAttributes()) {
            ...
            for (final SSNMeasurementProperty ssnMeasurementProperty : SSNMeasurementProperty.values()) {
                final MeasurementProperty measurementProperty = new MeasurementProperty(URI.create(ODYSSEUS.NS + name + "/" + attribute.getAttributeName() + "/" + attribute.getAttributeName() + "/" + ssnMeasurementProperty.toString()), ssnMeasurementProperty.getResource(), "1.0");
