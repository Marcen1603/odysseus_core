...
import de.uniol.inf.is.odysseus.ontology.storage.manager.SourceManager;
...
public class SourceManagerImpl implements SourceManager {
     ...
     */
    private Individual createMeasurementProperty(final URI uri, final String resource) {
