 ...
 *
 */
@LogicalOperator(maxInputPorts = 1, minInputPorts = 1, name = "RUBY", doc = "This operator supports Ruby scripts for data processing", category = { LogicalOperatorCategory.BASE })
