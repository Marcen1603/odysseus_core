 ...
 *
 */
@LogicalOperator(maxInputPorts = 1, minInputPorts = 1, name = "JS", doc = "This operator suports JavaScript scripts for data processing", category = { LogicalOperatorCategory.BASE })
