...
public class AnnotateObjectPO extends AbstractPipe<Tuple<IMetaAttribute>, Tuple<IMetaAttribute>> {
    ...
    public AnnotateObjectPO(AnnotateObjectPO splitPO) {
        super();
		init(splitPO.toolkit, splitPO.models, splitPO.attribute, splitPO.configuration);
    }
     
    public AnnotateObjectPO(NLPToolkit nlpToolkit, List<String> models, SDFAttribute attribute, HashMap<String, Option> configuration) {
	...
	public boolean process_isSemanticallyEqual(IPhysicalOperator ipo) {
	    if(!(ipo instanceof AnnotateObjectPO)) {
	        return false;
	    }
	    AnnotateObjectPO spo = (AnnotateObjectPO) ipo;
