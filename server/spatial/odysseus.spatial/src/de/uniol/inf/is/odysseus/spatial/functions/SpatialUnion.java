...
public class SpatialUnion extends AbstractFunction<Geometry> {
	...
	private static final long serialVersionUID = -5639856984067945270L;

	public SpatialUnion() {
		super("SpatialUnion", 2, accTypes, SDFSpatialDatatype.SPATIAL_GEOMETRY);
	}
	...
	public Geometry getValue() {
		return ((Geometry) this.getInputValue(0)).union((Geometry) this
				.getInputValue(1));
	}
