...
public interface NewSQLParserConstants {
  ...
  int S_POLYGON = 138;
  /** RegularExpression Id. */
  int S_MULTI_POINT = 139;
  /** RegularExpression Id. */
  int S_MULTI_LINE = 140;
  /** RegularExpression Id. */
  int S_MULTI_POLYGON = 141;
  /** RegularExpression Id. */
  int SPATIAL = 142;
  /** RegularExpression Id. */
  int FLOAT = 143;
  ...
  int IPADDRESS = 146;
  /** RegularExpression Id. */
  int LINE_COMMENT = 147;
  /** RegularExpression Id. */
  int MULTI_LINE_COMMENT = 148;
  /** RegularExpression Id. */
  int JDBC_STRING = 149;
  /** RegularExpression Id. */
  int IDENTIFIER = 150;
  ...
  int LETTER = 151;
  /** RegularExpression Id. */
  int SPECIAL_CHARS = 152;
  /** RegularExpression Id. */
  int CHAR_LITERAL = 153;
  /** RegularExpression Id. */
  int SQL_STRING = 154;
  /** RegularExpression Id. */
  int QUOTED_IDENTIFIER = 155;
  /** RegularExpression Id. */
  int COMPARE_OPERATOR = 156;
  /** RegularExpression Id. */
  int REGEXP = 157;
