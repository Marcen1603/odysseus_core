 ...
 */
public class DropSourcePreParserKeyword extends AbstractPreParserKeyword {

	public static final String NAME = "DROPSOURCE";
	...
	public List<IExecutorCommand>  execute(Map<String, Object> variables, String parameter, ISession caller, Context context, IServerExecutor executor) throws OdysseusScriptException {
		...
		cmds.add(new DropViewCommand(parameter, true, caller));
		return cmds;
	}
