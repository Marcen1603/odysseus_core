 ...
 */
public class GrantRolesPreParserKeyword extends AbstractPreParserKeyword {

	public static final String NAME = "GRANTROLES";
	...
	public List<IExecutorCommand>  execute(Map<String, Object> variables, String parameter, ISession caller, Context context, IServerExecutor executor) throws OdysseusScriptException {
		...
		cmds.add(new GrantRoleCommand(userName, role, caller));
		return cmds;
	}
