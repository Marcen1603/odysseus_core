 ...
 * The server is listening on a given port for new clients.
 * If a new client connects to the server, the server opens a new socket-connection for 
 * each client using a StreamClientHandler.  
 */
public class SensorStreamServer extends Thread implements ISensor{
	    ...
	    /* (non-Javadoc)
    	 * @see de.uniol.inf.is.odysseus.service.sensor.ISensor#sendTuple(de.uniol.inf.is.odysseus.service.sensor.data.DataTuple)
    	 */
