...
public class Permutation implements Cloneable,Serializable,Iterator,Comparator,Comparable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -192001461837808254L;
	/**
	 * Containing the permutation. The Numbers 0,1,2,...N-1
	 * @uml.property  name="al" multiplicity="(0 -1)" dimension="1"
	 */
    private int[] Al;
    /**
    ...
    private int N;
    /**
	 * @uml.property  name="fak" multiplicity="(0 -1)" dimension="1"
	 */
