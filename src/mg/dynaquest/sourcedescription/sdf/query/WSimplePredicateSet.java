...
public class WSimplePredicateSet {
    ...
    /* gibt alle Prädikate zurück */
    public ArrayList<WeightedSimplePredicate> getPredicates() {
    	return this.predicates;
    }
    
    /** Mit Hilfe dieser Methode werden alle Prädikate der Menge unabhängig von
     * ihrer Gewichtung zu einem komplexen UND-verknüpften Prädikat zusammengefasst
     * @return UND-Verknüpfung aller enthaltenen Prädikate
     */
	public SDFPredicate combinePredicates() {
		...
		// Ansonsten sind mindestens 2 Prädikate enthalten
		// Jetzt von links nach rechts verknüpfen
		SDFPredicate ret = 
