package mg.dynaquest.sourcedescription.sdf.unit;

import java.util.HashMap;

import mg.dynaquest.sourcedescription.sdf.vocabulary.SDFUnits;
...
public class SDFUnitFactory {
	...
	static public SDFUnit getUnit(String unitURI, String unitGroupURI) {
		...
		while (true) {
			...
			System.err.println("Ungültige Einheitengruppe");
			break;
		}
