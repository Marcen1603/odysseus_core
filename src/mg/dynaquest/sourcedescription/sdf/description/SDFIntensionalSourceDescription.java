...
public class SDFIntensionalSourceDescription extends SDFElement {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="mg.dynaquest.sourcedescription.sdf.description.SDFAccessPattern"
	 */
    // Zugriffsmuster
	...
	public void addSchemaMapping(SDFSchemaMapping mapping) {
		...
		//System.out.println("Neues Schemamapping hinzugefügt:
		// "+mapping.toString());
	}
	...
	//  System.out.println("Neues Qualitätsattribut hinzugefügt:
	// "+qualAttrib.toString());
	// }
