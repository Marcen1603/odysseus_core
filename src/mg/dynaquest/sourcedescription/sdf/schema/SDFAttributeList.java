...
public class SDFAttributeList extends SDFSchemaElementSet<SDFAttribute> {
     ...
     * @return
     */
    public static SDFAttributeList union(SDFAttributeList attributes1, SDFAttributeList attributes2) {
        // Zunächst die beiden Trivialfälle, wenn eine der beiden Mengen leer ist,
     ...
     * @return
     */
    public static SDFAttributeList difference(SDFAttributeList attributes1, SDFAttributeList attributes2) 
    {
    ...
    /**
     * Berechnet den Durchschnitt der beiden Mengen, also die Menge der Elemente, welche in beiden Sets vorkommen
     * @param attributes1 Set1
     * @param attributes2 Set2
     * @return 
     */
    public static SDFAttributeList intersection(SDFAttributeList attributes1, SDFAttributeList attributes2) 
    {
     ...
     * @return
     */
    public static boolean subset(SDFAttributeList attribs1, SDFAttributeList attribs2) {
        return attribs2.elements.containsAll(attribs1.elements);
    }

	
    
//    public SDFAttribute getOutputAttributeWithQualname(String QualName) {
//       return null;
//    }
}