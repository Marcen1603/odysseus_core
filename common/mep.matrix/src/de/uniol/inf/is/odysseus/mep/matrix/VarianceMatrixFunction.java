 ...
 *
 */
public class VarianceMatrixFunction extends AbstractFunction<Double> {

    /**
     * 
     */
    private static final long serialVersionUID = 5635024388724765640L;
    ...
    protected Double getValueInternal(final RealMatrix a) {
        return new Double(a.walkInOptimizedOrder(new RealMatrixPreservingVisitor() {
            ...
            public void start(final int rows, final int columns, final int startRow, final int endRow, final int startColumn, final int endColumn) {
                VarianceMatrixFunction.this.statistics.clear();
            }

            @Override
            public void visit(final int row, final int column, final double value) {
                VarianceMatrixFunction.this.statistics.addValue(value);

            }

            @Override
            public double end() {
                return VarianceMatrixFunction.this.statistics.getVariance();
            }
