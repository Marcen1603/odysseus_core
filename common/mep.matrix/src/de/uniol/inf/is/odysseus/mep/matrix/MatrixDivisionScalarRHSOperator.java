...
public class MatrixDivisionScalarRHSOperator extends AbstractMatrixDivisionScalarOperator {
     ...
     *
     */
    private static final long serialVersionUID = 4495576526371905885L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.MATRIXS, SDFDatatype.NUMBERS };

    public MatrixDivisionScalarRHSOperator() {
        super(MatrixDivisionScalarRHSOperator.ACC_TYPES);
    }
    ...
    public double[][] getValue() {
        ...
        return AbstractMatrixDivisionScalarOperator.getValueInternal(a, b);
    }
