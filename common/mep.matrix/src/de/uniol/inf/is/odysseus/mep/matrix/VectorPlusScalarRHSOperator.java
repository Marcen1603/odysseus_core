 ...
 *
 */
public class VectorPlusScalarRHSOperator extends AbstractVectorPlusScalarOperator {
    ...
    public VectorPlusScalarRHSOperator() {
        super(VectorPlusScalarRHSOperator.ACC_TYPES);
    }
