 ...
 *
 */
public abstract class AbstractVectorMinusScalarOperator extends AbstractBinaryOperator<double[]> {

    /**
     *
     */
    private static final long serialVersionUID = 392978567012133610L;

    public AbstractVectorMinusScalarOperator(final SDFDatatype[][] accTypes) {
    ...
    protected static double[] getValueInternal(final RealVector a, final double b) {
        return a.mapSubtract(b).toArray();
    }
