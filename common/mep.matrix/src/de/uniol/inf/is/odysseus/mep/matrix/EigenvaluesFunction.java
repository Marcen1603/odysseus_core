 ...
 *
 */
public class EigenvaluesFunction extends AbstractFunction<double[]> {

    /**
     * 
     */
    private static final long serialVersionUID = 3672955279777796058L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.MATRIXS };

    public EigenvaluesFunction() {
        super("eig", 1, EigenvaluesFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }

    @Override
    public double[] getValue() {
        final RealMatrix a = new Array2DRowRealMatrix((double[][]) this.getInputValue(0), false);
        return EigenvaluesFunction.getValueInternal(a);
    }
