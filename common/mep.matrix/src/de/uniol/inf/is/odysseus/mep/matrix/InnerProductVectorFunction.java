 ...
 *
 */
public class InnerProductVectorFunction extends AbstractFunction<Double> {
    ...
    public InnerProductVectorFunction() {
        super("dotProduct", 2, InnerProductVectorFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
    ...
    public Double getValue() {
        ...
        return InnerProductVectorFunction.getValueInternal(a, b);
    }
