...
public class ProbabilisticFloat extends AbstractProbabilisticValue<Float> {
    ...
    /**
     * Creates a new {@link ProbabilisticFloat} with the given value and
     * probability.
     * 
     * @param value
     *            The value
    ...
    /**
     * Creates a new {@link ProbabilisticFloat} with the given values and
     * probabilities.
     * 
     * @param values
     *            The values
     ...
     */
    @Override
    public final ProbabilisticFloat clone() {
        return new ProbabilisticFloat(this);
    }
}
