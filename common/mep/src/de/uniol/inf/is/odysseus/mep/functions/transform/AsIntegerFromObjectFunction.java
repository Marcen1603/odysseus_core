 ...
 * 
 */
public class AsIntegerFromObjectFunction extends AbstractUnaryObjectInputFunction<Integer> implements IHasAlias{
	 ...
	 * 
	 */
	public AsIntegerFromObjectFunction() {
		super("asInt", SDFDatatype.INTEGER);
	}
