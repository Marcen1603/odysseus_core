 ...
 * 
 */
public class ToDoubleFromBooleanFunction extends AbstractUnaryBooleanInputFunction<Double> {

	/**
		 * 
		 */
	private static final long serialVersionUID = -1320858430375018327L;

	/**
	 * 
	 */
	public ToDoubleFromBooleanFunction() {
