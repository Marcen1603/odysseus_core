...
public class BitVectorInvertOperator extends AbstractUnaryOperator<BitVector> {

	private static final long serialVersionUID = 5934608915212061886L;
	public static final SDFDatatype[][] accTypes = new SDFDatatype[][] { {SDFDatatype.BITVECTOR}};
	
	public BitVectorInvertOperator() {
		super("~", accTypes, SDFDatatype.BITVECTOR);
	}
