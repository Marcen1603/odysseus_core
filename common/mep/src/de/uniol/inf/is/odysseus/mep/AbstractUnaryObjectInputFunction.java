...
public abstract class AbstractUnaryObjectInputFunction<T> extends AbstractFunction<T> {
	...
	public AbstractUnaryObjectInputFunction(String symbol, SDFDatatype returnType) {
