...
public abstract class AbstractUnaryStringObjectInputFunction<T> extends AbstractFunction<T> {
	...
	public AbstractUnaryStringObjectInputFunction(String symbol, SDFDatatype returnType) {
