...
public class DStringEqualsOperator extends AbstractBinaryDStringInputOperator<Boolean> implements IHasAlias, IEqualsOperator {

	private static final long serialVersionUID = 6011800156304578501L;
	
	public DStringEqualsOperator() {
		this("=");
	}

	public DStringEqualsOperator(String symbol){
