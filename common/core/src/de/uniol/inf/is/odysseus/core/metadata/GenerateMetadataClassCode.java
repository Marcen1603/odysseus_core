...
public class GenerateMetadataClassCode {
	...
	public static String generateClassCode(List<Class<? extends IMetaAttribute>> classList,
			List<IMetaAttribute> metaDataTypes) throws ClassNotFoundException {
		...
		return generateClassCode(interfacesAndClasses, classLoader);
	}

	static private String generateClassCode(List<Pair<String, String>> interfacesAndClasses,
			GenericClassLoader classLoader) throws ClassNotFoundException {

		StringBuffer generatedClassCode = new StringBuffer();
		...
		return generatedClassCode.toString();
	}
