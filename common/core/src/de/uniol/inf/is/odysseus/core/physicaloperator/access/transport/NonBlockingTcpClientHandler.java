...
public class NonBlockingTcpClientHandler extends AbstractTransportHandler implements IAccessConnectionListener<ByteBuffer>, IConnectionListener, TCPConnectorListener {
    ...
    public NonBlockingTcpClientHandler(final IProtocolHandler<?> protocolHandler, final OptionMap options) {
        ...
        try {
            ...
            final InetSocketAddress address = new InetSocketAddress(this.getHost(), this.getPort());
    ...
    private void init() {
        ...
        if (options.containsKey(NonBlockingTcpClientHandler.PORT)) {
            this.setPort(Integer.parseInt(options.get(NonBlockingTcpClientHandler.PORT)));
        }
        else {
            this.setPort(8080);
        }
        if (options.containsKey(NonBlockingTcpClientHandler.READ_BUFFER)) {
            this.setReadBufferSize(Integer.parseInt(options.get(NonBlockingTcpClientHandler.READ_BUFFER)));
        }
        else {
            this.setReadBufferSize(10240);
        }
        if (options.containsKey(NonBlockingTcpClientHandler.WRITE_BUFFER)) {
            this.setWriteBufferSize(Integer.parseInt(options.get(NonBlockingTcpClientHandler.WRITE_BUFFER)));
        }
        else {
        ...
        if (options.containsKey(NonBlockingTcpClientHandler.INITIALIZE_ALIAS)) {
            ...
            NonBlockingTcpClientHandler.LOG.warn("Parameter " + NonBlockingTcpClientHandler.INITIALIZE_ALIAS + " is deprecated. Please use " + NonBlockingTcpClientHandler.INITIALIZE);
        }
        if (options.containsKey(NonBlockingTcpClientHandler.USERNAME)) {
            ...
            NonBlockingTcpClientHandler.LOG.warn("Parameter " + NonBlockingTcpClientHandler.USERNAME + " is deprecated. Please use " + NonBlockingTcpClientHandler.INITIALIZE);
        }
