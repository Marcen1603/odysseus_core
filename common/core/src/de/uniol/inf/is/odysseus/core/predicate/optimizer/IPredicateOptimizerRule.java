 ...
 *
 */
public interface IPredicateOptimizerRule<E extends IPredicate<?>> {
    /**
     ...
     */
    IPredicate<?> executeRule(IPredicate<?> expression);
     ...
     * @return The resulting expression after applying the rule
     */
    IPredicate<?> execute(E expression);
     ...
     */
    boolean isExecutable(IPredicate<?> expression);
}
