 ...
 * @param <E2>
 */
public class FESortedClonablePair<E1 extends IClone, E2 extends IClone> extends
		ClonablePair<E1, E2> implements
	...
	public FESortedClonablePair(FESortedClonablePair<E1, E2> feSortedPair,
			boolean deepClone) {
