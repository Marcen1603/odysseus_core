 ...
 *
 */
public class DuringFunction extends AbstractFunction<Boolean> {

    /**
     *
     */
    private static final long serialVersionUID = -3303917678754214927L;
    ...
    public DuringFunction() {
        super("during", 2, DuringFunction.ACC_TYPES, SDFDatatype.BOOLEAN);
    }
    ...
    public Boolean getValue() {
        ...
        return Boolean.valueOf((a.inf() >= b.inf()) && (a.sup() <= b.sup()));
