...
import de.uniol.inf.is.odysseus.logicaloperator.benchmark.BenchmarkAOExt;
import de.uniol.inf.is.odysseus.planmanagement.TransformationConfiguration;
import de.uniol.inf.is.odysseus.ruleengine.ruleflow.IRuleFlowGroup;
import de.uniol.inf.is.odysseus.transform.flow.TransformRuleFlowGroup;
import de.uniol.inf.is.odysseus.transform.rule.AbstractTransformationRule;

public class TBenchmarkAOExtRule extends
		AbstractTransformationRule<BenchmarkAOExt> {
	...
	public void execute(BenchmarkAOExt operator,
		...
		BenchmarkPOExt po = new BenchmarkPOExt(
				operator.getProcessingTimeInns(), operator.getSelectivity());
