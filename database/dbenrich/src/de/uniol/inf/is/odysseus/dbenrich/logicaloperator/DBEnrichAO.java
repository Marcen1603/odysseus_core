...
public class DBEnrichAO extends UnaryLogicalOp {
	...
	private String cachingStrategy = "myStrategy";
	...
	public DBEnrichAO(DBEnrichAO dBEnrichAO) {
		...
		cachingStrategy = dBEnrichAO.cachingStrategy;
	}
	...
	public String getDebugString() { // TODO DELETE
		...
		return String.format("connectionName:%s, query:%s, variables:%s, cacheSize:%s, cachingStrategy:%s", connectionName, query, variablesStr, cacheSize, cachingStrategy);
	}
	...
	@Parameter(type = StringParameter.class, optional=true, name = "cachingStrategy")
