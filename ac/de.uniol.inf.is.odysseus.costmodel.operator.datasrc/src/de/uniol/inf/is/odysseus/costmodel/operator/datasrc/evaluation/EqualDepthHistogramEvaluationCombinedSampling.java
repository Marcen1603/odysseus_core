...
public class EqualDepthHistogramEvaluationCombinedSampling {
	...
	public static void main(String[] args) {
		 ...
		 */
		IHistogramFactory factory3 = new EqualDepthHistogramFactory(attr, new CombinedSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualDepth-Histogram : Equal distributed Values, Combined Sampling");
		 ...
		 *  Increasing Values
		 */
		IHistogramFactory factory4 = new EqualDepthHistogramFactory(attr, new CombinedSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualDepth-Histogram : Increasing Values, Combined Sampling");
		 ...
		 *  Normalized Values
		 */
		IHistogramFactory factory = new EqualDepthHistogramFactory(attr, new CombinedSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualDepth-Histogram : Normalized Values, Combined Sampling");
		 ...
		 */
		IHistogramFactory factory2 = new EqualDepthHistogramFactory(attr, new CombinedSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualDepth-Histogram : Normalized increasing Values, Combined Sampling");
