...
public class EqualWidthHistogramEvaluationLastNSampling {
	...
	public static void main(String[] args) {
		 ...
		 */
		IHistogramFactory factory3 = new EqualWidthHistogramFactory(attr, new LastNSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualWidth-Histogram : Equal distributed Values, LastNSampling");
		 ...
		 *  Increasing Values
		 */
		IHistogramFactory factory4 = new EqualWidthHistogramFactory(attr, new LastNSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualWidth-Histogram : Increasing Values, LastNSampling");
		 ...
		 *  Normalized Values
		 */
		IHistogramFactory factory = new EqualWidthHistogramFactory(attr, new LastNSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualWidth-Histogram : Normalized Values, LastNSampling");
		 ...
		 */
		IHistogramFactory factory2 = new EqualWidthHistogramFactory(attr, new LastNSampling(2000), new FreedmanDiaconisRule());
		...
		System.out.println("EqualWidth-Histogram : Normalized increasing Values, LastNSampling");
