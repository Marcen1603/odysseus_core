...
//
//import de.uniol.inf.is.odysseus.DataDictionary;
//import de.uniol.inf.is.odysseus.ILogicalOperator;
//import de.uniol.inf.is.odysseus.QueryParseException;
...
//
//// TODO: Diese Klasse funktioniert nicht mehr da sie auf einer anderen Grammatik basiert
//// wird nur aus "Sicherheitsgruenden" aufbewart
class SaseBuilderOld {
//
...
//		SaseParser.queryStmt_return ret;
//		try {
//			ret = grammar.queryStmt();
...
//	}
//
//	private void processReturn(CommonTree child, CepAO cepAo) {
...
//			CepAO cepAo, Set<String> sourceNames) {
//		List<State> states = null;
