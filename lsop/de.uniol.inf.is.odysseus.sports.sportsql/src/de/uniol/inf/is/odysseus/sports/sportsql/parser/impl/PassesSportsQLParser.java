...
public class PassesSportsQLParser {
	...
	private static final String MAX_TIME_DIFF_DIRECT_PASS = "2000000.0";
	...
	public ILogicalOperator getPasses(ISession session, SportsQLQuery sportsQL, List<ILogicalOperator> allOperators) throws SportsQLParseException, NumberFormatException,
