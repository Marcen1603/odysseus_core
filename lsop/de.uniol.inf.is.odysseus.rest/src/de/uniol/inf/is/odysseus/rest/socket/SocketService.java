...
public class SocketService extends Observable {
	...
	public SocketInfo getConnectionInformationWithPorts(ISession session, int queryId, int minPort, int maxPort,
	...
	private SocketSinkPO addSocketSink(int queryId, int port, IPhysicalOperator root) {
		...
		SocketSinkPO sink = new SocketSinkPO(port, "", new NioByteBufferSinkStreamHandlerBuilder(), true, false, false,
