...
public class DatabaseConnectionsView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "de.uniol.inf.is.odysseus.database.rcp.viewer");
		makeActions();
		hookContextMenu();
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				DatabaseConnectionsView.this.fillContextMenu(manager);
			}
		});
