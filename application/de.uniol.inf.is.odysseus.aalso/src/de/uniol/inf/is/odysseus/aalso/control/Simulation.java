...
import de.uniol.inf.is.odysseus.aalso.output.AalsoActivator;
import de.uniol.inf.is.odysseus.aalso.output.AalsoDataProvider;
...
import de.uniol.inf.is.odysseus.aalso.output.StreamServer;
...
public class Simulation implements Runnable {
	...
	private SimulatorOutputPrinter createOutputPrinter(final String type) {
		...
		if (type.equalsIgnoreCase("csv")) {
			...
			try {
				return new AalsoActivator(world);
			} catch (Exception e) {
				e.printStackTrace();
