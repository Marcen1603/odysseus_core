...
public class StreamServer extends Thread {
	...
	public StreamServer(int port, Class<?> streamClientHandler, World world, String placeName) throws Exception {
	...
	public void run() {
		...
		while (!isClosing()) {
			...
			try {
				...
				StreamClientHandler streamClient = new AalsoDataProvider(this.getWorld(), this.getPlaceName());
