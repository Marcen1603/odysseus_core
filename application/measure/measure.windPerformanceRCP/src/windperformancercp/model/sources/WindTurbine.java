...
public class WindTurbine extends AbstractSource {
	...
	public WindTurbine(String name, String identifier, String hostName, int portId, ArrayList<Attribute> attList, double hubHeight, int powerControl, double cutin, double etyFive){
