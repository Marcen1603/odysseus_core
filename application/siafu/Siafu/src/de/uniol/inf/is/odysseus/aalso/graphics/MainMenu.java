...
public class MainMenu {
    ...
    private MenuItem simulationCloseItem, simulationOpenJarItem, simulationOpenDirItem;
    ...
    private MenuItem simulationMenuHeader, optionsMenuHeader, helpMenuHeader;
     ...
     *            the container shell
     * @param simGUI
     *            the simulation's GUI
     * @param siafuConfig
     *            the config for Siafu
     */
     ...
     * 
     * @param header
     *            the header from which the menu hangs
     */
    ...
    /**
     * Get the folder of the last open simulation. This is used to set the open
     * dialog box on the last used folder.
     * 
    ...
    private String getLastFolder() {
        ...
        return selected.substring(0, selected.lastIndexOf(File.separator));
    }
     ...
     * 
     * @param choice
     *            the path to the simulation that we want to open
     */
     ...
     * These menus should be disabled whily a simulation is being loaded.
     * 
     * @param enabled
     *            true if we want to allow the user to change the simulation,
     *            false otherwise
     */
