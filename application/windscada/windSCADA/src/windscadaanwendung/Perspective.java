...
/**
 * This class represents the windSCADA-Perspective with all views, also the ones
 * which use machine learning-tools
 * 
 * @author MarkMilster
 * 
 */
public class Perspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.addView("windscadaanwendung.views.dashboard.WindDirectionPart",
				...
				"windscadaanwendung.views.DetailView");
		layout.addView("windscadaanwendung.views.dashboard.SVRPart",
				...
				IPageLayout.LEFT, 0.76f, "windacadaanwendung.ListView");
		{
			...
			folderLayout
					.addView("windscadaanwendung.views.dashboard.ParkColorListPart");
