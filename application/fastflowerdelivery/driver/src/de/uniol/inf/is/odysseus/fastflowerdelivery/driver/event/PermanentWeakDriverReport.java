...
/**
 * Represents a certain Driver Report event, the permanent weak driver
 *
 * @author Weert Stamm
 * @version 1.0
 */
public class PermanentWeakDriverReport extends AbstractEvent implements ISinkEventHandler {
	private String driverReference;
	
	public PermanentWeakDriverReport() {}
	
	@SuppressWarnings("rawtypes")
	public PermanentWeakDriverReport(Tuple tuple) {
	...
	public void processTuple(@SuppressWarnings("rawtypes") Tuple tuple) {
		PermanentWeakDriverReport report = new PermanentWeakDriverReport(tuple);
