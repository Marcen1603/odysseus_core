...
/**
 * Represents the Improving Note event
 *
 * @author Weert Stamm
 * @version 1.0
 */
public class ImprovingNote extends AbstractEvent implements ISinkEventHandler {
	private String driverReference;
	
	public ImprovingNote() {}
	
	@SuppressWarnings("rawtypes")
	public ImprovingNote(Tuple tuple) {
	...
	public void processTuple(@SuppressWarnings("rawtypes") Tuple tuple) {
		ImprovingNote report = new ImprovingNote(tuple);
