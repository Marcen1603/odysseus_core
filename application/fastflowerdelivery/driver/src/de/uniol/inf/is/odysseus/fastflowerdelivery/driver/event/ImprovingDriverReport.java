...
/**
 * Represents a certain Driver Report event, the improving driver
 *
 * @author Weert Stamm
 * @version 1.0
 */
public class ImprovingDriverReport extends AbstractEvent implements ISinkEventHandler {
	private String driverReference;
	
	public ImprovingDriverReport() {}
	
	@SuppressWarnings("rawtypes")
	public ImprovingDriverReport(Tuple tuple) {
	...
	public void processTuple(@SuppressWarnings("rawtypes") Tuple tuple) {
		ImprovingDriverReport report = new ImprovingDriverReport(tuple);
