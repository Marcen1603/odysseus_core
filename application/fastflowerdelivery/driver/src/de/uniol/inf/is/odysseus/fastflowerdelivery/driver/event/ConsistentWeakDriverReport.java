...
/**
 * Represents a certain Driver Report event, the consistent weak driver
 *
 * @author Weert Stamm
 * @version 1.0
 */
public class ConsistentWeakDriverReport extends AbstractEvent implements ISinkEventHandler {
	private String driverReference;
	
	public ConsistentWeakDriverReport() {}
	
	@SuppressWarnings("rawtypes")
	public ConsistentWeakDriverReport(Tuple tuple) {
	...
	public void processTuple(@SuppressWarnings("rawtypes") Tuple tuple) {
		ConsistentWeakDriverReport report = new ConsistentWeakDriverReport(tuple);
