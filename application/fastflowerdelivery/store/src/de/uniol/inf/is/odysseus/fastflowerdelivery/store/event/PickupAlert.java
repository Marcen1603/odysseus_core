...
/**
 * Represents a Pickup Alert event
 *
 * @author Weert Stamm
 * @version 1.0
 */
public class PickupAlert extends AbstractEvent implements ISinkEventHandler {
	...
	public PickupAlert(Tuple tuple) {
	...
	public void processTuple(Tuple tuple) {
		...
		PickupAlert alert = new PickupAlert(tuple);
