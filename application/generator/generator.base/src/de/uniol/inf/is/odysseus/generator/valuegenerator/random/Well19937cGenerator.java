 ...
 * 
 */
public class Well19937cGenerator extends AbstractSingleValueGenerator {

    private Well19937c random;
    private long seed;

    /**
     * Creates a Well19937c.
     * 
     * @param errorModel
     *            Error model.
     * 
     */
    public Well19937cGenerator(IErrorModel errorModel) {
        this(errorModel, 1l);
    }
     ...
     * 
     */
    public Well19937cGenerator(IErrorModel errorModel, long seed) {
        super(errorModel);
