 ...
 * 
 */
public class ISAACGenerator extends AbstractSingleValueGenerator {
     ...
     * 
     */
    public ISAACGenerator(IErrorModel errorModel) {
        this(errorModel, 1l);
    }
     ...
     * 
     */
    public ISAACGenerator(IErrorModel errorModel, long seed) {
        super(errorModel);
