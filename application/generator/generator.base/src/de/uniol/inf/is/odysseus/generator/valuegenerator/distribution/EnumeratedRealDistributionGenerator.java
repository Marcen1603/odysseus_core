 ...
 * 
 */
public class EnumeratedRealDistributionGenerator extends AbstractSingleValueGenerator {
     ...
     */
    public EnumeratedRealDistributionGenerator(IErrorModel errorModel, double[] singletons, double[] probabilities) {
     ...
     *             all of the probabilities are 0.
     */
    public EnumeratedRealDistributionGenerator(IErrorModel errorModel, double[] singletons, double[] probabilities, long seed) {
        super(errorModel);
        this.distribution = new EnumeratedRealDistribution(singletons, probabilities);
        this.seed = seed;
    }
