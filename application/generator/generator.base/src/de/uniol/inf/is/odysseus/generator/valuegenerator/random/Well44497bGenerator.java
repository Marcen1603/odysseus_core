 ...
 * 
 */
public class Well44497bGenerator extends AbstractSingleValueGenerator {

    private Well44497b random;
    private long seed;
     ...
     * 
     */
    public Well44497bGenerator(IErrorModel errorModel) {
        this(errorModel, 1l);
    }
     ...
     * 
     */
    public Well44497bGenerator(IErrorModel errorModel, long seed) {
        super(errorModel);
