...
public class StringResponse  extends de.uniol.inf.is.soop.webApp.webservice.Response  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.webApp.soop.is.inf.uniol.de/", "stringResponse"));
