...
public class CarUDPOldSinkAdapter extends AbstractSinkAdapter implements
		SinkAdapter {
	private static Logger LOG = LoggerFactory
			.getLogger(CarUDPOldSinkAdapter.class);

	private DatagramChannel channel;
	private final Map<SinkSpec, SocketAddress> sinks = new HashMap<SinkSpec, SocketAddress>();
	private final ByteBuffer buffer;

	public CarUDPOldSinkAdapter() {
