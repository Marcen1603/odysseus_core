...
public class Sample {
    ...
    public float[] getDist1Vector() {
        ...
        vector[0] = (float) (this.getDist1() * Math.sin(angle));
        vector[1] = (float) (this.getDist1() * Math.cos(angle));
        return vector;
    }
    ...
    public float[] getDist2Vector() {
        final float[] vector = new float[2];
        final double angle = Math.toRadians(this.getAngle());
        vector[0] = (float) (this.getDist2() * Math.sin(angle));
        vector[1] = (float) (this.getDist2() * Math.cos(angle));
        return vector;
    }
