...
public class RestService {
    ...
    public static Map<String, Map<Integer, SocketInfo>> runQuery(String ip, String token, String query) throws RestException {
        ...
        ClientResource crCreateSocket = new ClientResource(getHostURL(ip, SERVICE_PATH_CORE, RESOURCE_PATH_CREATE_SOCKET));
    ...
    public static List<ConfigurationDescription> getConfigurations(String ip, String token) throws RestException {
        try {
            String url = getHostURL(ip, SERVICE_PATH_CONDITION, RESOURCE_PATH_GET_CONFIGURATIONS);
            ClientResource crGetConfigs = new ClientResource(url);
