...
//		line += (new BooleanType(agent.isAtDestination()).flatten() + ",");
	...
	/**
	 * Adds Place Info Fields to csv
	 * @param agent
	 * @return
	 */
	private String addSensorInfo(Agent agent) {
		ArrayList<Place> places = world.getPlaces();
		String line = new String();
