...
public abstract class Shape extends VectorObject implements Strokeable,
        ...
        public String getStrokeDashArray() {
                return getImpl().getStrokeDashArray(getElement());
        }
        ...
        public void setStrokeDashArray(String dasharray) {
                getImpl().setStrokeDashArray(getElement(), dasharray);
        }
        ...
        public void setPropertyDouble(String property, double value) {
                ...
                } else if("translate x".equals(property)){
                    setTranslate(value, getTranslate()[1]);
                } else if ("translate y".equals(property)) {
                    setTranslate(getTranslate()[0], value);
                }
        }
}
