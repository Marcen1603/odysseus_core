...
public abstract class VectorObject extends Widget implements HasClickHandlers,
    ...
    public void setTranslate(double x, double y) {
        getImpl().setTranslate(getElement(), x, y);
    }

    public double[] getTranslate() {
        return getImpl().getTranslate(getElement());
    }
    ...
    public void removeFromParent() {
        ...
        getImpl().removeFromParent(getElement());
        if(isAttached())
            onDetach();
        parent = null;
    }
    ...
    public void setObjectOpacity(double opacity){
        getImpl().setObjectOpacity(getElement(), opacity);
    }
}
