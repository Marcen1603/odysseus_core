...
/**
 * Special svg class for a Intersection operator.
 * 
 * @author Alexander Funk
 *
 */
public class OperatorIntersectionSvg extends AbstractOperatorSvg {

	public static final String NAME = "Name";
	
	public static final String DESCRIPTION = "The Intersection operator provides " +
			"the functionality from the intersection in the set theory. The operator " +
			"only forwards sensor data that are equal in both sensor data streams. To " +
			"do so the sensor data stream elements have to be annotated with a validity " +
			"using a Window operator.";
	
	public OperatorIntersectionSvg(SvgEditor editor, OperatorModuleModel temp,
