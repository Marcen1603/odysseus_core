 ...
 */
public class ElectricCooker extends StreamClientHandler{

	/*
	 * Durchschnittswerte Elektroherd
	...
	private double maxWatt = 3000;
	private double runtime = 1.5;
	private int rMin = 0;
	private int rMax = 1;
	private long [] randomStart = new long[rMax];
	private int startMin = 12;
	private int startMax = 14;
	private double startUpTime = 60000;
	private String name = "ElectricCooker";
	...
	public ElectricCooker(ElectricCooker electricCooker) {
	...
	public StreamClientHandler clone() {
		return new ElectricCooker(this);
	}
