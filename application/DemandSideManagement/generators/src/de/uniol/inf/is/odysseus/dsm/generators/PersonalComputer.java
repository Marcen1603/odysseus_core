 ...
 */
public class PersonalComputer extends StreamClientHandler{

	/*
	 * Durchschnittswerte Computer
	 * Laufzeit: 2 Stunden
	 * Watt = 120 W
	 * StartUp = false
	 */
	...
	public PersonalComputer(PersonalComputer personalComputer) {
