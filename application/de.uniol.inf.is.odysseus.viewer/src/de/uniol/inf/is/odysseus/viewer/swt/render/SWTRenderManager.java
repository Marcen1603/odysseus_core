...
public final class SWTRenderManager<C> implements PaintListener, MouseListener, MouseMoveListener, MouseWheelListener, IRenderManager<C> {
	...
	private SWTMiniMapWindow<C> miniMapWindow;
		
	public SWTRenderManager( Composite comp, SWTStatusLine statusText, INodePositioner<C> nodePositioner ) {
		
		if( nodePositioner == null )
			throw new IllegalArgumentException("device is null");
		if( statusText == null ) 
			throw new IllegalArgumentException("statusText is null");
	...
	public void showMinimap() {
		if( miniMapWindow != null ) {
			...
			((Shell)miniMapWindow.getComposite()).forceFocus();
			...
			miniMapWindow = new SWTMiniMapWindow<C>(s, this);
