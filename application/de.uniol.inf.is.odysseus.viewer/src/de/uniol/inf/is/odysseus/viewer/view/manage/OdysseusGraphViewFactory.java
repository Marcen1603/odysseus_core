...
//	}
	...
	@Override
	public IGraphView<IPhysicalOperator> createGraphDisplay( IGraphModel<IPhysicalOperator> graph, ISymbolConfiguration symbolConfig, ISymbolElementFactory<IPhysicalOperator> symbolFactory ) {
		...
		// Graph
		IGraphView<IPhysicalOperator> graphView = new DefaultGraphView<IPhysicalOperator>(graph);
	...
	public void updateGraphDisplay( IGraphModel<IPhysicalOperator> graph, ISymbolConfiguration symbolConfig, ISymbolElementFactory<IPhysicalOperator> symbolFactory, IGraphView<IPhysicalOperator> graphDisplay ) {
		...
		// Schauen, ob neue Knoten hinzugefÃ¼gt worden sind
		final Map<String, Collection<SymbolElementInfo>> map = symbolConfig.getMap();
		...
		// Die Konfiguration kann sich geÃ¤ndert haben...
