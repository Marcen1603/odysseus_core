...
//		configItem.setMenu(configSubMenu);
		...
		selectAllMenuItem.setText("&Alle auswÃ¤hlen\tStrg+A");
		...
		if (!useOGL) {
			...
			miniMapMenuItem.setText("Ãœbersicht\tStrg+M");
...
//		shell.setLayout(gridLayout);
		...
		// Updateregler plaziert werden, sowie geeignete MenÃ¼s
		// if( renderManager instanceof SWTRenderManager<?> ) {

		MenuItem increaseUpdateIntervalMenuItem = new MenuItem(viewSubMenu, SWT.PUSH);
		increaseUpdateIntervalMenuItem.setText("&Intervall erhÃ¶hen\tStrg+Alt+Plus");
	...
	private SWTGraphTab createTab(IGraphView<IPhysicalOperator> graphView) {
		...
		// Zeichenbereich fÃ¼r den Graphen
