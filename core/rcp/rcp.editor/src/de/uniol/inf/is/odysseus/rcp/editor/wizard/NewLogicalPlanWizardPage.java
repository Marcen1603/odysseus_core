...
public class NewLogicalPlanWizardPage extends WizardPage {
	...
	private static final String INFORMATION_TEXT = "Note: The ending '." + ILogicalPlanEditorConstants.LOGICAL_PLAN_FILE_EXTENSION +"' will be automatically added";
	private static final String NO_NAME_ERROR_TEXT = "A unique name must be specified";
	private static final String TITLE_TEXT = "New Logical Plan";
	private static final String DESCRIPTION_TEXT = "Creates a new file for one logical plan";
	private static final String NAME_EXISTS_TEXT = "Name already in use";
	
	private String queryName;
	private IContainer container;
	
	public NewLogicalPlanWizardPage(IContainer container) {
		super(TITLE_TEXT);
	...
	public String getFullQueryName() {
		return queryName + "." + ILogicalPlanEditorConstants.LOGICAL_PLAN_FILE_EXTENSION;
	}
	...
	private static boolean isNameAlreadyUsed( IContainer container, String name ) {
		return container.findMember(name + "." + ILogicalPlanEditorConstants.LOGICAL_PLAN_FILE_EXTENSION) != null;
	}
}
