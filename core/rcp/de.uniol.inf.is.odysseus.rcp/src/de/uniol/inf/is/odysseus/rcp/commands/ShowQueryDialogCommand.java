...
import de.uniol.inf.is.odysseus.rcp.QueryHistory;
...
public class ShowQueryDialogCommand extends AbstractHandler implements IHandler {
		...
		okButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				try {
					...
					map.put(OdysseusRCPPlugIn.PARSER_PARAMETER_ID, parserCombo.getText());
					map.put(OdysseusRCPPlugIn.QUERY_PARAMETER_ID, queryTextField.getText());
					map.put(OdysseusRCPPlugIn.PARAMETER_TRANSFORMATION_CONFIGURATION_NAME_PARAMETER_ID, transCfgCombo.getText());
	...
	private void fillTransformCfgCombo() {
		...
		for (String name :  OdysseusRCPPlugIn.getExecutor().getQueryBuildConfigurationNames()) {
