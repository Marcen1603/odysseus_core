...
public class PartialPlanView extends ViewPart implements IPlanModificationListener {
	...
	private Logger logger = LoggerFactory.getLogger(PartialPlanView.class);
	...
	public void createPartControl(Composite parent) {
		...
		idColumn.setLabelProvider(new CellLabelProvider() {
			...
			public void update(ViewerCell cell) {
				cell.setText(String.valueOf(((IPartialPlan) cell.getElement()).getId()));
			}
		});
		...
		queryColumn.setLabelProvider(new CellLabelProvider() {
			@Override
			public void update(ViewerCell cell) {
				cell.setText(String.valueOf(((IPartialPlan) cell.getElement()).getQueries()));
			}
		});
		...
		sourceColumn.setLabelProvider(new CellLabelProvider() {
			@Override
			public void update(ViewerCell cell) {
				cell.setText(String.valueOf(((IPartialPlan) cell.getElement()).getIterableSources()));
			}
		});
		...
		rootsColumn.setLabelProvider(new CellLabelProvider() {
			@Override
			public void update(ViewerCell cell) {
				cell.setText(String.valueOf(((IPartialPlan) cell.getElement()).getRoots()));
			}
		});
		...
		basePrioColumn.setLabelProvider(new CellLabelProvider() {
			@Override
			public void update(ViewerCell cell) {
				cell.setText(String.valueOf(((IPartialPlan) cell.getElement()).getBasePriority()));
			}
		});
		...
		curPrioColumn.setLabelProvider(new CellLabelProvider() {
			@Override
			public void update(ViewerCell cell) {
				cell.setText(String.valueOf(((IPartialPlan) cell.getElement()).getCurrentPriority()));
			}
		});
		...
		slaRateColumn.setLabelProvider(new CellLabelProvider() {
			@Override
			public void update(ViewerCell cell) {
				cell.setText(String.valueOf(((IPartialPlan) cell.getElement()).getScheduleMeta()));
			}
		});

		tableColumnLayout.setColumnData(slaRateColumn.getColumn(), new ColumnWeightData(5, 25, true));
