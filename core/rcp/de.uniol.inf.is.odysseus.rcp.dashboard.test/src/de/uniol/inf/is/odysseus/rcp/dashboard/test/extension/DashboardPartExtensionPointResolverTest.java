...
public class DashboardPartExtensionPointResolverTest {
	...
	private static Object[][] convertValueDataProvider() {
		return new Object[][] { { "123", "Integer", 123 }, { "123.0", "Double", 123.0 }, { "1", "Long", 1L }, { "123.5f", "Float", 123.5f }, { "Moin", "String", "Moin" }, { "", "String", "" },
				{ "true", "Boolean", true }, { "false", "Boolean", false },

				{ null, "Integer", null }, { null, "Long", null }, { null, "Float", null }, { null, "Double", null }, { null, "String", null }, { null, "Boolean", null }, };
	}
}
