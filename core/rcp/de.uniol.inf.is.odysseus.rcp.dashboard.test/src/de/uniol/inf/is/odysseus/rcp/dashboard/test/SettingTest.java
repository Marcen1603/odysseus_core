...
public class SettingTest {
	...
	public void testConstructor() {
		final Setting<Integer> setting = new Setting<Integer>(newSettingDescriptor());
	...
	public void testConvertValue(String value, String type, Object realValue) throws Throwable {
		final Object result = TestUtil.invoke("convertValue", Setting.class, value, type);
	...
	private static Object[][] convertValueDataProvider() {
		return new Object[][] { { "100", "Integer", 100 }, { "100", "Long", 100L }, { "100.0", "Double", 100.0 }, { "true", "Boolean", true }, { "100", "Float", 100.0f },
				{ "Moin", "String", "Moin" }, { null, "String", null }, { null, "Integer", null }, };
	}
