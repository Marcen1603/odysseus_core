 ...
 * verfolgt. Dabei wird nur in eine Richtung erfasst. Der Baum wird nicht in
 * Richtung Senke verfolgt.
 * 
...
public final class OdysseusModelProviderSinkOneWay implements IModelProvider<IPhysicalOperator> {
	 ...
	 */
	public OdysseusModelProviderSinkOneWay(IPhysicalOperator operator) {
		if (operator == null)
	...
	// verarbeitet
	private <T> void parse(IPhysicalOperator operator, IGraphModel<IPhysicalOperator> graphModel, INodeModel<IPhysicalOperator> srcNode) {
