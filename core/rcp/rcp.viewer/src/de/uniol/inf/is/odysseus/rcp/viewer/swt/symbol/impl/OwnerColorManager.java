...
public class OwnerColorManager {
	...
	private static void createOwnerColors() {
		ownerColors = new OwnerColor[] {
				new OwnerColor( X11Col.CornflowerBlue,  X11Col.gray100,X11Col.CornflowerBlue, X11Col.gray80 ),
				new OwnerColor( X11Col.DodgerBlue,  X11Col.gray100,X11Col.DodgerBlue, X11Col.gray80 ),
				new OwnerColor( X11Col.DodgerBlue3,  X11Col.gray100,X11Col.DodgerBlue3, X11Col.gray80 ),
				new OwnerColor( X11Col.DarkOliveGreen3,  X11Col.gray100,X11Col.DarkOliveGreen3, X11Col.gray80 ),
				new OwnerColor( X11Col.LightSeaGreen,  X11Col.gray100,X11Col.LightSeaGreen, X11Col.gray80 ),
				new OwnerColor( X11Col.LimeGreen,  X11Col.gray100,X11Col.LimeGreen, X11Col.gray80 ),
				new OwnerColor( X11Col.OliveDrab3,  X11Col.gray100,X11Col.OliveDrab3, X11Col.gray80 ),
				new OwnerColor( X11Col.chartreuse3,  X11Col.gray100,X11Col.chartreuse3, X11Col.gray80 ),
				new OwnerColor( X11Col.green4,  X11Col.gray100,X11Col.green4, X11Col.gray80 ),
				new OwnerColor( X11Col.brown3,  X11Col.gray100,X11Col.brown3, X11Col.gray80 ),
				new OwnerColor( X11Col.chocolate3,  X11Col.gray100,X11Col.chocolate3, X11Col.gray80 ),
				new OwnerColor( X11Col.tan3,  X11Col.gray100,X11Col.tan3, X11Col.gray80 ),
				new OwnerColor( X11Col.DarkGoldenrod3,  X11Col.gray100,X11Col.DarkGoldenrod3, X11Col.gray80 ),
				new OwnerColor( X11Col.LemonChiffon3,  X11Col.gray100,X11Col.LemonChiffon3, X11Col.gray80 ),
				new OwnerColor( X11Col.LightGoldenrod3,  X11Col.gray100,X11Col.LightGoldenrod3, X11Col.gray80 ),
				new OwnerColor( X11Col.gold3,  X11Col.gray100,X11Col.gold3, X11Col.gray80 ),
				new OwnerColor( X11Col.goldenrod3,  X11Col.gray100,X11Col.goldenrod3, X11Col.gray80 ),
				new OwnerColor( X11Col.yellow3,  X11Col.gray100,X11Col.yellow3, X11Col.gray80 ),		
