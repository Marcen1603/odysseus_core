 ...
 ******************************************************************************/
package de.uniol.inf.is.odysseus.testng;
...
public class TestUtil {
	...
	public static <T> T invoke( String methodName, Class<?> clazz, Object... parameters ) throws Throwable {
		try {
			...
			return (T)m.invoke(m, parameters);
		} catch( Exception ex ) {
			if( ex.getCause() != null ) {
				throw ex.getCause();
			} else {
	...
	@SuppressWarnings("unchecked")
	public static <T> T invoke( String methodName, Object object, Object... parameters ) throws Throwable {
		try {
			Class<?>[] parameterClasses = getClasses(parameters);
