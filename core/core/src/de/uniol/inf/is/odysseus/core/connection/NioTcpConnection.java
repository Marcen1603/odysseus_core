...
public class NioTcpConnection implements IConnection {
	private static final Logger LOG = LoggerFactory
			.getLogger(NioTcpConnection.class);
	...
	public NioTcpConnection(Selector selector, InetSocketAddress address,
	...
	public NioTcpConnection(Selector selector, SocketChannel channel,
			int readBufferSize, int writeBufferSize,
			IAccessConnectionListener<ByteBuffer> listener) throws IOException {
		this.listener = listener;
		this.readBuffer = ByteBuffer.allocate(readBufferSize);
