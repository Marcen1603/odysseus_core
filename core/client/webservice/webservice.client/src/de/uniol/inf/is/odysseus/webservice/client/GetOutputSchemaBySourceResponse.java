...
/**
 * <p>Java-Klasse f�r getOutputSchemaBySourceResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getOutputSchemaBySourceResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getOutputSchemaBySourceResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetOutputSchemaBySourceResponse {
