...
/**
 * <p>Java-Klasse f�r getConnectionInformationWithMetadataResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getConnectionInformationWithMetadataResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getConnectionInformationWithMetadataResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetConnectionInformationWithMetadataResponse {
