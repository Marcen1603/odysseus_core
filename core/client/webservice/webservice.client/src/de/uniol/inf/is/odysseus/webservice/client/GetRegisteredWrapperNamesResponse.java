...
/**
 * <p>Java-Klasse f�r getRegisteredWrapperNamesResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getRegisteredWrapperNamesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getRegisteredWrapperNamesResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetRegisteredWrapperNamesResponse {
