...
/**
 * <p>Java-Klasse f�r addStoredProcedureResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="addStoredProcedureResponse">
 *   &lt;complexContent>
...
@XmlType(name = "addStoredProcedureResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class AddStoredProcedureResponse {
