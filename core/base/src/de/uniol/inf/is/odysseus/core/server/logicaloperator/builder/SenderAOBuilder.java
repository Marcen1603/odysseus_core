...
public class SenderAOBuilder extends AbstractOperatorBuilder {
    ...
    private final ListParameter<Option> options          = new ListParameter<Option>("OPTIONS", REQUIREMENT.OPTIONAL,
                                                                 new CreateOptionParameter("OPTION",
    ...
    protected boolean internalValidation() {
        if (!this.wrapper.hasValue()) {
            this.addError(new IllegalArgumentException(
                    "to less information for the creation of sender. expecting wrapper."));
            return false;
        }
        return true;
    }
