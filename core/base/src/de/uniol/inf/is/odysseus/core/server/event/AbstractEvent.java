...
public abstract class AbstractEvent<SenderType, ValueType> implements
	...
	/* (non-Javadoc)
	 * @see de.uniol.inf.is.odysseus.core.server.planmanagement.event.IEvent#getSender()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uniol.inf.is.odysseus.core.server.planmanagement.event.IEvent#getValue()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uniol.inf.is.odysseus.core.server.planmanagement.event.IEvent#getID()
	 */
	@Override
