...
public class StandardTransformationHelper implements ITransformationHelper {
	 ...
	 * 
	 * @param oldFather
	 *            The old lower operator (from the dataflow point of view)
	 * @param children
	 *            The following operators of oldFather (from the dataflow point
	 *            of view)
	 * @param newFather
	 *            The new lower operator. oldFather becomes the father of
	 *            newFather
	 * @return the modified children must be returned to update the drools
	 *         working memory
	 */
	@Override
