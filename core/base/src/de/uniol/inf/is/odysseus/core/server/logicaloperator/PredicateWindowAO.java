...
@LogicalOperator(minInputPorts = 1, maxInputPorts = 1, name = "ElEMENTWINDOW", category={LogicalOperatorCategory.BASE}, doc="This is an predicated based window, set start and end condition with predicates.", hidden=true)
