...
@LogicalOperator(minInputPorts = 1, maxInputPorts = 1, name = "PREDICATEWINDOW", category={LogicalOperatorCategory.BASE}, doc="This is an predicated based window, set start and end condition with predicates.", hidden=true)
