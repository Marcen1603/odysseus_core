...
public enum UserManagementAction implements IUserAction {
	// TODO kommentieren
	INSTANCE, GRANT, GRANT_ALL, REVOKE, REVOKE_ALL, CREATE_USER, DELETE_USER, GET_USER, GET_ALL_USER, UPDATE_USER_PASSWORD, CREATE_ROLE, CREATE_PRIV, LOGOUT, CLEAR_USERSTORE, FIND_USER, IS_LOGGEDIN, ADD_LISTENER, REMOVE_LISTENER, DELETE_ROLE;
