 ...
 * 
 */
@LogicalOperator(maxInputPorts=1, minInputPorts=1, name="FILTER", doc="Filters elements of the input stream. If predicate evaluates to true, element will be sent to port 0 else to port 1.", category={LogicalOperatorCategory.BASE})
