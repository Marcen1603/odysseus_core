...
public class TSelectAddHeartbeatGenerationRule extends AbstractTransformationRule<SelectPO<?>> {
    ...
    @Override
    public boolean isExecutable(SelectPO<?> operator, TransformationConfiguration config) {
    ...
    public String getName() {
        return "Insert HeartbeatGenerationStrategy in SelectPO";
    }
    ...
    @Override
    public Class<? super SelectPO<?>> getConditionClass() {
