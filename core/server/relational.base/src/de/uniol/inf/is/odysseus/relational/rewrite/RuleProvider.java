...
import de.uniol.inf.is.odysseus.relational.rewrite.rules.RDeleteRenameAORule;
...
import de.uniol.inf.is.odysseus.relational.rewrite.rules.RSwitchSelectionDifferenceRule;
...
public class RuleProvider implements IRewriteRuleProvider {
    ...
    public List<IRule<?, ?>> getRules() {
        ...
        rules.add(new RSwitchSelectionDifferenceRule());
