...
public interface ICompiler extends IInfoProvider, IRewrite, IPlanGenerator {
	...
	public List<IPhysicalQuery> translateAndTransformQuery(String query,
			...
			Context context, IServerExecutor executor)
	...
	/**
	 * Transforms a query where the logical plan is set into a physical
	 * representation that will be set in the query object
	 * 
	 * @param ILogicalQuery
