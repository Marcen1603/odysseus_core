 ...
 */
public class RelationalPredicate extends AbstractPredicate<Tuple<?>> implements IRelationalPredicate {
		...
		try {
			...
			if (ex1.getReturnType().equals(ex2.getReturnType()) && ex1.isFunction()) {
				...
				if (this.getAttributes().size() == 1) {
					...
					// rechten
					if (firstArgument1.isVariable() && secondArgument1.isConstant() && firstArgument2.isVariable() && secondArgument2.isConstant() && firstArgument1.toVariable().equals(firstArgument2.toVariable())) {
					...
					} else if (secondArgument1.isVariable() && firstArgument1.isConstant() && secondArgument2.isVariable() && firstArgument2.isConstant() && secondArgument1.toVariable().equals(secondArgument2.toVariable())) {
					...
					} else if (firstArgument1.isVariable() && secondArgument1.isConstant() && secondArgument2.isVariable() && firstArgument2.isConstant() && firstArgument1.toVariable().equals(secondArgument2.toVariable())) {
						Double c1 = Double.parseDouble(secondArgument1.toString());
						Double c2 = Double.parseDouble(firstArgument2.toString());
					...
					} else if (secondArgument1.isVariable() && firstArgument1.isConstant() && firstArgument2.isVariable() && secondArgument2.isConstant() && secondArgument1.toVariable().equals(firstArgument2.toVariable())) {
					...
					if (v11.equals(v21) && v12.equals(v22)) {
						if ((symbol1.equals("<") && symbol2.equals("<")) || (symbol1.equals("<=") && symbol2.equals("<=")) || (symbol1.equals("==") && symbol2.equals("==")) || (symbol1.equals("!=") && symbol2.equals("!=")) || (symbol1.equals(">=") && symbol2.equals(">=")) || (symbol1.equals(">") && symbol2.equals(">"))) {
							return true;
						}
					}
	...
	static boolean isAndPredicate(IExpression<?> iExpression) {
		return iExpression.isFunction() && iExpression.toFunction() instanceof AndOperator;
	}
	...
	public static void main(String[] args) {
		...
		RelationalPredicate pred = new RelationalPredicate(new SDFExpression("a>b", MEP.getInstance()));
