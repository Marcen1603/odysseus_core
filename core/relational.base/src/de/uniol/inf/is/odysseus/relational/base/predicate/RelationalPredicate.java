...
public class RelationalPredicate extends AbstractPredicate<Tuple<?>> implements
	...
	public boolean isContainedIn(IPredicate<?> o) {
		...
		if (this.isAndPredicate()) {
			...
			// AndPredicate handelt, m�ssen beide Pr�dikate verglichen werden
			...
			if (ex1.getReturnType().equals(ex2.getReturnType())
				...
				if (this.getAttributes().size() == 1) {
					...
					if (firstArgument1.isVariable()
						...
						// F1 kleiner-als, F2 gr��er-als oder gr��er-gleich-als
						if (symbol1.equals("<")
								&& (symbol2.equals(">") || symbol2.equals(">="))
								&& c1 <= c2) {
							return true;
						...
						// F1 gr��er-als, F2 kleiner-als oder kleiner-gleich-als
						if (symbol1.equals(">")
								&& (symbol2.equals("<") || symbol2.equals("<="))
								&& c1 >= c2) {
							return true;
