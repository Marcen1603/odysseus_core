...
public class RelationalPredicateParser implements RelationalPredicateParserConstants {
  ...
  final public IPredicate OrPredicate() throws ParseException {
  IPredicate < RelationalTuple <? > > first, second;
    first = SimplePredicate();
    jj_consume_token(K_OR);
    second = Predicate();
    {if (true) return ComplexPredicateBuilder.createOrPredicate(first, second);}
    throw new Error("Missing return statement in function");
  }

  final public IPredicate AndPredicate() throws ParseException {
  IPredicate < RelationalTuple <? > > first, second;
    first = SimplePredicate();
    jj_consume_token(K_AND);
    second = Predicate();
    {if (true) return ComplexPredicateBuilder.createAndPredicate(first, second);}
    throw new Error("Missing return statement in function");
  }
  ...
  IPredicate < RelationalTuple <? > > predicate;
    ...
    predicate = Predicate();
    {if (true) return ComplexPredicateBuilder.createNotPredicate(predicate);}
    throw new Error("Missing return statement in function");
  }
