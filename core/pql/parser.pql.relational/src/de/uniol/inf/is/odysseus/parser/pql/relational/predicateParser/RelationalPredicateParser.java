...
public class RelationalPredicateParser implements RelationalPredicateParserConstants {
  ...
  IPredicate < RelationalTuple <? > > first, second;
    ...
    second = Predicate();
    {if (true) return ComplexPredicateHelper.createOrPredicate(first, second);}
    throw new Error("Missing return statement in function");
  }
  ...
  IPredicate < RelationalTuple <? > > first, second;
    ...
    second = Predicate();
    {if (true) return ComplexPredicateHelper.createAndPredicate(first, second);}
    throw new Error("Missing return statement in function");
  }
  ...
  IPredicate < RelationalTuple <? > > predicate;
    ...
    predicate = Predicate();
    {if (true) return ComplexPredicateHelper.createNotPredicate(predicate);}
    throw new Error("Missing return statement in function");
  }
