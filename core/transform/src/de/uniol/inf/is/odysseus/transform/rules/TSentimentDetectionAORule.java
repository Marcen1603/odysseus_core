...
import de.uniol.inf.is.odysseus.core.server.sentimentdetection.logicaloperator.SentimentDetectionAO;
import de.uniol.inf.is.odysseus.core.server.sentimentdetection.physicaloperator.SentimentDetectionPO;
...
public class TSentimentDetectionAORule extends
	...
	public void execute(SentimentDetectionAO sentimentDetectionAO,
		...
		defaultExecute(sentimentDetectionAO, new SentimentDetectionPO(
				sentimentDetectionAO.getPredicates()), config, true, true);
	}
