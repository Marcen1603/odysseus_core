...
public class FloorFunction extends AbstractUnaryNumberInputFunction<Double> {

	private static final long serialVersionUID = -858633322246642617L;

	public FloorFunction() {
		super("floor", SDFDatatype.DOUBLE);
	}
