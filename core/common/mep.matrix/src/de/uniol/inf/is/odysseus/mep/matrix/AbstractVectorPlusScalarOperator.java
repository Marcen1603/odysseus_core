 ...
 *
 */
public abstract class AbstractVectorPlusScalarOperator extends AbstractBinaryOperator<double[]> {

    /**
     *
     */
    private static final long serialVersionUID = 822543810631808993L;

    public AbstractVectorPlusScalarOperator(final SDFDatatype[][] accTypes) {
