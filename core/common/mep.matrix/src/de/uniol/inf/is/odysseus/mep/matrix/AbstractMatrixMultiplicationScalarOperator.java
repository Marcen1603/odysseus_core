 ...
 * @version $Id$
 */
public abstract class AbstractMatrixMultiplicationScalarOperator extends AbstractBinaryOperator<double[][]> {
    ...
    public AbstractMatrixMultiplicationScalarOperator(final SDFDatatype[][] accTypes) {
    ...
    protected static double[][] getValueInternal(final RealMatrix a, final double b) {
        return a.scalarMultiply(b).getData();
    }
