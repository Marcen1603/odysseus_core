...
/**
 * A relational fast median can only be part of a fragment for consistent hash
 ...
 *
 */
public class RelationalFastMedianConsistentHashFragmentationRule extends RelationalFastMedianHorizontalFragmentationRule<ConsistentHashFragmentationQueryPartModificator> {

    @Override
    public boolean canOperatorBePartOfFragments(final ConsistentHashFragmentationQueryPartModificator strategy, final RelationalFastMedianAO operator,
            final AbstractFragmentationParameterHelper helper) {
        return !this.needSpecialHandlingForQueryPart(null, operator, helper);
    }

    @Override
    public boolean needSpecialHandlingForQueryPart(final ILogicalQueryPart part, final RelationalFastMedianAO operator, final AbstractFragmentationParameterHelper helper) {
