...
/**
 * Class of messages to response to a {@link UpdateMergerMessage}.
 * 
 * @author Michael Brand
 */
public class UpdateMergerResponseMessage implements IMessage {
	 ...
	 */
	public UpdateMergerResponseMessage() {
		// Empty default constructor.
	}

	/**
	 * Creates a new update merger acknowledge message.
	 * 
	 * @param uuid
	 *            The id of the original {@link UpdateMergerMessage} message. <br />
	 *            Must be not null.
	 */
	public UpdateMergerResponseMessage(UUID uuid) {
		Preconditions.checkNotNull(uuid);
		this.mID = uuid;
	}

	/**
	 * Creates a new update merger failure message.
	 * 
	 * @param uuid
	 *            The id of the original {@link UpdateMergerMessage} message. <br />
	 *            Must be not null.
	 ...
	 *            Must be not null
	 */
	public UpdateMergerResponseMessage(UUID uuid, String errorMessage) {
		this(uuid);
