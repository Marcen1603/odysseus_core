...
public class LoadBalancingFinishedListener implements Observer {
	...
	private final MovingStateMessageDispatcher dispatcher;
	
	/**
	 * Constructor
	 * @param peerId Peer to inform (initiating Peer)
	 */
	LoadBalancingFinishedListener(MovingStateMessageDispatcher dispatcher, PeerID peerId, String pipeId) {
