...
public class SmartDeviceLocalConfiguration implements
	...
	public static SmartDeviceLocalConfiguration getInstance() {
		if (instance == null) {
			instance = new SmartDeviceLocalConfiguration();
		}
		return instance;
	}
