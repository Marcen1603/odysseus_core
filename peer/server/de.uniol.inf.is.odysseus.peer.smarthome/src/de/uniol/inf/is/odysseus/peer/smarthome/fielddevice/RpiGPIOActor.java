...
public class RpiGPIOActor extends Actor {
	...
	class RpiGPIOActorLogicRule extends LogicRule {
		...
		public LinkedHashMap<String, String> getLogicRuleQueries(
			...
			String activityImportedName = getNameCombination("Activity_imported", activity);
			StringBuilder activityImport = activityImportedStream(activityImportedName, activitySourceName);
			...
			String actorConfigIfParticipateActivity = getNameCombination("Config", activity);
			...
			String setConfigStreamName = getNameCombination("SetActor", activity);
			StringBuilder sbSetConfig = entityConfigStream(
					actorConfigIfParticipateActivity, setConfigStreamName, activitySourceName);
			...
			// 'String']]
			String entitySetStateStreamName =getNameCombination("rpigpio11", activity);
			StringBuilder sbEntitySetState = entitySetStateStream(setConfigStreamName,
					entitySetStateStreamName);
		...
		private StringBuilder activityImportedStream(String activityImportedName, String activitySourceName) {
