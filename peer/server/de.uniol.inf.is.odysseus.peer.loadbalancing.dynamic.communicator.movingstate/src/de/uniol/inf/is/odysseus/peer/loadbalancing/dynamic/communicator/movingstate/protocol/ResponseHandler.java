...
public class ResponseHandler {
	...
	/***
	 * Flag that defines how protocol handles Error during state copy Phase (as
	 * LoadBalancing can be done without having all states copied correctly.)
	 */
