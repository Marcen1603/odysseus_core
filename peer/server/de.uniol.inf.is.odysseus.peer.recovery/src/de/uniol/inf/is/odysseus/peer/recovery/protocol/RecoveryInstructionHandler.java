...
public class RecoveryInstructionHandler {
	...
	public static void handleAddQueryInstruction(
			RecoveryAddQueryMessage message, PeerID sender) {
	...
	private static void addQuery(PeerID senderPeer,
