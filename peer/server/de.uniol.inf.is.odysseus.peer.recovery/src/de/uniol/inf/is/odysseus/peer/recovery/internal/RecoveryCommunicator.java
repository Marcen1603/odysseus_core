...
public class RecoveryCommunicator implements IRecoveryCommunicator {
	...
	@Override
	public void installQueriesOnNewPeer(PeerID failedPeer, PeerID newPeer, int localQueryId, String pql,
		...
		AddQuerySender.getInstance().sendAddQueryPart(newPeer, pql, localQueryId, recoveryStateIdentifier,
				subprocessID, cPeerCommunicator.get());
	}
