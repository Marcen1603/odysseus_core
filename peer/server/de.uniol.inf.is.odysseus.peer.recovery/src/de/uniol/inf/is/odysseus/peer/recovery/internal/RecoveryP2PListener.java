 ...
 * 
 */
// TODO Bad class name. What it does: Observe the network for peers entering or leaving. M.B.
public class RecoveryP2PListener extends Observable implements IRecoveryP2PListener,
	...
	public void bindP2PNetworkManager(IP2PNetworkManager serv) {
		...
		if(!mNetworkObserver.isPresent() && cP2PDictionary.isPresent()) {
			...
			this.startPeerFailureDetection();
	...
	public void activate() {
		...
		if(!mNetworkObserver.isPresent() && cP2PNetworkManager.isPresent() && cP2PDictionary.isPresent()) {
	...
	public void startPeerFailureDetection() {
		...
		final P2PNetworkObserver networkObserver = new P2PNetworkObserver();
		Thread waitForNetwork = new Thread("Wait for network") {
			...
			public void run() {
				...
				RecoveryP2PListener.this.mNetworkObserver = Optional.of(networkObserver);
