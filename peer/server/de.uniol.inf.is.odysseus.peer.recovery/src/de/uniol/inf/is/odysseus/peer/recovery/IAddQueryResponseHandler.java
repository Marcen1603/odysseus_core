...
public interface IAddQueryResponseHandler {
	...
	/**
	 * method for handling the response. Both types (ack and fail) should be handled.
	 * 
	 * @param senderPeer
	 ...
	 *            Must be not null.
	 * @param localQueryId
	 *            The affected local query. <br />
	 */
	void handleAddQueryResponse(PeerID senderPeer, IRecoveryCommunicator communicator,
