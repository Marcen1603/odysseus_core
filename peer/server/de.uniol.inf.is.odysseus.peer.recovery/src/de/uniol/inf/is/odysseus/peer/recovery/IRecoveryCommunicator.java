...
public interface IRecoveryCommunicator {
	 ...
	 *            Must be not null.
	 * @param isNewInfo
	 *            True, is this is a new backup-information or false, if this is an updated information
	 */
	public void sendBackupInformation(PeerID destination, IRecoveryBackupInformation info, boolean isNewInfo);
	
	/**
	 * Distributes the backup-information as updated information to every peer, so that the peer who are affected can update their information
	 * @param info the updated backup-information
	 */
	 ...
	 * specific shared query. It will also send the necessary backup-information to this peer
	 * 
	 * @param sharedQueryId
	 *            The id of the shared query for which the other peer will be the buddy (and thus will do the recovery
	 *            if this peer fails)
	 */
