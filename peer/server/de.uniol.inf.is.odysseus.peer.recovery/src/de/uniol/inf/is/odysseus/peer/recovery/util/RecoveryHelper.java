...
public class RecoveryHelper {
	...
	public static void insertOperatorBefore(ISink sink, AbstractPipe operatorToInsert, int port) {
		...
		operatorToInsert.subscribeToSource((ISource) subscription.getTarget(), subscription.getSinkInPort(), subscription.getSourceOutPort(), subscription.getSchema());
	...
	public static String convertToPQL(ILogicalQueryPart part) {
		return cPQLGenerator.get().generatePQLStatement(part.getOperators().iterator().next());
	}
