...
// TODO This part of the code will be replaced	
...
//			peerIDIndex = (peerIDIndex + 1) % peerIDs.size();
//			
//			LOG.debug("Allocated recovered query to peer {}", Activator.getPeerDictionary().get().getRemotePeerName(chosenPeerID));
//			
//		
//		
//		LOG.debug("RoundRobinAllocation finished");
...
//		
//		for(PeerID peerID : peerIDs) {
//			LOG.debug("\t{}", Activator.getPeerDictionary().get().getRemotePeerName(peerID));
//		}
//	}
//
//	/**
