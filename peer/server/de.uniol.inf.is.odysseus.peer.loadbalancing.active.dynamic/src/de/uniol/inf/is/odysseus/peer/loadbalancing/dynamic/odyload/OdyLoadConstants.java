...
public class OdyLoadConstants {
			...
			public static final String TRIGGER_NAME = "Monitoring";
			...
			public static final double BandwithPerSender = 0.025;
			public static final double BandwithPerReceiver = 0.025;
			//Other
