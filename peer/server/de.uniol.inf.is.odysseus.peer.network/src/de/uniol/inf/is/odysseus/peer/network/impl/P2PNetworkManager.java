...
import de.uniol.inf.is.odysseus.peer.network.PeerNetworkPlugIn;
...
public final class P2PNetworkManager implements IP2PNetworkManager, RendezvousListener {
	...
	private AdvertisementDiscoverer advDiscoverer;
	...
	public void start() throws P2PNetworkException {
		...
		configureLogging(PeerNetworkPlugIn.getBundle());
		...
		try {
			...
			advDiscoverer = new AdvertisementDiscoverer(peerGroup.getDiscoveryService());
			advDiscoverer.start();
			started = true;
	...
	public void addAdvertisementListener(IAdvertisementDiscovererListener listener) {
		AdvertisementDiscoverer.addListener(listener);
	}
	
	@Override
	public void removeAdvertisementListener(IAdvertisementDiscovererListener listener) {
		AdvertisementDiscoverer.removeListener(listener);
	}
}
