 ...
 * 
 */
public class FrequentItemsetIncrementalPO<M extends ITimeInterval> extends AbstractPipe<Tuple<M>, Tuple<ITimeInterval>> {
	...
	private FrequentItemSetContainer<Tuple<M>, M> oneItemSet = new FrequentItemSetContainer<Tuple<M>, M>();
	private List<FrequentItemSetContainer<Tuple<M>, M>> allFrequentItemSets = new ArrayList<FrequentItemSetContainer<Tuple<M>, M>>();

	public FrequentItemsetIncrementalPO() {

	}

	public FrequentItemsetIncrementalPO(FrequentItemsetIncrementalPO<M> old) {
	...
	private void processData(PointInTime currentTime) {
		...
		if (currentTime.after(lastCut)) {
			...
			updateTransactionList(currentTime);
	...
	private void updateTransactionList(PointInTime currentTime) {
	...
	public void updateFrequentsets(Transaction<M> transaction){
...
//	private void updateFrequentCandidates(Transaction<M> transaction){
//		for (Tuple<M> t : transaction.getElements()) {
//
...
//			}
//			fis.setMetadata(transaction.getMetadata());
//		}
...
//	}
	...
	@Override
	public FrequentItemsetIncrementalPO<M> clone() {
		return new FrequentItemsetIncrementalPO<M>(this);
	}
