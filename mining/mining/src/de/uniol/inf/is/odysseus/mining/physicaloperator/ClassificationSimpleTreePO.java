 ...
 * 
 */
public class ClassificationSimpleTreePO<M extends ITimeInterval> extends AbstractPipe<Tuple<M>, Tuple<M>> implements IProcessInternal<Tuple<M>> {

	private static Logger logger = LoggerFactory.getLogger(ClassificationSimpleTreePO.class);
	...
	public ClassificationSimpleTreePO(SDFSchema inputschema, IInputStreamSyncArea<Tuple<M>> inputStreamSyncArea) {
		this.inputSchema = inputschema;
		this.inputStreamSyncArea = inputStreamSyncArea;
	}

	public ClassificationSimpleTreePO(ClassificationSimpleTreePO<M> classificationTreePO) {
	...
	@Override
	public ClassificationSimpleTreePO<M> clone() {
		return new ClassificationSimpleTreePO<M>(this);
	}
