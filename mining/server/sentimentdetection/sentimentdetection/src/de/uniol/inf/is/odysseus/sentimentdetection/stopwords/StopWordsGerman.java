...
public class StopWordsGerman extends AbstractStopWords {
	...
	private static String[] stopwords = { "aber", "als", "am", "an", "auch",
			...
			"können", "könnt", "machen", "mein", "meine", "mit", "muß", "mußt",
			"musst", "müssen", "müßt", "nach", "nachdem", "nein", "nicht",
