...
public class FileHandlerHMM {
	 ...
	 * @param gesture Gesture name to load.
	 */
	 ...
	 * @param obsSequences Training observations.
	 */
	...
	/**
	 * Appends new observation sequence to training data. Creates new file of not existent yet
	 * @param observation Observation sequence to append
	 * @param filePath Path including filename and file extension
	 * @throws IOException 
	 */
	 ...
	 * @param gesture HMM config to save
	 * @param pathToConfigfiles Path to files
	 */
	public static void saveHMMConfigToFile(Gesture gesture, String pathToConfigfiles) {
