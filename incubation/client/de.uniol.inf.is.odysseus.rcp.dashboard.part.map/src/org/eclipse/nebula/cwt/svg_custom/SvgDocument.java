...
public class SvgDocument extends SvgContainer {
	...
	public static enum VARIABLE { FillColor, LineColor, LineWidth };
	public final static String VARIABLE_IDENTIFIER = "$VAR$";
	...
	private HashMap<VARIABLE, Object> vars;
	
	SvgDocument() {
		super(null, null);
		fragmentMap = new HashMap<String, SvgFragment>(3);
		this.vars = new HashMap<VARIABLE, Object>();
	}
	...
	public void setVariable(VARIABLE key, Object value){
