...
import de.uniol.inf.is.odysseus.rcp.dashboard.part.map.style.CollectionStyle;
import de.uniol.inf.is.odysseus.rcp.dashboard.part.map.style.LineStyle;
import de.uniol.inf.is.odysseus.rcp.dashboard.part.map.style.PointStyle;
import de.uniol.inf.is.odysseus.rcp.dashboard.part.map.style.PolygonStyle;
import de.uniol.inf.is.odysseus.rcp.dashboard.part.map.style.Style;
import de.uniol.inf.is.odysseus.rcp.dashboard.part.map.style.Style.STYLE;
