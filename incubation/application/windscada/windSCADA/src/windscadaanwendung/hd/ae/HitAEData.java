...
/**
 * This class holds a List of AEEntrys and represents the historical data of Warnings and Errors. Also it implements a specific type of observable for the GUI which wants to listen to the event of insert or delete a AEEntry.
 * 
 * @author MarkMilster
 *
 */
public class HitAEData {
	...
	/**
	 * Removes a AEObserver from this Observable if it is registered here. You have to call this before a AEObserver will be disposed!
	 * @param obs
	 ...
	 * 
	 * @param aeEntry
	 * 			The AEEntry which is changed.
	 * 			Null if there are no more AEEntrys, because the List was cleared
	 */
