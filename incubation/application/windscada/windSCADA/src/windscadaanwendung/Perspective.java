...
public class Perspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.addView("windscadaanwendung.views.HitAEView", IPageLayout.BOTTOM, 0.58f, "windscadaanwendung.views.UebersichtView");
		...
		layout.addView("windscadaanwendung.views.dashboard.ParkColorListPart", IPageLayout.BOTTOM, 0.5f, "windscadaanwendung.views.UebersichtView");
