...
/**
 * This class should be used as a view of the Dashboardpart which shows the corrected_score (the performance) of a single WKA in a textfield
 * 
 * @author MarkMilster
 *
 */
public class CorrectedScoreTfPart extends WindDashboardPartView {
	 ...
	 * @param wka_id
	 * 		The id of the wka which corrected_score should be shown in the textfield
	 */
