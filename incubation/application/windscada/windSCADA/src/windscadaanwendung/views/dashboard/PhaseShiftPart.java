...
/**
 * This class should be used as a view of the Dashboardpart which shows the phaseShift of a single WKA in a textfield
 * 
 * @author MarkMilster
 *
 */
public class PhaseShiftPart extends WindDashboardPartView {
	 ...
	 * @param wka_id
	 * 		The id of the wka which phaseShift should be shown in the textfield
	 */
