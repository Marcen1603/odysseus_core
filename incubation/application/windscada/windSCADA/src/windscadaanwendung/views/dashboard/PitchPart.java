...
/**
 * This class should be used as a view of the Dashboardpart which shows the pith angle of a single WKA in a textfield
 * 
 * @author MarkMilster
 *
 */
public class PitchPart extends WindDashboardPartView {
	 ...
	 * @param wka_id
	 * 		The id of the wka which pitch angle should be shown in the textfield
	 */
