...
import de.uniol.inf.is.odysseus.codegenerator.operator.rule.AbstractCSlidingElementWindowTIPORule;
...
public class CSlidingElementWindowTIPORule extends AbstractCSlidingElementWindowTIPORule<ElementWindowAO>{
	...
	public CodeFragmentInfo getCode(ElementWindowAO operator) {
		...
		slidingElementWindowCode.addFrameworkImport(SlidingElementWindowTIPO.class.getName());
