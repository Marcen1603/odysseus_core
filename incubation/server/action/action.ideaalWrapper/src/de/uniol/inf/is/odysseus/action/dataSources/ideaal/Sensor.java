 ...
 */
public enum Sensor {
	BedBalance("192.168.0.56", 99, 200, new String[] { "0", "1", "2", "3" }), Bed1(
			"192.168.0.56", 99, 200, new String[] { "0" }), Bed2(
			"192.168.0.56", 99, 200, new String[] { "1" }), Bed3(
			"192.168.0.56", 99, 200, new String[] { "2" }), Bed4(
			"192.168.0.56", 99, 200, new String[] { "3" });
	...
	/**
	 * Returns message which should be send to sensor for data retrieval
	 * 
	 * @return
	 */
	...
	public static SDFSchema getSchema(Sensor sensor) {
		if (schema == null) {
			...
			SDFDatatype[] types = { SDFDatatype.LONG, SDFDatatype.INTEGER,
					SDFDatatype.DOUBLE, SDFDatatype.DOUBLE, SDFDatatype.DOUBLE,
					SDFDatatype.DOUBLE };
			...
			SDFSchema schema = SDFSchemaFactory.createNewTupleSchema("BedBalance", attrs);
			...
			schema = SDFSchemaFactory.createNewTupleSchema("Bed", attrs);
