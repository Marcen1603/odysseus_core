...
/**
 *  AbstractTNoSQLAORule is protected, because AbstractTNoSQLSinkAORule or AbstractTNoSQLSourceAORule should be used instead
 *
 *  AbstractTNoSQLAORule helps creating transformation rules by outsourcing recurring operations
 *
 * @param <L> the concrete logical operator class
 * @param <P> AbstractNoSQLSinkPO or AbstractNoSQLSourcePO (P don't have to be more specified)
 */
abstract class AbstractTNoSQLAORule<L extends AbstractNoSQLAO, P extends IPhysicalOperator> extends AbstractTransformationRule<L> {
	...
	@Override
    public final void execute(AbstractNoSQLAO logicalOperator, TransformationConfiguration config) throws RuleException {
        ...
        try {
            ...
            physicalOperator = (P) physicalOperatorClass.getDeclaredConstructor(logicalOperatorClass).newInstance(logicalOperator);
        } catch (Exception e) {
