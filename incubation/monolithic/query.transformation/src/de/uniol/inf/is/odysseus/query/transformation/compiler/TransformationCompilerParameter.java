...
public class TransformationCompilerParameter {
	...
	public TransformationCompilerParameter(String programLanguage, String tempDirectory, String destinationDirectory, int queryId){
