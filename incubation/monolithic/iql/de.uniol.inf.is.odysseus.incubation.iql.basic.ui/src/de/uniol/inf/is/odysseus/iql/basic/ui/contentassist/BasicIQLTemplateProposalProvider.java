...
public class BasicIQLTemplateProposalProvider extends AbstractIQLTemplateProposalProvider<BasicIQLExpressionEvaluator, BasicIQLTypeFactory, BasicIQLLookUp, BasicIQLScopeProvider, BasicIQLTypeUtils> {

	@Inject
	public BasicIQLTemplateProposalProvider(TemplateStore templateStore,
			ContextTypeRegistry registry, ContextTypeIdHelper helper, BasicIQLExpressionEvaluator exprEvaluator, BasicIQLTypeFactory factory, BasicIQLLookUp lookUp, BasicIQLScopeProvider scopeProvider, BasicIQLTypeUtils typeUtils) {
