...
public class BasicIQLProposalBuilder extends AbstractIQLProposalBuilder {
	

	public BasicIQLProposalBuilder(BasicIQLTypeFactory factory, ContentAssistContext contentAssistContext,
