...
public class BasicIQLProposalProvider extends AbstractBasicIQLProposalProvider {
	...
	@Inject
	private BasicIQLTypeFactory factory;
	...
	protected Function<IEObjectDescription, ICompletionProposal> getProposalFactory(String ruleName, ContentAssistContext contentAssistContext) {		
		return new BasicIQLProposalBuilder(factory, contentAssistContext, ruleName, converter, getValueConverter(), getLabelProvider(), getPriorityHelper(), getHover(), getConflictHelper());
	}
}
