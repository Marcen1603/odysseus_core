...
public class ODLExpressionCompiler extends AbstractIQLExpressionCompiler<ODLCompilerHelper, ODLGeneratorContext, ODLTypeCompiler, ODLExpressionParser, ODLTypeUtils, ODLLookUp, ODLTypeExtensionsFactory> {
  @Inject
  public ODLExpressionCompiler(final ODLCompilerHelper helper, final ODLTypeCompiler typeCompiler, final ODLExpressionParser parser, final ODLTypeUtils typeUtils, final ODLLookUp lookUp, final ODLTypeExtensionsFactory typeOperatorsFactory) {
