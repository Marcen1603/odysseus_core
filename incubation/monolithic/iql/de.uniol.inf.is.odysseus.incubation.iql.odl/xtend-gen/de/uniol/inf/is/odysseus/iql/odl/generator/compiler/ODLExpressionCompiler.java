...
public class ODLExpressionCompiler extends AbstractIQLExpressionCompiler<IODLCompilerHelper, IODLGeneratorContext, IODLTypeCompiler, IODLExpressionEvaluator, IODLTypeUtils, IODLLookUp, IODLTypeExtensionsDictionary> implements IODLExpressionCompiler {
  @Inject
  public ODLExpressionCompiler(final IODLCompilerHelper helper, final IODLTypeCompiler typeCompiler, final IODLExpressionEvaluator exprEvaluator, final IODLTypeUtils typeUtils, final IODLLookUp lookUp, final IODLTypeExtensionsDictionary typeExtensionsDictionary) {
