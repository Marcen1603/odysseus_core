...
public class ODLExpressionCompiler extends AbstractIQLExpressionCompiler<ODLCompilerHelper, ODLGeneratorContext, ODLTypeCompiler, ODLExpressionParser, ODLTypeFactory, ODLLookUp> {
  @Inject
  public ODLExpressionCompiler(final ODLCompilerHelper helper, final ODLTypeCompiler typeCompiler, final ODLExpressionParser parser, final ODLTypeFactory factory, final ODLLookUp lookUp) {
