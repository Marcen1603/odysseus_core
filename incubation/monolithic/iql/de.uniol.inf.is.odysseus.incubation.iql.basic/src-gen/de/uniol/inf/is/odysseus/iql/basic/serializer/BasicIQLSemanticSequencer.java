...
public class BasicIQLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *     var=[JvmField|ID]
	 */
	protected void sequence_IQLAttributeSelection(EObject context, IQLAttributeSelection semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_ATTRIBUTE_SELECTION__VAR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_ATTRIBUTE_SELECTION__VAR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLAttributeSelectionAccess().getVarJvmFieldIDTerminalRuleCall_1_0_1(), semanticObject.getVar());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (expr=IQLLiteralExpression body=IQLStatement)
	 */
	protected void sequence_IQLCasePart(EObject context, IQLCasePart semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_CASE_PART__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_CASE_PART__EXPR));
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_CASE_PART__BODY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_CASE_PART__BODY));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLCasePartAccess().getExprIQLLiteralExpressionParserRuleCall_2_0(), semanticObject.getExpr());
		feeder.accept(grammarAccess.getIQLCasePartAccess().getBodyIQLStatementParserRuleCall_4_0(), semanticObject.getBody());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_IQLFormalParameter(EObject context, IQLVariableDeclaration semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     value=CHAR
	 */
	protected void sequence_IQLLiteralExpression(EObject context, IQLLiteralExpressionChar semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_LITERAL_EXPRESSION_CHAR__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_LITERAL_EXPRESSION_CHAR__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLLiteralExpressionAccess().getValueCHARTerminalRuleCall_4_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	protected void sequence_IQLLiteralExpression(EObject context, IQLLiteralExpressionRange semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLLiteralExpressionAccess().getValueRANGETerminalRuleCall_5_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (leftOperand=IQLMemberCallExpression_IQLArrayExpression_1_0_0 expr=IQLExpression)
	 */
	protected void sequence_IQLMemberCallExpression(EObject context, IQLArrayExpression semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_ARRAY_EXPRESSION__LEFT_OPERAND) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_ARRAY_EXPRESSION__LEFT_OPERAND));
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_ARRAY_EXPRESSION__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_ARRAY_EXPRESSION__EXPR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLMemberCallExpressionAccess().getIQLArrayExpressionLeftOperandAction_1_0_0(), semanticObject.getLeftOperand());
		feeder.accept(grammarAccess.getIQLMemberCallExpressionAccess().getExprIQLExpressionParserRuleCall_1_0_2_0(), semanticObject.getExpr());
		feeder.finish();
	}
	 ...
	 * Constraint:
	 *     (
	 *         leftOperand=IQLMemberCallExpression_IQLMemberSelectionExpression_2_0_0_0 
	 *         (rightOperand=IQLAttributeSelection | rightOperand=IQLMethodSelection)
	 *     )
	 */
	 ...
	 *     value=CHAR
	 */
	protected void sequence_IQLMetadataValueSingle(EObject context, IQLMetadataValueSingleChar semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_METADATA_VALUE_SINGLE_CHAR__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_METADATA_VALUE_SINGLE_CHAR__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLMetadataValueSingleAccess().getValueCHARTerminalRuleCall_4_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *     value=INT
	 */
	protected void sequence_IQLMetadataValueSingle(EObject context, IQLMetadataValueSingleLong semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_METADATA_VALUE_SINGLE_LONG__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_METADATA_VALUE_SINGLE_LONG__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	protected void sequence_IQLMetadata(EObject context, IQLMetadata semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_METADATA__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_METADATA__NAME));
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_METADATA__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_METADATA__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLMetadataAccess().getNameIDTerminalRuleCall_0_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getIQLMetadataAccess().getValueIQLMetadataValueParserRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_IQLMethodSelection(EObject context, IQLMethodSelection semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_METHOD_SELECTION__METHOD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_METHOD_SELECTION__METHOD));
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_METHOD_SELECTION__ARGS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_METHOD_SELECTION__ARGS));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLMethodSelectionAccess().getMethodIDTerminalRuleCall_1_0(), semanticObject.getMethod());
		feeder.accept(grammarAccess.getIQLMethodSelectionAccess().getArgsIQLArgumentsListParserRuleCall_2_0(), semanticObject.getArgs());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (expr=IQLExpression cases+=IQLCasePart* default=IQLStatement?)
	 */
	 ...
	 */
	protected void sequence_IQLTerminalExpression(EObject context, IQLTerminalExpressionNew semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     expr=IQLExpression
	 */
	protected void sequence_IQLTerminalExpression(EObject context, IQLTerminalExpressionParenthesis semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_TERMINAL_EXPRESSION_PARENTHESIS__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_TERMINAL_EXPRESSION_PARENTHESIS__EXPR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLTerminalExpressionAccess().getExprIQLExpressionParserRuleCall_3_2_0(), semanticObject.getExpr());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     {IQLTerminalExpressionSuper}
	 */
	protected void sequence_IQLTerminalExpression(EObject context, IQLTerminalExpressionSuper semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     {IQLTerminalExpressionThis}
	 */
	protected void sequence_IQLTerminalExpression(EObject context, IQLTerminalExpressionThis semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     var=[IQLVariableDeclaration|ID]
	 */
	protected void sequence_IQLTerminalExpression(EObject context, IQLTerminalExpressionVariable semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BasicIQLPackage.Literals.IQL_TERMINAL_EXPRESSION_VARIABLE__VAR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BasicIQLPackage.Literals.IQL_TERMINAL_EXPRESSION_VARIABLE__VAR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIQLTerminalExpressionAccess().getVarIQLVariableDeclarationIDTerminalRuleCall_0_1_0_1(), semanticObject.getVar());
		feeder.finish();
	}
