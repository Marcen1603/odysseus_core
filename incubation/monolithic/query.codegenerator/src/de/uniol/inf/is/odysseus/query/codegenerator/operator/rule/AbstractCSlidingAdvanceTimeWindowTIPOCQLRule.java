...
public abstract class AbstractCSlidingAdvanceTimeWindowTIPOCQLRule<T extends WindowAO> extends
AbstractRule<WindowAO>{

	public AbstractCSlidingAdvanceTimeWindowTIPOCQLRule(String name) {
	super(name);
	}
