...
import de.uniol.inf.is.odysseus.query.codegenerator.operator.rule.AbstractCSlidingAdvanceTimeWindowTIPOCQLRule;
import de.uniol.inf.is.odysseus.server.intervalapproach.window.SlidingAdvanceTimeWindowTIPO;

public class CSlidingAdvanceTimeWindowTIPOCQLRule extends AbstractCSlidingAdvanceTimeWindowTIPOCQLRule<WindowAO>{


	public CSlidingAdvanceTimeWindowTIPOCQLRule(){
		super(CSlidingAdvanceTimeWindowTIPOCQLRule.class.getName());
	}
