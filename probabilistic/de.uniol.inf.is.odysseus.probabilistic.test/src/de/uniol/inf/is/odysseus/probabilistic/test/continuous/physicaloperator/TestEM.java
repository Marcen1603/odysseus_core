...
public class TestEM {
	/**
	 * Tests the EM algorithm.
	 * 
	 * 
	 * FIXME needs rework
	 */
	@Test
	public final void testEM() {
		...
		final Object[] attributes2 = new Object[] { 2.0, 2.0, 5.0, 12.0 };
		final Object[] attributes3 = new Object[] { 3.0, 3.0, 7.0, 13.0 };
		final Object[] attributes4 = new Object[] { 4.0, 4.0, 8.0, 14.0 };
		final Object[] attributes5 = new Object[] { 5.0, 5.0, 9.0, 15.0 };
		final Object[] attributes6 = new Object[] { 6.0, 6.0, 10.0, 16.0 };
		...
		final EMPO<ITimeInterval> em = new EMPO<ITimeInterval>(new int[] { 0, 1, 3 }, 3);
		for (int i = 0; i < 100; i++) {
			final ProbabilisticTuple<ITimeInterval> tmpTuple1 = tuple1.clone();
			...
			final ProbabilisticTuple<ITimeInterval> tmpTuple2 = tuple2.clone();
			...
			final ProbabilisticTuple<ITimeInterval> tmpTuple3 = tuple3.clone();
			...
			final ProbabilisticTuple<ITimeInterval> tmpTuple4 = tuple4.clone();
			...
			final ProbabilisticTuple<ITimeInterval> tmpTuple5 = tuple5.clone();
			...
			final ProbabilisticTuple<ITimeInterval> tmpTuple6 = tuple6.clone();
