...
public class TestProjectPO extends RelationalProjectPO<IMetaAttribute> {
	...
	public final Object[][] provideTuple() {
		return new Object[][] { { this.provideSimpleTuple() }, { this.provideUnivariateTuple() }, { this.provideMultivariateTuple1() }, { this.provideMultivariateTuple2() }, { this.provideMultivariateTuple3() }, { this.provideMultivariateTuple4() } };
	}
