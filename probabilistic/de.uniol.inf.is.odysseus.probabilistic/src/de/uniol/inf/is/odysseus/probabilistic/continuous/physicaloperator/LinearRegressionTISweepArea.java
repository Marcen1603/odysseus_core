...
public class LinearRegressionTISweepArea extends JoinTISweepArea<ProbabilisticTuple<? extends ITimeInterval>> implements Cloneable {
	...
	/**
	 * Default constructor to create a sweep area that performs a linear regression on the given attributes.
	 * 
	...
	/**
	 * Returns <code>true</code> there is at least one more element in the area than the number of attributes. More formaly this function returns <code>true</code> iff the number of data is greater than the number of explanatory and dependent attributes.
	 * 
	...
	/**
	 * Perform least square estimation of residual (r) and regression coefficient (c) for the given explanatory attribute. More formaly perform the following equation:
	 * 
	 * \f$c = (A^{T} A)^{-1} A^{T} B\f$
	 * 
