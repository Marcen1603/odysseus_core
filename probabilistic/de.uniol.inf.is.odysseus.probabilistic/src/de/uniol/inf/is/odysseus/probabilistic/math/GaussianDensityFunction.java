...
public class GaussianDensityFunction implements ProbabilityDensityFunction {
	...
	public GaussianDensityFunction add(final GaussianDensityFunction probabilityDensityFunction) {
		return new GaussianDensityFunction(this.distribution.getMean() + probabilityDensityFunction.distribution.getMean(), this.distribution.getStandardDeviation() + probabilityDensityFunction.distribution.getStandardDeviation());
	}
