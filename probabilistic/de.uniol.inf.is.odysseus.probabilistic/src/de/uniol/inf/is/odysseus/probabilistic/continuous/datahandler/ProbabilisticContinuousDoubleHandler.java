...
public class ProbabilisticContinuousDoubleHandler extends AbstractDataHandler<ProbabilisticContinuousDouble> {
	...
	static {
		ProbabilisticContinuousDoubleHandler.types.add(SDFProbabilisticDatatype.PROBABILISTIC_CONTINUOUS_BYTE.getURI());
		ProbabilisticContinuousDoubleHandler.types.add(SDFProbabilisticDatatype.PROBABILISTIC_CONTINUOUS_SHORT.getURI());
		ProbabilisticContinuousDoubleHandler.types.add(SDFProbabilisticDatatype.PROBABILISTIC_CONTINUOUS_INTEGER.getURI());
		ProbabilisticContinuousDoubleHandler.types.add(SDFProbabilisticDatatype.PROBABILISTIC_CONTINUOUS_LONG.getURI());
		ProbabilisticContinuousDoubleHandler.types.add(SDFProbabilisticDatatype.PROBABILISTIC_CONTINUOUS_FLOAT.getURI());
		ProbabilisticContinuousDoubleHandler.types.add(SDFProbabilisticDatatype.PROBABILISTIC_CONTINUOUS_DOUBLE.getURI());
	}
