...
public class ProbabilisticContinuousMinusNumberRHSOperator extends AbstractProbabilisticContinuousMinusNumberOperator {
	...
	public final SDFDatatype[] getAcceptedTypes(final int argPos) {
		...
		return ProbabilisticContinuousMinusNumberRHSOperator.ACC_TYPES[argPos];
	}

	/*
	 * 
	 * @see de.uniol.inf.is.odysseus.probabilistic.continuous.functions.math.AbstractProbabilisticContinuousMinusNumberOperator#isCommutative()
	 */
	@Override
