...
public class SDFProbabilisticDatatype extends SDFDatatype {
    ...
    public static final SDFDatatype COVARIANCE_MATRIX = new SDFProbabilisticDatatype("CovarianceMatrix");
    public static final SDFDatatype MULTIVARIATE_COVARIANCE_MATRIX = new SDFProbabilisticDatatype("MultivariateCovarianceMatrix");
 ...
 */
    ...
    public boolean isDouble() {
        return this.getURI().equals(PROBABILISTIC_DOUBLE.getURI()) || this.getURI().equals(PROBABILISTIC_CONTINUOUS_DOUBLE.getURI());
    }
 ...
 */
    ...
    public boolean isInteger() {
        return this.getURI().equals(PROBABILISTIC_INTEGER.getURI()) || this.getURI().equals(PROBABILISTIC_CONTINUOUS_INTEGER.getURI());
    }
 ...
 */
    ...
    public boolean isLong() {
        return this.getURI().equals(PROBABILISTIC_LONG.getURI()) || this.getURI().equals(PROBABILISTIC_CONTINUOUS_LONG.getURI());
    }
 ...
 */
    ...
    public boolean isFloat() {
        return this.getURI().equals(PROBABILISTIC_FLOAT.getURI()) || this.getURI().equals(PROBABILISTIC_CONTINUOUS_FLOAT.getURI());
    }
 ...
 */
    ...
    public boolean isShort() {
        return this.getURI().equals(PROBABILISTIC_SHORT.getURI()) || this.getURI().equals(PROBABILISTIC_CONTINUOUS_SHORT.getURI());
    }
 ...
 */
    ...
    public boolean isByte() {
        return this.getURI().equals(PROBABILISTIC_BYTE.getURI()) || this.getURI().equals(PROBABILISTIC_CONTINUOUS_BYTE.getURI());
    }
 ...
 */
    ...
    public boolean compatibleTo(final SDFDatatype other) {
        if (other instanceof SDFProbabilisticDatatype) {
            ...
            if ((this.isDiscrete() && (otherProbabilistic.isDiscrete())) || (this.isContinuous() && (otherProbabilistic.isContinuous())) || (this.isCovarianceMatrix() && (otherProbabilistic.isCovarianceMatrix()))
