 ...
 * 
 */
public class ProbabilisticContinuousSmallerEqualsOperator extends AbstractProbabilisticBinaryOperator<ProbabilisticContinuousPredicateResult> {
	...
	public SDFDatatype[] getAcceptedTypes(final int argPos) {
		...
		return ProbabilisticContinuousSmallerEqualsOperator.accTypes[argPos];
	}
