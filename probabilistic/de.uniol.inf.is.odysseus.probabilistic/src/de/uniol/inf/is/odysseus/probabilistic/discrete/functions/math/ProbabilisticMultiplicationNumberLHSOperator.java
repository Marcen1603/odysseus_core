...
public class ProbabilisticMultiplicationNumberLHSOperator extends ProbabilisticMultiplicationOperator {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2201151609608243659L;
	...
	/*
	 * 
	 * @see de.uniol.inf.is.odysseus.probabilistic.discrete.functions.math.ProbabilisticMultiplicationOperator#isCommutative()
	 */
	@Override
	...
	/*
	 * 
	 * @see de.uniol.inf.is.odysseus.probabilistic.discrete.functions.math.ProbabilisticMultiplicationOperator#getAcceptedTypes(int)
	 */
	@Override
	public final SDFDatatype[] getAcceptedTypes(final int argPos) {
		...
		return ProbabilisticMultiplicationNumberLHSOperator.ACC_TYPES[argPos];
	}
