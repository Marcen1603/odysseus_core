...
public class NewProbabilityChart3D extends AbstractView<NormalDistributionMixture, IMetaAttribute> implements IChartSettingChangeable {
	
	public static final String VIEW_ID = "de.offis.chart.charts.newprobabilitychart3d";
...
//		m.set(funcs);
	...
	public void createPartControl(Composite parent) {
		...
		swtFrame.addKeyListener(new KeyListener() {
...
//		sm.setDispDivisions(1000);
		...
		chart.setTitleText("NewProbabilityChart3D");
	}
