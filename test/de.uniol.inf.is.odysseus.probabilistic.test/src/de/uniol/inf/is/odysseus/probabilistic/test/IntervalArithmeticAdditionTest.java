...
public class IntervalArithmeticAdditionTest {
    @Parameters(name = "{index}: {0} + {1} = {2}")
    public static Collection<Object[]> data() {

        return Arrays.asList(new Object[][] { //
                { Interval.of(1.0, 3.0), Interval.of(3.0, 5.0), Interval.of(4.0, 8.0) }, //

                { Interval.of(-1.0, -3.0), Interval.of(3.0, 5.0), Interval.of(0.0, 4.0) }, //
                { Interval.of(-3.0, -1.0), Interval.of(3.0, 5.0), Interval.of(0.0, 4.0) }, //
    ...
    private void whenAdd(Interval left, Interval right) {

        System.out.print(String.format("%s + %s == ", left, right));
        final Stopwatch timer = Stopwatch.createStarted();

        tmpResult = left.add(right);
