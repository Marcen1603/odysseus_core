...
public class BenchmarkEditorPart extends EditorPart implements ISaveablePart, PropertyChangeListener {
	...
	public void doSave(IProgressMonitor monitor) {
		// �berpr�ft, ob Benchmarker mit diesen Einstellungen gestartet werden
		// kann
    ...
    public void createPartControl(Composite composite) {
		...
		// Abh�ngigkeit von Extended_Postpriorisation zu Priority
		...
		// Abh�ngigkeit von Result_Per_Query zu Max_Result
		...
		// In Max_Result, Wait_Config und Number_Of_Runs d�rfen nur Zahlen
		// stehen
		...
		// �berpr�fe ob die Buttons aktiviert/deaktiviert sein muessen.
		propertyChange(new PropertyChangeEvent(benchmarkParam, null, null, null));
		setDirtyState(false);
	}

	/**
	 * Diese Methode �berpr�ft, ob die gespeicherten Parametereinstellungen
	 * ge�ndert werden d�rfen und setzt sie ggf. auf Enabled(false)
	 */
	...
	/**
	 * Wenn sich die Eingaben ver�ndern
	 */
	@Override
	...
	/**
	 * �berpr�ft die angeklickte Metadata-Kombination
	 * 
	 * @return
	 */
	...
	/**
	 * �berpr�ft, ob BenchmarkProzess mit diesen
	...
	/**
	 * �berpr�ft, ob die erforderten Felder zum Starten des Benchmarkprozesses
	 * ausgef�llt sind
	 * 
	 * @param benchmarkParam
	 * @return
