 ...
 * @author Jonas Jacobi
 */
@LogicalOperator(name = "BENCHMARK", minInputPorts = 1, maxInputPorts = Integer.MAX_VALUE, doc="Simulate an operator with specific behavior.", category={LogicalOperatorCategory.BENCHMARK})
