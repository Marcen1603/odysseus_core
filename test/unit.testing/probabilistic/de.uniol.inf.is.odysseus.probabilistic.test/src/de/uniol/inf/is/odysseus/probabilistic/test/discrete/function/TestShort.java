...
public class TestShort {
    ...
    public final void testShortPlus(final ProbabilisticShort left, final ProbabilisticShort right, final ProbabilisticDouble result) {
        ...
        function.setArguments(new Constant<ProbabilisticShort>(left, SDFProbabilisticDatatype.PROBABILISTIC_SHORT), new Constant<ProbabilisticShort>(right,
    ...
    public final Object[][] provideDiscreteDivisionShortValues() {
        return new Object[][] {
                ...
                {
                        new ProbabilisticShort(new Short[] { 1, 3, 5, 7 }, new Double[] { 0.25, 0.25, 0.25, 0.25 }),
                        new ProbabilisticShort(new Short[] { 1, 3 }, new Double[] { 0.5, 0.5 }),
