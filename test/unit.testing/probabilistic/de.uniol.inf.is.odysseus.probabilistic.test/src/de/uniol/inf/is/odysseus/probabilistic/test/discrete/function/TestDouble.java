...
//        function.setArguments(new Constant<ProbabilisticDouble>(left, SDFProbabilisticDatatype.PROBABILISTIC_DOUBLE), new Constant<ProbabilisticDouble>(right,
...
//                {
//                        new ProbabilisticDouble(new Double[] { 1.0, 3.0, 5.0, 7.0 }, new Double[] { 0.25, 0.25, 0.25, 0.25 }),
//                        new ProbabilisticDouble(new Double[] { 1.0, 3.0 }, new Double[] { 0.5, 0.5 }),
