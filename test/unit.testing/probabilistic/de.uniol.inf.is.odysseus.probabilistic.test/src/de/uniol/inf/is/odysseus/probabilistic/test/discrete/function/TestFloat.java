...
//        function.setArguments(new Constant<ProbabilisticFloat>(left, SDFProbabilisticDatatype.PROBABILISTIC_FLOAT), new Constant<ProbabilisticFloat>(right,
...
//                { new ProbabilisticFloat(new Float[] { 1.0f, 3.0f, 5.0f, 7.0f }, new Double[] { 0.25, 0.25, 0.25, 0.25 }),
//                        new ProbabilisticFloat(new Float[] { 1.0f, 3.0f }, new Double[] { 0.5, 0.5 }),
