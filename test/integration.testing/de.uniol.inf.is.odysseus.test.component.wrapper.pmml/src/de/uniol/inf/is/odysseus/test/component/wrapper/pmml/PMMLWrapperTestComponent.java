package de.uniol.inf.is.odysseus.test.component.wrapper.pmml;
...
public class PMMLWrapperTestComponent extends AbstractQueryTestComponent<BasicTestContext, QueryTestSet> {

	public PMMLWrapperTestComponent() {
		super(false);
	}
