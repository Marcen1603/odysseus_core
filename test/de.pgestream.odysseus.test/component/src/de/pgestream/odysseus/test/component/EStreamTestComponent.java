package de.pgestream.odysseus.test.component;
...
public class EStreamTestComponent extends AbstractQueryTestComponent<BasicTestContext, QueryTestSet> {

	public EStreamTestComponent() {
		super(false);
	}
