...
import de.uniol.inf.is.odysseus.p2p.distribution.provider.selector.AbstractClientSelector;
...
public class StandardBiddingClientSelector extends AbstractClientSelector{

	public StandardBiddingClientSelector(int time, IExecutionListenerCallback callback) {
		super(time, callback);
	}
