...
public class AdministrationPeerJxtaImpl extends AbstractAdministrationPeer {
    ...
    protected void initQuerySpezificationListener() {
        ...
        this.biddingStrategy = new MaxQueryBiddingStrategyJxtaImpl(this, rand.nextInt(10) + 1, (rand.nextInt(10) + 1) * 10);
        querySpezificationListener = new APQuerySpezificationListenerJxtaImpl((JxtaMessageSender) getMessageSender(), this, biddingStrategy, Log.getInstance());
    ...
    protected synchronized void startNetwork() {
        ...
        CacheTool.checkForExistingConfigurationDeletion("AdministrationPeer_" + name, new File(new File(".cache"), "AdministrationPeer_" + name));
        ...
        try {
            manager = new NetworkManager(peerMode, "AdministrationPeer_" + name, new File(new File(".cache"), "AdministrationPeer_" + name).toURI());
