...
public class SourceSplit extends
...
//				temp = adv;
	...
	public void initializeService() {
		IExecutionHandler<AbstractPeer, AbstractSplittingStrategy> handler = new SourceSplitExecutionHandler<AbstractPeer, AbstractSplittingStrategy>();
