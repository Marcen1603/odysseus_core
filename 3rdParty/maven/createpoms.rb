...
"org.eclipse.swt" => "<dependency><groupId>${swt.groupId}</groupId><artifactId>${swt.artifactId}</artifactId><version>[3.5,)</version></dependency>",
"org.eclipse.swt.custom" => "<dependency><groupId>${swt.groupId}</groupId><artifactId>${swt.artifactId}</artifactId><version>[3.5,)</version></dependency>",
"org.eclipse.swt.events" => "<dependency><groupId>${swt.groupId}</groupId><artifactId>${swt.artifactId}</artifactId><version>[3.5,)</version></dependency>",
"org.eclipse.swt.graphics" => "<dependency><groupId>${swt.groupId}</groupId><artifactId>${swt.artifactId}</artifactId><version>[3.5,)</version></dependency>",
"org.eclipse.swt.layout" => "<dependency><groupId>${swt.groupId}</groupId><artifactId>${swt.artifactId}</artifactId><version>[3.5,)</version></dependency>",
"org.eclipse.swt.widgets" => "<dependency><groupId>${swt.groupId}</groupId><artifactId>${swt.artifactId}</artifactId><version>[3.5,)</version></dependency>",

"org.eclipse.equinox.app" => "<dependency><groupId>org.eclipse.equinox</groupId><artifactId>app</artifactId></dependency>",
"org.eclipse.osgi.framework.console" => "<dependency><groupId>org.eclipse</groupId><artifactId>osgi</artifactId></dependency>",
