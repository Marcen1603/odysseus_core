 ...
 *
 */
public class StartsFunction<T extends Number> extends AbstractFunction<Boolean> {

    /**
     *
     */
    private static final long serialVersionUID = -2200758593001068840L;
    ...
    public StartsFunction() {
        super("starts", 2, StartsFunction.ACC_TYPES, SDFDatatype.BOOLEAN);
    }
    ...
    public Boolean getValue() {
        ...
        return new Boolean(a.inf().doubleValue() == b.inf().doubleValue());
