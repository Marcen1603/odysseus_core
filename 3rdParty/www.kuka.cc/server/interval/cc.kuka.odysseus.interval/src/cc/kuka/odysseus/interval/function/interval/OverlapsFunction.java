 ...
 *
 */
public class OverlapsFunction<T extends Number> extends AbstractFunction<Boolean> {

    /**
     *
     */
    private static final long serialVersionUID = 2334723517516967557L;
    ...
    public OverlapsFunction() {
        super("overlaps", 2, OverlapsFunction.ACC_TYPES, SDFDatatype.BOOLEAN);
    }
    ...
    public Boolean getValue() {
        ...
        return new Boolean(((!a.isEmpty()) && (!b.isEmpty()) && (b.inf().doubleValue() <= a.sup().doubleValue()) && (a.inf().doubleValue() <= b.sup().doubleValue())));
    }
