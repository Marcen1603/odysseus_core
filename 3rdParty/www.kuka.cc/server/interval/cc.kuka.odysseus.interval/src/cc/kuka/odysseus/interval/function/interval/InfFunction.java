 ...
 *
 */
public class InfFunction<T extends Number> extends AbstractFunction<T> {
    /**
     *
     */
    private static final long serialVersionUID = 4217614995255897665L;
    public static final SDFDatatype[][] accTypes = new SDFDatatype[][] { SDFIntervalDatatype.TYPES };

    public InfFunction() {
        super("inf", 1, InfFunction.accTypes, SDFDatatype.DOUBLE);
    }
