 ...
 *
 */
public class FinishesFunction<T extends Number> extends AbstractFunction<Boolean> {

    /**
     *
     */
    private static final long serialVersionUID = -7343872444899801374L;
    ...
    public FinishesFunction() {
        super("finishes", 2, FinishesFunction.ACC_TYPES, SDFDatatype.BOOLEAN);
    }
    ...
    public Boolean getValue() {
        ...
        return new Boolean(a.sup().doubleValue() == b.sup().doubleValue());
