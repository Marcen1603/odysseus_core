 ...
 *
 */
public class IntervalPlusOperator extends AbstractBinaryOperator<Interval<Double>> {
    ...
    public IntervalPlusOperator() {
        super("+", IntervalPlusOperator.accTypes, SDFIntervalDatatype.INTERVAL_DOUBLE);
    }
    ...
    public Interval<Double> getValue() {
        ...
        return IntervalPlusOperator.getValueInternal(a, b);
    }

    protected static Interval<Double> getValueInternal(final Interval<?> a, final Interval<?> b) {
        return new Interval<>(new Double(a.inf().doubleValue() + b.inf().doubleValue()), new Double(a.sup().doubleValue() + b.sup().doubleValue()), a.isLeftOpen() && b.isLeftOpen(),
