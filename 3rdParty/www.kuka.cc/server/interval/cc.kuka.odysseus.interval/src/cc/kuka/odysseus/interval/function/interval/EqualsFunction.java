 ...
 *
 */
public class EqualsFunction<T extends Number> extends AbstractFunction<Boolean> {

    /**
     *
     */
    private static final long serialVersionUID = 1187162171497986109L;
    ...
    public EqualsFunction() {
        super("equals", 2, EqualsFunction.ACC_TYPES, SDFDatatype.BOOLEAN);
    }
