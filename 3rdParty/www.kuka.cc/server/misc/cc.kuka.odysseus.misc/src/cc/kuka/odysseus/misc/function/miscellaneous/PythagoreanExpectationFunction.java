 ...
 *
 */
public class PythagoreanExpectationFunction extends AbstractFunction<Double> {
    /**
     * 
     */
    private static final long serialVersionUID = 8751973243715976909L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public PythagoreanExpectationFunction() {
        super("PythagoreanExpectation", 2, PythagoreanExpectationFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
