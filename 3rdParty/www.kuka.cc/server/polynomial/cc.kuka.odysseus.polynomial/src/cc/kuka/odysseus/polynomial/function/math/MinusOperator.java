 ...
 *
 */
public class MinusOperator extends AbstractBinaryOperator<Polynomial> {

    /**
     *
     */
    private static final long serialVersionUID = 4999096289718072142L;
    ...
    public MinusOperator() {
        super("-", MinusOperator.accTypes, SDFPolynomialDatatype.POLYNOMIAL);
    }
