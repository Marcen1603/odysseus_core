 ...
 *
 */
public class ImaginaryFunction extends AbstractFunction<Double> {

    /**
     *
     */
    private static final long serialVersionUID = -691917194209123412L;
    public static final SDFDatatype[][] accTypes = new SDFDatatype[][] { { SDFSignalDatatype.COMPLEX } };

    /**
     *
     */
    public ImaginaryFunction() {
        super("imaginary", 1, ImaginaryFunction.accTypes, SDFDatatype.DOUBLE);
    }
    ...
    public Double getValue() {
        ...
        return Double.valueOf(a.getImaginary());
    }
