 ...
 *
 */
public class ComplexPlusOperator extends AbstractBinaryOperator<Complex> {

    /**
     *
     */
    private static final long serialVersionUID = 4106812635813268919L;
    private static final SDFDatatype[][] accTypes = new SDFDatatype[][] { { SDFSignalDatatype.COMPLEX }, { SDFSignalDatatype.COMPLEX } };

    public ComplexPlusOperator() {
        super("+", ComplexPlusOperator.accTypes, SDFSignalDatatype.COMPLEX);
    }
    ...
    public Complex getValue() {
        ...
        return ComplexPlusOperator.getValueInternal(a, b);
    }
