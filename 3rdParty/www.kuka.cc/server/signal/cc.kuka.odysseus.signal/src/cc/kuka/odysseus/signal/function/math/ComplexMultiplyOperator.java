 ...
 *
 */
public class ComplexMultiplyOperator extends AbstractBinaryOperator<Complex> {
    /**
     *
     */
    private static final long serialVersionUID = -1173223340647738674L;
    private static final SDFDatatype[][] accTypes = new SDFDatatype[][] { { SDFSignalDatatype.COMPLEX }, { SDFSignalDatatype.COMPLEX } };

    public ComplexMultiplyOperator() {
        super("*", ComplexMultiplyOperator.accTypes, SDFSignalDatatype.COMPLEX);
    }
    ...
    public Complex getValue() {
        ...
        return ComplexMultiplyOperator.getValueInternal(a, b);
    }
