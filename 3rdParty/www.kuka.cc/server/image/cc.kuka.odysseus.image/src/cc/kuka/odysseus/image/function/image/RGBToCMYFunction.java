 ...
 *
 */
public class RGBToCMYFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = -3371832957012487916L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public RGBToCMYFunction() {
        super("RGBToCMY", 3, RGBToCMYFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final CMY colorSpace = (new RGB(R, G, B)).toCMY();
