 ...
 *
 */
public class RGBToHSVFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = 6018564490544560092L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public RGBToHSVFunction() {
        super("RGBToHSV", 3, RGBToHSVFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final HSV colorSpace = (new RGB(R, G, B)).toHSV();
