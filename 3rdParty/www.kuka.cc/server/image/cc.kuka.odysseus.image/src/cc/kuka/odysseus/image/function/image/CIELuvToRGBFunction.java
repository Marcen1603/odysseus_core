...
import cc.kuka.odysseus.image.colorspace.CIELuv;
 ...
 *
 */
public class CIELuvToRGBFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = 2746860343842742833L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public CIELuvToRGBFunction() {
        super("CIELuvToRGB", 3, CIELuvToRGBFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final double u = this.getNumericalInputValue(1).doubleValue();
        final double v = this.getNumericalInputValue(2).doubleValue();

        final RGB colorSpace = (new CIELuv(L, u, v)).toRGB();
