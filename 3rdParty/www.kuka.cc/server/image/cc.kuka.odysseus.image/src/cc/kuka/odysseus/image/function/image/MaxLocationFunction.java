 ...
 *
 */
public class MaxLocationFunction extends AbstractFunction<double[]> {

    /**
     *
     */
    private static final long serialVersionUID = 6254213420219112792L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { { SDFImageDatatype.IMAGE } };

    /**
     *
     */
    public MaxLocationFunction() {
        super("maxLoc", 1, MaxLocationFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        mat.release();
        return new double[] { minMaxLoc.maxLoc.x, minMaxLoc.maxLoc.y };
    }
