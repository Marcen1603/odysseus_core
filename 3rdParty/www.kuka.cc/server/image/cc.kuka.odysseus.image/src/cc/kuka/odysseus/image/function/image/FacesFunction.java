 ...
 *
 */
public class FacesFunction extends AbstractFunction<Integer> {

    /**
     *
     */
    private static final long serialVersionUID = 2083744155865398921L;
    private static final Logger LOG = LoggerFactory.getLogger(FacesFunction.class);
     ...
     *
     */
    public FacesFunction() {
        super("faces", 1, FacesFunction.ACC_TYPES, SDFDatatype.INTEGER);
        ...
        if ((this.faceClassifier == null) || (this.faceClassifier.empty())) {
            FacesFunction.LOG.error("Unable to load face classifier: {}", FacesFunction.FACE_CASCADE_FILE);
        }
    }
    ...
    public Integer getValue() {
        ...
        return new Integer(facesArray.length);
    }
}
