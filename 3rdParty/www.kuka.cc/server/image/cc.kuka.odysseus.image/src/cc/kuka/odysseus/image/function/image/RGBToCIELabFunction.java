 ...
 *
 */
public class RGBToCIELabFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = -2445873514911693068L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public RGBToCIELabFunction() {
        super("RGBToCIELab", 3, RGBToCIELabFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final CIELab colorSpace = (new RGB(R, G, B)).toCIELab();
