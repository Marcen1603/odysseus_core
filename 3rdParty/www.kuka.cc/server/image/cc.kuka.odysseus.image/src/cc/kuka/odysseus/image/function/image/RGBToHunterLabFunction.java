...
import cc.kuka.odysseus.image.colorspace.HunterLab;
 ...
 *
 */
public class RGBToHunterLabFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = -6660574523355554039L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public RGBToHunterLabFunction() {
        super("RGBToHunterLab", 3, RGBToHunterLabFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final HunterLab colorSpace = (new RGB(R, G, B)).toHunterLab();
