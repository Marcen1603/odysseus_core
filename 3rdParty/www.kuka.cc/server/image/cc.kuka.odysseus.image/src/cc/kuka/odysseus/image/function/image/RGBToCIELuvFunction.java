 ...
 *
 */
public class RGBToCIELuvFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = -1663402029288894896L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public RGBToCIELuvFunction() {
        super("RGBToCIELuv", 3, RGBToCIELuvFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final CIELuv colorSpace = (new RGB(R, G, B)).toCIELuv();
