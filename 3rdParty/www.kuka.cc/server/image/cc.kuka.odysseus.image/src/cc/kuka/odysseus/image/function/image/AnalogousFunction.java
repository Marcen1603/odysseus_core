 ...
 *
 */
public class AnalogousFunction extends AbstractFunction<double[][]> {

    /**
     *
     */
    private static final long serialVersionUID = 4483890684525952911L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public AnalogousFunction() {
        super("Analogous", 3, AnalogousFunction.ACC_TYPES, SDFDatatype.MATRIX_DOUBLE);
    }
    ...
    public double[][] getValue() {
        ...
        final RGB[] colorSpaces = (new RGB(R, G, B)).getAnalogous();
