 ...
 *
 */
public class MaxFunction extends AbstractFunction<Double> {

    /**
     *
     */
    private static final long serialVersionUID = 1664489006512327396L;
     ...
     */
    public MaxFunction() {
        super("max", 1, MaxFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
    ...
    public Double getValue() {
        ...
        mat.release();
        return new Double(minMaxLoc.maxVal);
    }
