 ...
 *
 */
public class SplitComplementsFunction extends AbstractFunction<double[][]> {

    /**
     *
     */
    private static final long serialVersionUID = 6159549960576238558L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public SplitComplementsFunction() {
        super("SplitComplements", 3, SplitComplementsFunction.ACC_TYPES, SDFDatatype.MATRIX_DOUBLE);
    }
    ...
    public double[][] getValue() {
        ...
        final RGB[] colorSpaces = (new RGB(R, G, B)).getSplitComplements();
