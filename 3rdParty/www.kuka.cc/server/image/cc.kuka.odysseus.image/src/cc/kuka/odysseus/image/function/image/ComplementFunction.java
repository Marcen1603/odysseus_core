 ...
 *
 */
public class ComplementFunction extends AbstractFunction<double[]> {

    /**
     *
     */
    private static final long serialVersionUID = -96989389515630493L;
    ...
    public ComplementFunction() {
        super("Complement", 3, ComplementFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        return (new RGB(R, G, B)).getComplement().toArray();
