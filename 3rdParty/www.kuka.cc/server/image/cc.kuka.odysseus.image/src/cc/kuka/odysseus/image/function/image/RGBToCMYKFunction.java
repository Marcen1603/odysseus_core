 ...
 *
 */
public class RGBToCMYKFunction extends AbstractFunction<double[]> {
    /**
     *
     */
     ...
     *
     */
    public RGBToCMYKFunction() {
        super("RGBToCMYK", 3, RGBToCMYKFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final CMYK colorSpace = (new RGB(R, G, B)).toCMYK();
