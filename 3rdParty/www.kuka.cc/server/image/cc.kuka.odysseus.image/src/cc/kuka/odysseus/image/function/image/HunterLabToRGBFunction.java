 ...
 *
 */
public class HunterLabToRGBFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = 6639591492968763172L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public HunterLabToRGBFunction() {
        super("HunterLabToRGB", 3, HunterLabToRGBFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final RGB colorSpace = (new HunterLab(L, a, b)).toRGB();
