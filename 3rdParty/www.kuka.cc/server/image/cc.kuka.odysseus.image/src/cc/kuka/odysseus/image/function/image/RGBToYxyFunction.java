 ...
 *
 */
public class RGBToYxyFunction extends AbstractFunction<double[]> {
    /**
     *
     */
    private static final long serialVersionUID = -2762276206504014498L;
    private static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    /**
     *
     */
    public RGBToYxyFunction() {
        super("RGBToYxy", 3, RGBToYxyFunction.ACC_TYPES, SDFDatatype.VECTOR_DOUBLE);
    }
    ...
    public double[] getValue() {
        ...
        final Yxy colorSpace = (new RGB(R, G, B)).toYxy();
