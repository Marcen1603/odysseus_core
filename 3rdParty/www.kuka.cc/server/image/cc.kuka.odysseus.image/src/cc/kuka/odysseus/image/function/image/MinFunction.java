 ...
 *
 */
public class MinFunction extends AbstractFunction<Double> {

    /**
     *
     */
    private static final long serialVersionUID = -6069573219501169929L;
     ...
     */
    public MinFunction() {
        super("min", 1, MinFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
    ...
    public Double getValue() {
        ...
        mat.release();
        return new Double(minMaxLoc.minVal);
    }
