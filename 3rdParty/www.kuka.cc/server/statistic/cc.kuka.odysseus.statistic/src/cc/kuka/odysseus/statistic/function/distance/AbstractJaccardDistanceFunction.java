 ...
 *
 */
public abstract class AbstractJaccardDistanceFunction extends AbstractFunction<Double> {
    ...
    public AbstractJaccardDistanceFunction(final SDFDatatype[][] accTypes) {
        super("JaccardDistance", 2, accTypes, SDFDatatype.DOUBLE);
    }
    ...
    protected final static Double getValueInternal(final RealMatrix a, final RealMatrix b) {
        return Double.valueOf(a.walkInOptimizedOrder(new RealMatrixPreservingVisitor() {
            ...
            public void visit(final int row, final int column, final double value) {
                if (value == b.getEntry(row, column)) {
                    this.distance++;
                }
            }
            ...
            @Override
            public double end() {
                return this.distance / a.getRowDimension();
            }
        }));
    }
