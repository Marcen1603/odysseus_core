 ...
 *
 */
public class MinkowskiDistanceFunctionVector extends AbstractMinkowskiDistanceFunction {

    /**
     *
     */
    private static final long serialVersionUID = -5292172954256211602L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.VECTORS, SDFDatatype.VECTORS, SDFDatatype.NUMBERS };

    public MinkowskiDistanceFunctionVector() {
        super(MinkowskiDistanceFunctionVector.ACC_TYPES);
    }
