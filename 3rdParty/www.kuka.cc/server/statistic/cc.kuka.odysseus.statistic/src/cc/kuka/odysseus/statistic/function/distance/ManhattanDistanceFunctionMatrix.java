 ...
 *
 */
public class ManhattanDistanceFunctionMatrix extends AbstractManhattanDistanceFunction {

    /**
     *
     */
    private static final long serialVersionUID = -436476186435081809L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.MATRIXS, SDFDatatype.MATRIXS };

    public ManhattanDistanceFunctionMatrix() {
        super(ManhattanDistanceFunctionMatrix.ACC_TYPES);
    }
