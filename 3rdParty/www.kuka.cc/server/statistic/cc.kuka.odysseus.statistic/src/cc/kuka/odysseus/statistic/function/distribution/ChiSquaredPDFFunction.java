 ...
 *
 */
public class ChiSquaredPDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = 80532525937471170L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public ChiSquaredPDFFunction() {
        super("chi2pdf", 2, ChiSquaredPDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
