 ...
 *
 */
public class LogNormalCDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = -5061010896829020991L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public LogNormalCDFFunction() {
        super("logncdf", 3, LogNormalCDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
