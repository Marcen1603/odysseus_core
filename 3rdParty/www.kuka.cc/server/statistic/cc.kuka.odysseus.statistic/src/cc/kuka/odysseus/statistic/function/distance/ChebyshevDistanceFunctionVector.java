 ...
 *
 */
public class ChebyshevDistanceFunctionVector extends AbstractChebyshevDistanceFunction {

    /**
     *
     */
    private static final long serialVersionUID = 3175848094963346383L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.VECTORS, SDFDatatype.VECTORS };

    public ChebyshevDistanceFunctionVector() {
        super(ChebyshevDistanceFunctionVector.ACC_TYPES);
    }
