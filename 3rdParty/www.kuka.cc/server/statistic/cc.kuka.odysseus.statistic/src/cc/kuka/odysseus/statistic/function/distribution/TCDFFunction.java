 ...
 *
 */
public class TCDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = 66889401755957092L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public TCDFFunction() {
        super("tcdf", 2, TCDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
