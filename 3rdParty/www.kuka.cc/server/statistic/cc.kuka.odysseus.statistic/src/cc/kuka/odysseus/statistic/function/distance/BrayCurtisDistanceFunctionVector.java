 ...
 *
 */
public class BrayCurtisDistanceFunctionVector extends AbstractBrayCurtisDistanceFunction {

    /**
     *
     */
    private static final long serialVersionUID = -4852153272894622760L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.VECTORS, SDFDatatype.VECTORS };

    public BrayCurtisDistanceFunctionVector() {
        super(BrayCurtisDistanceFunctionVector.ACC_TYPES);
    }
