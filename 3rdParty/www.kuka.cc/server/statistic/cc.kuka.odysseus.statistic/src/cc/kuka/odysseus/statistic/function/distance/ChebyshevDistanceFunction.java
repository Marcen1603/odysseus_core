 ...
 *
 */
public class ChebyshevDistanceFunction extends AbstractChebyshevDistanceFunction {
    /**
     *
     */
    private static final long serialVersionUID = 8098381071912458335L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public ChebyshevDistanceFunction() {
        super(ChebyshevDistanceFunction.ACC_TYPES);
    }
