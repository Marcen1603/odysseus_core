 ...
 *
 */
public class NormalCDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = -8692170769996837210L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public NormalCDFFunction() {
        super("normcdf", 3, NormalCDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
