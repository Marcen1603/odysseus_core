 ...
 *
 */
public class TPDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = -4736161019228465956L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public TPDFFunction() {
        super("tpdf", 2, TPDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
