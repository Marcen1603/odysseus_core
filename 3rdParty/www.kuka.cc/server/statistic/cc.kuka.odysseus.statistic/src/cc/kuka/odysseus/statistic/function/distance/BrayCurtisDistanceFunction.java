 ...
 *
 */
public class BrayCurtisDistanceFunction extends AbstractBrayCurtisDistanceFunction {
    /**
     *
     */
    private static final long serialVersionUID = -1646427515591819232L;
    /**
     * Accepted data types.
     */
    ...
    public BrayCurtisDistanceFunction() {
        super(BrayCurtisDistanceFunction.ACC_TYPES);
    }
