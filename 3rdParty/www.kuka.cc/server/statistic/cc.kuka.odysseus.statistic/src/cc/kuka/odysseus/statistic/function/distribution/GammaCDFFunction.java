 ...
 *
 */
public class GammaCDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = -3520627525895260521L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public GammaCDFFunction() {
        super("gamcdf", 3, GammaCDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
