 ...
 *
 */
public class BetaPDFFunction extends AbstractFunction<Double> {

    /**
     *
     */
    private static final long serialVersionUID = 560618367521190104L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public BetaPDFFunction() {
        super("betapdf", 3, BetaPDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
