 ...
 *
 */
public class PoissonPDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = 456300464211625837L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public PoissonPDFFunction() {
        super("poisspdf", 2, PoissonPDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
