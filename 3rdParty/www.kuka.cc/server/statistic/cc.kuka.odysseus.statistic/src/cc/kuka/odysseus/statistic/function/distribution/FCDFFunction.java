 ...
 *
 */
public class FCDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = 5433700962692257357L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public FCDFFunction() {
        super("fcdf", 3, FCDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
