 ...
 *
 */
public abstract class AbstractHammingDistanceFunction extends AbstractFunction<Integer> {
    ...
    public AbstractHammingDistanceFunction(final SDFDatatype[][] accTypes) {
        super("HammingDistance", 2, accTypes, SDFDatatype.INTEGER);
    }
