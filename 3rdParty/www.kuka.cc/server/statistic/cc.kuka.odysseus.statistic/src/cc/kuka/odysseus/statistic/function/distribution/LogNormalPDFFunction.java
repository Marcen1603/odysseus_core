 ...
 *
 */
public class LogNormalPDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = 4362425224565322576L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public LogNormalPDFFunction() {
        super("lognpdf", 3, LogNormalPDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
    ...
    public Double getValue() {
        ...
        final LogNormalDistribution distribution = new LogNormalDistribution(scale, shape);
