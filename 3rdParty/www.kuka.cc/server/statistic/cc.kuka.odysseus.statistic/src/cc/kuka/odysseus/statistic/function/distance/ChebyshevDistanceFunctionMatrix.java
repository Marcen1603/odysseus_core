 ...
 *
 */
public class ChebyshevDistanceFunctionMatrix extends AbstractChebyshevDistanceFunction {

    /**
     *
     */
    private static final long serialVersionUID = -2798460132136548310L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.MATRIXS, SDFDatatype.MATRIXS };

    public ChebyshevDistanceFunctionMatrix() {
        super(ChebyshevDistanceFunctionMatrix.ACC_TYPES);
    }
    ...
    public final Double getValue() {
        ...
        return AbstractChebyshevDistanceFunction.getValueInternal(a, b);
    }
}
