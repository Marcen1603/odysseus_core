 ...
 *
 */
public abstract class AbstractChebyshevDistanceFunction extends AbstractFunction<Double> {

    /**
     *
     */
    private static final long serialVersionUID = -1615896806582650107L;

    public AbstractChebyshevDistanceFunction(final SDFDatatype[][] accTypes) {
        super("ChebyshevDistance", 2, accTypes, SDFDatatype.DOUBLE);
    }
    ...
    protected final static Double getValueInternal(final RealMatrix a, final RealMatrix b) {
        return Double.valueOf(a.walkInOptimizedOrder(new RealMatrixPreservingVisitor() {
            ...
            public void visit(final int row, final int column, final double value) {
                final double distance = Math.abs(value - b.getEntry(row, column));
