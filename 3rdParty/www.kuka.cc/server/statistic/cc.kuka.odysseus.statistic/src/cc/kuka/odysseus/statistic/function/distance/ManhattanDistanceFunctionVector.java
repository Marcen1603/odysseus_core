 ...
 *
 */
public class ManhattanDistanceFunctionVector extends AbstractManhattanDistanceFunction {

    /**
     *
     */
    private static final long serialVersionUID = -4535833105673464402L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.VECTORS, SDFDatatype.VECTORS };

    public ManhattanDistanceFunctionVector() {
        super(ManhattanDistanceFunctionVector.ACC_TYPES);
    }
    ...
    public final Double getValue() {
        ...
        return AbstractManhattanDistanceFunction.getValueInternal(a, b);
    }
}
