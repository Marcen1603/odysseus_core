 ...
 *
 */
public class WeibullCDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = 5823299631963563847L;
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.NUMBERS, SDFDatatype.NUMBERS, SDFDatatype.NUMBERS };

    public WeibullCDFFunction() {
        super("wblcdf", 3, WeibullCDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
