 ...
 *
 */
public class HypergeometricCDFFunction extends AbstractFunction<Double> {
    /**
     *
     */
    private static final long serialVersionUID = -4073339452416511106L;
    ...
    public HypergeometricCDFFunction() {
        super("hygecdf", 4, HypergeometricCDFFunction.ACC_TYPES, SDFDatatype.DOUBLE);
    }
