 ...
 *
 */
public class JaccardDistanceFunctionMatrix extends AbstractJaccardDistanceFunction {

    /**
     *
     */
    private static final long serialVersionUID = 3842263880078924562L;
    /**
     * Accepted data types.
     */
    public static final SDFDatatype[][] ACC_TYPES = new SDFDatatype[][] { SDFDatatype.MATRIXS, SDFDatatype.MATRIXS };

    public JaccardDistanceFunctionMatrix() {
        super(JaccardDistanceFunctionMatrix.ACC_TYPES);
    }
