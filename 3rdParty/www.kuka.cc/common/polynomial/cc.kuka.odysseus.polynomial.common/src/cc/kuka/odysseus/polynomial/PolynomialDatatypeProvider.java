 ...
 *
 */
public class PolynomialDatatypeProvider implements IDatatypeProvider {
    /**
     *
     * {@inheritDoc}
     */
    ...
    public List<SDFDatatype> getDatatypes() {
        ...
        ret.add(SDFPolynomialDatatype.POLYNOMIAL);
        ret.add(SDFPolynomialDatatype.POLYNOMIALREGRESSION_PARTIAL_AGGREGATE);
