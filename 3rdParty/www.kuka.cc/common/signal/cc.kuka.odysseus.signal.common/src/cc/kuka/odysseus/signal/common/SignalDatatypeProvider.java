 ...
 *******************************************************************************/
package cc.kuka.odysseus.signal.common;
 ...
 *
 */
public class SignalDatatypeProvider implements IDatatypeProvider {
    /**
     *
     * {@inheritDoc}
     */
    ...
    public List<SDFDatatype> getDatatypes() {
        ...
        for (final SDFDatatype dt : SDFSignalDatatype.types) {
            ret.add(dt);
        }
        return ret;
    }
