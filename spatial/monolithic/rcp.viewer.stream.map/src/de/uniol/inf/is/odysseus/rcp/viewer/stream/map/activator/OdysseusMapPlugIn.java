...
public class OdysseusMapPlugIn extends AbstractUIPlugin {
	...
	private static OwnProperties props;
	
	@Override
	public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		LayerTypeRegistry.register(new VectorLayer(new VectorLayerConfiguration()));
	}
	...
	public static OwnProperties getProperties() {
		if (props == null)
			props = new OwnProperties();
		return props;
	}
