...
public class SpatialIsPolygon extends AbstractFunction<Boolean> {

	private static final long serialVersionUID = 6184485303204708634L;

	public SpatialIsPolygon() {
		super("SpatialIsPolygon", 1, accTypes, SDFDatatype.BOOLEAN);
	}
	...
	public Boolean getValue() {
		return ((Geometry) this.getInputValue(0)).getGeometryType()
				.equalsIgnoreCase("Polygon")
				&& !((Geometry) this.getInputValue(0)).isEmpty();
	}
}
