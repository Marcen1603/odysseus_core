...
public class TraceColorListener extends SelectionAdapter {
	...
	AbstractMapPropertiesDialog mapPropertiesDialog;
	Label correspondingLabel;
	int id;

	public TraceColorListener(TracemapLayerConfiguration tracemapLayerConfiguration, int id,
			AbstractMapPropertiesDialog mapPropertiesDialog, Label correspondingLabel) {
	...
	public void widgetSelected(SelectionEvent e) {
		...
		cd.setRGB(new RGB(tracemapLayerConfiguration.getColorForId(id).getRed(),
