 ...
 * 
 * Function to return centroid of spatial data types. 
 */
public class GetCentroid extends AbstractFunction<Point> {
	...
	public Point getValue() {
		return ((Geometry) this.getInputValue(0)).getCentroid();
	}
