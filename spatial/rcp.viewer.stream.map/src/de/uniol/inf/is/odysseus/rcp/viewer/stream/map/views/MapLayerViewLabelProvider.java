 ...
 * 
 */
public class MapLayerViewLabelProvider implements ILabelProvider {

	Map<SDFAttribute, Image> images = null;

	public MapLayerViewLabelProvider() {
	...
	public Image getImage(Object element) {
		...
		if (element instanceof RasterLayer) {
			if (((RasterLayer) element).getStyle() != null) {
				return ((RasterLayer) element).getStyle().getImage();
			}
		}
