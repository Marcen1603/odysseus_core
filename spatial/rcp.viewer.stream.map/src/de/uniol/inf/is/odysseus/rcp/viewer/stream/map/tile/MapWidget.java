...
public class MapWidget extends Canvas {
    ...
    public static final class TileServer {
        ...
        public TileServer(String url, int maxZoom, int format) {
            this.url = url;
    ...
    public static final TileServer[] TILESERVERS = {
        new TileServer("http://tile.openstreetmap.org/", 18, 0),
        new TileServer("http://tah.openstreetmap.org/Tiles/tile/", 17, 0),
    	new TileServer("http://oatile2.mqcdn.com/tiles/1.0.0/sat/",17, 0),
        new TileServer("http://otile2.mqcdn.com/tiles/1.0.0/osm/",18, 0),
        new TileServer("http://tile.opencyclemap.org/cycle/",18, 0),
        new TileServer("http://tile2.opencyclemap.org/transport/",18, 0),
        new TileServer("http://tile.cloudmade.com/0636cabea78640328462d9d26e2a97e2/1/256/",18, 0),
        new TileServer("http://tile.cloudmade.com/0636cabea78640328462d9d26e2a97e2/2/256/",18, 0),
        new TileServer("http://tile.cloudmade.com/0636cabea78640328462d9d26e2a97e2/3/256/",18, 0),
        new TileServer("http://otile1.mqcdn.com/tiles/1.0.0/osm/",18, 0),
        new TileServer("http://oatile1.mqcdn.com/naip/",12, 0),
        new TileServer("http://oatile1.mqcdn.com/naip/",18, 0),
    };
 
    /*
     * 
     * http://mt1.google.com/vt/lyrs=m@110&hl=pl&x=0&y=0&z=2
     * 
     ...
     * 
     * http://[abc].tile.cloudmade.com/your_CloudMade_API_key/1/256/zoom/x/y.png
     * 
     * http://[abc].tile.cloudmade.com/your_CloudMade_API_key/2/256/zoom/x/y.png
     * 
     * http://[abc].tile.cloudmade.com/your_CloudMade_API_key/2/256/zoom/x/y.png
     *
     * http://otile[1234].mqcdn.com/tiles/1.0.0/osm/zoom/x/y.jpg
     * 
     * http://oatile[1234].mqcdn.com/naip/zoom/x/y.jpg
     * 
    ...
    public double position2lon(int x, int z) {
        double xmax = TILE_SIZE * (1 << z);
        return x / xmax * 360.0 - 180;
    }

    public double position2lat(int y, int z) {
