...
public class ObjectFieldImpl implements FieldValue, Externalizable {
	...
	public void readExternal(ObjectInput in) throws IOException,
		...
		if (in instanceof DroolsObjectInputStream) {
			classLoader = ((DroolsObjectInputStream) in).getClassLoader();
		}
		if (!isEnum || enumName == null || fieldName == null) {
			value = (Serializable) in.readObject();
		} else {
			resolveEnumValue(classLoader);
		}
	...
	private void resolveEnumValue(ClassLoader classLoader) {
		try {
			final Class<?> staticClass = classLoader == null ? Class
					.forName(enumName) : classLoader.loadClass(enumName);
	...
	public boolean getBooleanValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to boolean not supported for type: "
						+ this.value.getClass());
	}
	...
	public byte getByteValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to byte not supported for type: "
						+ this.value.getClass());
	}
	...
	public char getCharValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to char not supported for type: "
						+ this.value.getClass());
	}
	...
	public double getDoubleValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to double not supported for type: "
						+ this.value.getClass());
	}
	...
	public float getFloatValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to float not supported for type: "
						+ this.value.getClass());
	}
	...
	public int getIntValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to int not supported for type: "
						+ this.value.getClass());
	}
	...
	public long getLongValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to long not supported for type: "
						+ this.value.getClass());
	}
	...
	public short getShortValue() {
		...
		throw new RuntimeDroolsException(
				"Conversion to short not supported for type: "
						+ this.value.getClass());
	}
	...
	public boolean equals(final Object object) {
		...
		return (((this.value == null) && (other.value == null)) || ((this.value != null) && (this.value
				.equals(other.value))));
	}
