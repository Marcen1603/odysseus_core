...
public class TFilterCovarianceAORule extends AbstractTransformationRule<FilterCovarianceUpdateAO>{
	...
	@Override
	public void execute(FilterCovarianceUpdateAO operator,
			TransformationConfiguration config) {
		
		System.out.print("CREATE Filter Covariance PO...");

		FilterCovarianceUpdatePO filterCovarianceUpdatePO = new FilterCovarianceUpdatePO();
		...
		if (operator.getFunctionID().equals("KALMAN"))
			{
				...
				filterCovarianceUpdatePO.setMetaDataUpdateFunction(new KalmanCorrectStateCovarianceFunction());
			}
		...
		System.out.println("CREATE Filter Covariance PO finished.");
		
	}

	@Override
	public boolean isExecutable(FilterCovarianceUpdateAO operator,
			TransformationConfiguration config) {
...
//		$filterCovarianceUpdateAO : FilterCovarianceUpdateAO( allPhysicalInputSet == true )
	}

	@Override
	public String getName() {
		// TODO Auto-generated method stub
		return "FilterCovarianceUpdateAO -> FilterCovarianceUpdatePO";
	}
