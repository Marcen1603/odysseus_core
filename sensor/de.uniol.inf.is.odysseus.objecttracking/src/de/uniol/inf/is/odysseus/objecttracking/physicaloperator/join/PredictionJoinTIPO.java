...
public class PredictionJoinTIPO<K extends ITimeInterval & IProbability & IPredictionFunction, T extends MVRelationalTuple<K>>
	...
	private RelationalJoinTIMVPredictionSweepArea<K, T>[] areas;
	...
	public PredictionJoinTIPO(IDataMergeFunction<T> dataMerge,
			...
			ITransferFunction<T> transferFunction, RelationalJoinTIMVPredictionSweepArea<K, T>[] areas) {
	...
	public void setAreas(RelationalJoinTIMVPredictionSweepArea<K, T> leftArea, RelationalJoinTIMVPredictionSweepArea<K, T> rightArea){
...
//		}
	...
	protected void process_done() {
		...
		System.out.println("Join SA Duration: " + RelationalJoinTIMVPredictionSweepArea.duration);
		System.out.println("Join SA Duration normal: " + RelationalJoinTIMVPredictionSweepArea.durationNormal);
		System.out.println("Join SA Duration prediction: " + RelationalJoinTIMVPredictionSweepArea.durationPrediction);
		System.out.println("Join SA Duration prediction predicate: "+RelationalJoinTIMVPredictionSweepArea.durationPredictionPredicate);
		...
		System.out.println("Query Aufrufe SA: " + RelationalJoinTIMVPredictionSweepArea.counter);
