...
public class RelationalJoinTIMVPredictionSweepArea<M extends IPredictionFunction & ITimeInterval & IProbability, T extends MVRelationalTuple<M>> extends JoinTISweepArea<T>{
	...
	public static long durationNormal;
	public static long durationPrediction;
	public static long durationPredictionPredicate;
	public static long duration;
	
	public static long counter;
	public static long compareCounter;
	
	public RelationalJoinTIMVPredictionSweepArea(SDFAttributeList leftSchema, SDFAttributeList rightSchema){
		super();
