...
import de.uniol.inf.is.odysseus.broker.evaluation.physicaloperator.predicate.BrokerQueryPredicate;
import de.uniol.inf.is.odysseus.broker.evaluation.physicaloperator.predicate.BrokerRemovePredicate;
import de.uniol.inf.is.odysseus.broker.evaluation.transaction.CycleSubscription;
...
public class BrokerPO<T extends IMetaAttributeContainer<ITimeInterval>> extends AbstractPipe<T, T> {
	...
	/** The SweepArea. */
	private volatile BrokerSweepArea<T> sweepArea = new BrokerSweepArea<T>();
