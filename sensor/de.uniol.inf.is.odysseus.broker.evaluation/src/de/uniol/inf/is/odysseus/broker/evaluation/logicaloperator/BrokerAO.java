...
public class BrokerAO extends AbstractLogicalOperator{
	...
	protected BrokerAO(BrokerAO original){
		...
		this.inPort = original.inPort;
		this.outPort = original.outPort;
		this.queuePort = original.queuePort;
...
//	}
	...
	public String toString(){
		return super.toString()+" ("+this.identifier+") ["+this.inPort+"->"+this.outPort+"]";
	}	
