...
public class ProceduralExpressionParser/*@bgen(jjtree)*/implements ProceduralExpressionParserTreeConstants, ProceduralExpressionParserConstants {/*@bgen(jjtree)*/
  ...
  jjtree.openNodeScope(jjtn000);
      try {
        ...
        while (true) {
          ...
          case K_EVALUATE:
          case K_FILTER_GAIN:
          case K_FILTER_ESTIMATE:
          case K_FILTER_COVARIANCE:
          case K_BROKER_INIT:
          case K_TMP_DATA_BOUNCER:
          case K_JDVE_SINK:
          case K_SCARS_XML_PROFILER:
          case K_DISTANCE_OBJECT_SELECTOR:
          case K_DISTANCE_OBJECT_SELECTOR_ANDRE:
          case K_ASSOCIATION_EXP_EVAL:
          case K_ASSOCIATION_EXP_GATE:
          case K_FILTER_EXP_GATE:
          case K_FILTER_EXP_EXTIMATE:
          case K_FILTER_EXP_COVARIANCE:
            ;
            break;
          default:
            jj_la1[2] = jj_gen;
 ...
 /*@bgen(jjtree) TestOp */
  ...
  static final public void ExistOp() throws ParseException {
    trace_call("ExistOp");
    try {
 /*@bgen(jjtree) ExistOp */
  ...
  jjtree.openNodeScope(jjtn000);
      try {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case K_EXIST:
          jj_consume_token(K_EXIST);
      jjtn000.setType("exist");
          break;
        case K_NOT_EXIST:
          jj_consume_token(K_NOT_EXIST);
      jjtn000.setType("not exist");
          break;
        default:
          jj_la1[4] = jj_gen;
          jj_consume_token(-1);
 ...
 /*@bgen(jjtree) BenchmarkOp */
  ...
  static final public void BenchmarkOpExt() throws ParseException {
    trace_call("BenchmarkOpExt");
    try {
 /*@bgen(jjtree) BenchmarkOpExt */
  ASTBenchmarkOpExt jjtn000 = new ASTBenchmarkOpExt(JJTBENCHMARKOPEXT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_BENCHMARK_EXT);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Number();
    ...
    if (jjtc000) {
      ...
      trace_return("BenchmarkOpExt");
    }
  }

  static final public void BufferOp() throws ParseException {
    trace_call("BufferOp");
    try {
 /*@bgen(jjtree) BufferOp */
  ASTBufferOp jjtn000 = new ASTBufferOp(JJTBUFFEROP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_BUFFER);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("BufferOp");
    }
  }

  static final public void PunctuationOp() throws ParseException {
    trace_call("PunctuationOp");
    try {
 /*@bgen(jjtree) PunctuationOp */
  ASTPunctuationOp jjtn000 = new ASTPunctuationOp(JJTPUNCTUATIONOP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_PUNCTUATION);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Number();
...
/*void TumblingWindow(): {}{
 ...
 /*@bgen(jjtree) SelectionOp */
  ...
  static final public void BrokerInitOp() throws ParseException {
    trace_call("BrokerInitOp");
    try {
 /*@bgen(jjtree) BrokerInitOp */
  ...
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_BROKER_INIT);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Number();
...
}
{
 ...
 /*@bgen(jjtree) EvaluateOp */
  ...
  static final public void TmpDataBouncerOp() throws ParseException {
    trace_call("TmpDataBouncerOp");
    try {
 /*@bgen(jjtree) TmpDataBouncerOp */
  ASTTmpDataBouncerOp jjtn000 = new ASTTmpDataBouncerOp(JJTTMPDATABOUNCEROP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_TMP_DATA_BOUNCER);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("TmpDataBouncerOp");
    }
  }

  static final public void FilterGainOp() throws ParseException {
    trace_call("FilterGainOp");
    try {
 /*@bgen(jjtree) FilterGainOp */
  ...
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_FILTER_GAIN);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("FilterGainOp");
    }
  }

  static final public void FilterEstimateOp() throws ParseException {
    trace_call("FilterEstimateOp");
    try {
 /*@bgen(jjtree) FilterEstimateOp */
  ...
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_FILTER_ESTIMATE);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("FilterEstimateOp");
    }
  }

  static final public void FilterCovarianceOp() throws ParseException {
    trace_call("FilterCovarianceOp");
    try {
 /*@bgen(jjtree) FilterCovarianceOp */
  ...
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_FILTER_COVARIANCE);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("FilterCovarianceOp");
    }
  }

  static final public void JDVESinkOp() throws ParseException {
    trace_call("JDVESinkOp");
    try {
 /*@bgen(jjtree) JDVESinkOp */
  ASTJDVESinkOp jjtn000 = new ASTJDVESinkOp(JJTJDVESINKOP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_JDVE_SINK);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Host();
    ...
    if (jjtc000) {
      ...
      trace_return("JDVESinkOp");
    }
  }

  static final public void ScarsXMLProfilerOp() throws ParseException {
    trace_call("ScarsXMLProfilerOp");
    try {
 /*@bgen(jjtree) ScarsXMLProfilerOp */
  ASTScarsXMLProfilerOp jjtn000 = new ASTScarsXMLProfilerOp(JJTSCARSXMLPROFILEROP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_SCARS_XML_PROFILER);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("ScarsXMLProfilerOp");
    }
  }

  static final public void DistanceObjectSelectorOp() throws ParseException {
    trace_call("DistanceObjectSelectorOp");
    try {
 /*@bgen(jjtree) DistanceObjectSelectorOp */
  ASTDistanceObjectSelectorOp jjtn000 = new ASTDistanceObjectSelectorOp(JJTDISTANCEOBJECTSELECTOROP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_DISTANCE_OBJECT_SELECTOR);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("DistanceObjectSelectorOp");
    }
  }

  static final public void DistanceObjectSelectorOp_Andre() throws ParseException {
    trace_call("DistanceObjectSelectorOp_Andre");
    try {
 /*@bgen(jjtree) DistanceObjectSelectorOp_Andre */
  ASTDistanceObjectSelectorOp_Andre jjtn000 = new ASTDistanceObjectSelectorOp_Andre(JJTDISTANCEOBJECTSELECTOROP_ANDRE);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_DISTANCE_OBJECT_SELECTOR_ANDRE);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("DistanceObjectSelectorOp_Andre");
    }
  }

  static final public void AssociationExpressionEvalOp() throws ParseException {
    trace_call("AssociationExpressionEvalOp");
    try {
 /*@bgen(jjtree) AssociationExpressionEvalOp */
  ASTAssociationExpressionEvalOp jjtn000 = new ASTAssociationExpressionEvalOp(JJTASSOCIATIONEXPRESSIONEVALOP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_ASSOCIATION_EXP_EVAL);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("AssociationExpressionEvalOp");
    }
  }

  static final public void AssociationExpressionGateOp() throws ParseException {
    trace_call("AssociationExpressionGateOp");
    try {
 /*@bgen(jjtree) AssociationExpressionGateOp */
  ASTAssociationExpressionGateOp jjtn000 = new ASTAssociationExpressionGateOp(JJTASSOCIATIONEXPRESSIONGATEOP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_ASSOCIATION_EXP_GATE);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("AssociationExpressionGateOp");
    }
  }

  static final public void FilterExpGainOp() throws ParseException {
    trace_call("FilterExpGainOp");
    try {
 /*@bgen(jjtree) FilterExpGainOp */
  ASTFilterExpGainOp jjtn000 = new ASTFilterExpGainOp(JJTFILTEREXPGAINOP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_FILTER_EXP_GATE);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("FilterExpGainOp");
    }
  }

  static final public void FilterExpEstimateOp() throws ParseException {
    trace_call("FilterExpEstimateOp");
    try {
 /*@bgen(jjtree) FilterExpEstimateOp */
  ASTFilterExpEstimateOp jjtn000 = new ASTFilterExpEstimateOp(JJTFILTEREXPESTIMATEOP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_FILTER_EXP_EXTIMATE);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("FilterExpEstimateOp");
    }
  }

  static final public void FilterExpCovarianceOp() throws ParseException {
    trace_call("FilterExpCovarianceOp");
    try {
 /*@bgen(jjtree) FilterExpCovarianceOp */
  ASTFilterExpCovarianceOp jjtn000 = new ASTFilterExpCovarianceOp(JJTFILTEREXPCOVARIANCEOP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
      try {
        jj_consume_token(K_FILTER_EXP_COVARIANCE);
        jj_consume_token(78);
        AlgebraOp();
        jj_consume_token(79);
        Identifier();
    ...
    if (jjtc000) {
      ...
      trace_return("FilterExpCovarianceOp");
    }
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0xdc047e20,0xdc047e20,0x6000,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x10000,0x0,0x10000,0x400000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0xffffe27f,0xffffe27f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x80802,0x2000,0x1,0x1,0x0,0x80002,0x80002,0x8000,0x80002,0x8000,0x0,0x8000,0x80002,0x0,0x80002,0x0,0x84312,0x84312,0x310,0x84002,0x300,0x3e0000,0x80000,0x80002,0x80002,0x80002,0x80302,0x8000,0x8000,0x8000,};
   }
