 ...
 * @param <T>
 */
public class UpdateRateSinkRateConformance<T extends IStreamObject<?>> extends AbstractSLaConformance<T> {
	/**
...
//	private T prevObj;
	 ...
	 */
	private UpdateRateSinkRateConformance(UpdateRateSinkRateConformance<T> conformance) {
		super(conformance);
