...
public class ModelParameterEstimationTesting {
	...
	public static void main(String[] args) {
		...
		LengthTuneableLine line4 = new LengthTuneableLine();
		LengthTuneableLine line5 = new LengthTuneableLine();
		LengthTuneableLine line6 = new LengthTuneableLine();
		LengthTuneableLine line7 = new LengthTuneableLine();
		LengthTuneableLine line8 = new LengthTuneableLine();
		
		LengthTuneableLine[] lines = new LengthTuneableLine[8];
		lines[0] = line1;
		lines[1] = line2;
		lines[2] = line3;
		lines[3] = line4;
...
//		inputs.addConnector(new PhaseToEarthVoltage(network,bus9,FourWireNetwork.phaseN,0.0), stdVV);
		...
		double phaseInsymmetry = 0.5;//5;//1.5;//2.5;//1;
...
//				modelEstimationInputs.addConnector(new AbsoluteNodalPhaseCurrent(network, buses[i], FourWireNetwork.phaseN, 0), stdVI);					
		...
		double startLength = 500;
		
		line1.length = startLength;
		line2.length = startLength;
		line3.length = startLength;
		line4.length = startLength;
		line5.length = startLength;
		line6.length = startLength;
		line7.length = startLength;
		line8.length = startLength;

		
		modelEstimator.tuneModel(network, tuneables, modelEstimationInputs, timeSeries, 10000);
