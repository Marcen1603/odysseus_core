...
public class SinglePhaseActivePower extends NodeConnector {
	...
	public SinglePhaseActivePower(FourWireNetwork network, Node myNode,
	...
	public SinglePhaseActivePower(String uId, FourWireNetwork network,
