...
public class SinglePhaseEightTerminalElementActivePower extends
EightTerminalElementConnector {
	...
	public SinglePhaseEightTerminalElementActivePower(FourWireNetwork network, EightTerminalElement element, Node node, int phase, int counterPhase, double value){
		super();
	...
	public double[] myJacobianRow(Complex[] assumedVoltages) {
		...
		for (int i=0;i<4;i++){
			// dP_12/de_1,X
			jacobianRow[2*4*startNodeIndex+2*i+0] += admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getReal()*assumedVoltages[4*startNodeIndex+this.myPhase].getReal();
			jacobianRow[2*4*startNodeIndex+2*i+0] += admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getImag()*assumedVoltages[4*startNodeIndex+this.myPhase].getImag();
			jacobianRow[2*4*startNodeIndex+2*i+0] += -admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getReal()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getReal();
			jacobianRow[2*4*startNodeIndex+2*i+0] += -admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getImag()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getImag();
			
			// dP_12/de_2,X
			jacobianRow[2*4*endNodeIndex+2*i+0] += admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getReal()*assumedVoltages[4*startNodeIndex+this.myPhase].getReal();
			jacobianRow[2*4*endNodeIndex+2*i+0] += admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getImag()*assumedVoltages[4*startNodeIndex+this.myPhase].getImag();
			jacobianRow[2*4*endNodeIndex+2*i+0] += -admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getReal()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getReal();
			jacobianRow[2*4*endNodeIndex+2*i+0] += -admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getImag()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getImag();

			// dP_12/df_1,X
			jacobianRow[2*4*startNodeIndex+2*i+1] += -admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getImag()*assumedVoltages[4*startNodeIndex+this.myPhase].getReal();
			jacobianRow[2*4*startNodeIndex+2*i+1] += admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getReal()*assumedVoltages[4*startNodeIndex+this.myPhase].getImag();
			jacobianRow[2*4*startNodeIndex+2*i+1] += admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getImag()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getReal();
			jacobianRow[2*4*startNodeIndex+2*i+1] += -admittanceMatrix[4*localStart+this.myPhase][4*localStart+i].getReal()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getImag();
			
			// dP_12/df_2,X
			jacobianRow[2*4*endNodeIndex+2*i+1] += -admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getImag()*assumedVoltages[4*startNodeIndex+this.myPhase].getReal();
			jacobianRow[2*4*endNodeIndex+2*i+1] += admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getReal()*assumedVoltages[4*startNodeIndex+this.myPhase].getImag();
			jacobianRow[2*4*endNodeIndex+2*i+1] += admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getImag()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getReal();
			jacobianRow[2*4*endNodeIndex+2*i+1] += -admittanceMatrix[4*localStart+this.myPhase][4*localEnd+i].getReal()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getImag();
		...
		temp += 2*admittanceMatrix[4*localStart+this.myPhase][4*localStart+this.myPhase].getReal()*assumedVoltages[4*startNodeIndex+this.myPhase].getReal();
		...
		temp += 2*admittanceMatrix[4*localStart+this.myPhase][4*localStart+this.myPhase].getReal()*assumedVoltages[4*startNodeIndex+this.myPhase].getImag();
		...
		temp += -2*admittanceMatrix[4*localStart+this.myPhase][4*localStart+this.myCounterPhase].getReal()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getReal();
		...
		temp += -2*admittanceMatrix[4*localStart+this.myPhase][4*localStart+this.myCounterPhase].getReal()*assumedVoltages[4*startNodeIndex+this.myCounterPhase].getImag();
