...
public final class StreamAdvertisementInstantiator implements AdvertisementFactory.Instantiator {
	/**
	...
	public String getAdvertisementType() {
		return StreamAdvertisement.getAdvertisementType();
	}
	...
	public Advertisement newInstance() {
		return new StreamAdvertisement();
	}

	@SuppressWarnings("rawtypes")
	@Override
	public Advertisement newInstance(Element root) {
		return new StreamAdvertisement(root);
	}
}
