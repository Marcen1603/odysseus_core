 ...
 * 
 */
public class HypothesisGenerationAO<M extends IProbability> extends
		BinaryLogicalOp {
	...
	public SDFAttributeList getOutputSchema() {
		...
		helper = new SchemaHelper(((SDFAttributeListExtended) this
				.getSubscribedToSource(LEFT).getSchema().clone()));
		SDFAttribute scannedObjects = helper.getAttribute(this.newObjListPath)
				.clone();
		// set new list name
		...
		// copy scanned Objects
		helper = new SchemaHelper(((SDFAttributeListExtended) this
				.getSubscribedToSource(RIGHT).getSchema().clone()));
