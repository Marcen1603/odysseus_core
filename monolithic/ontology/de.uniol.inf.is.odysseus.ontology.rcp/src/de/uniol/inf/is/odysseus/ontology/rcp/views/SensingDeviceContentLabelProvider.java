...
public class SensingDeviceContentLabelProvider extends AbstractViewLabelProvider {
    ...
    public String getText(final Object element) {
        if (element instanceof SensingDevice) {
            ...
            sb.append(sensingDevice.getName()).append(" [ns:").append(sensingDevice.getUri().getFragment()).append("]");
            return sb.toString();
        }
        else if (element instanceof FeatureOfInterest) {
            final FeatureOfInterest featureOfInterest = (FeatureOfInterest) element;
            final StringBuilder sb = new StringBuilder();
            sb.append(featureOfInterest.getName()).append(" [ns:").append(featureOfInterest.getUri().getFragment()).append("]");
            return sb.toString();
        }
        else if (element instanceof MeasurementCapability) {
            final MeasurementCapability measurementCapability = (MeasurementCapability) element;
            final StringBuilder sb = new StringBuilder();
            sb.append(measurementCapability.getName()).append(" [ns:").append(measurementCapability.getUri().getFragment()).append("]");
            return sb.toString();
        }
        else if (element instanceof Condition) {
            final Condition condition = (Condition) element;
            final StringBuilder sb = new StringBuilder();
            sb.append(String.format(condition.toString(), condition.getOnProperty().getName())).append(" [ns:").append(condition.getOnProperty().getUri().getFragment()).append("]");
            return sb.toString();
        }
        else if (element instanceof MeasurementProperty) {
            ...
            final StringBuilder sb = new StringBuilder();
            sb.append(property.getName()).append(" [ns:").append(property.getUri().getFragment()).append("]");
            return sb.toString();
        }
