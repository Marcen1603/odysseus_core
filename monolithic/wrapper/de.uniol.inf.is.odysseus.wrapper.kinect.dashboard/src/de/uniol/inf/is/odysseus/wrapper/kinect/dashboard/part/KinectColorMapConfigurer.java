...
public class KinectColorMapConfigurer extends AbstractDashboardPartConfigurer<KinectColorMapDashboardPart> {

	private KinectColorMapDashboardPart dashboardPart;

	@Override
	public void init(KinectColorMapDashboardPart dashboardPartToConfigure, Collection<IPhysicalOperator> roots ) {
