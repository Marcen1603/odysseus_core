...
public interface OdysseusWSPort {
    ...
    public java.lang.String createSource(
        ...
        SourceSchema sourceDescription
    ...
    @WebResult(name = "status", targetNamespace = "", partName = "status")
    @WebMethod(operationName = "CreateSourceString", action = "http://de.uni.ol.inf.is.odysseus/OdysseusWS/CreateSourceString")
    public java.lang.String createSourceString(
    ...
    ) throws CreateSourceStringFault;
}
