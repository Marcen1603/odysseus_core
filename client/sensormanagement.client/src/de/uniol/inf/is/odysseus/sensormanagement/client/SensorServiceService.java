 ...
 * 
 */
@WebServiceClient(name = "SensorServiceService", targetNamespace = "http://server.sensormanagement.odysseus.is.inf.uniol.de/", wsdlLocation = "http://localhost:9669/odysseus/sensormanagement?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SENSORSERVICESERVICE_QNAME = new QName("http://server.sensormanagement.odysseus.is.inf.uniol.de/", "SensorServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9669/odysseus/sensormanagement?wsdl");
    ...
    public SensorService getSensorServicePort() {
        return super.getPort(new QName("http://server.sensormanagement.odysseus.is.inf.uniol.de/", "SensorServicePort"), SensorService.class);
    }
    ...
    public SensorService getSensorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.sensormanagement.odysseus.is.inf.uniol.de/", "SensorServicePort"), SensorService.class, features);
    }
