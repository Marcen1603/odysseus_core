 ...
 * @version $Id: ColorWheelConfigurer.java | Fri Apr 10 23:28:57 2015 +0000 |
 *          ckuka $
 *
 */
public class ColorWheelConfigurer extends AbstractWheelDashboardPartConfigurer<ColorWheelDashboardPart> {
    ...
    protected void createPartControl(final ColorWheelDashboardPart dashboardPart, final FormToolkit toolkit, final ScrolledForm form) {
        ...
        {// Dot Settings
            ...
            section.setText("Color Settings");
