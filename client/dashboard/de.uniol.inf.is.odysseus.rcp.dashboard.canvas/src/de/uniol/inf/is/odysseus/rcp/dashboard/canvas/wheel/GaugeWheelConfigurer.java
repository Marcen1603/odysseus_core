 ...
 * @version $Id: GaugeWheelConfigurer.java | Fri Apr 10 23:28:57 2015 +0000 |
 *          ckuka $
 *
 */
public class GaugeWheelConfigurer extends AbstractWheelDashboardPartConfigurer<GaugeWheelDashboardPart> {

    /**
     * {@inheritDoc}
     */
    @Override
    protected void createPartControl(@SuppressWarnings("hiding") final GaugeWheelDashboardPart dashboardPart, final FormToolkit toolkit, final ScrolledForm form) {
        ...
        {// Gauge Settings
            ...
            section.setText("Gauge Settings");
            ...
            {// Gauge color
                ...
                gaugeColorButton.addSelectionListener(new SelectionAdapter() {
                    ...
                    public void widgetSelected(final SelectionEvent e) {
                        ...
                        GaugeWheelConfigurer.this.getDashboardPart().setGaugeColor(new RGB(selectedColor.red, selectedColor.green, selectedColor.blue));
                    }
                });
            }
