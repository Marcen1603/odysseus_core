...
/**
 * <p>Java-Klasse f�r getDataHandlerValuesResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getDataHandlerValuesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getDataHandlerValuesResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetDataHandlerValuesResponse {
