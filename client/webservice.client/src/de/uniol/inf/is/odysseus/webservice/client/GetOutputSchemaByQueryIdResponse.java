...
/**
 * <p>Java-Klasse f�r getOutputSchemaByQueryIdResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getOutputSchemaByQueryIdResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getOutputSchemaByQueryIdResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetOutputSchemaByQueryIdResponse {
