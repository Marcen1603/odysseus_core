...
public class ConnectionReconnectCommand extends Command {
	...
	private OperatorNode oldSourceNode;
	private OperatorNode oldTargetNode;
	private OperatorNode newSourceNode;
	private OperatorNode newTargetNode;
	...
	public void setNewSourceNode(OperatorNode sourceNode) {
		if (sourceNode == null) {
			throw new IllegalArgumentException();
		}
	...
	public void setNewTargetNode(OperatorNode targetNode) {
		if (targetNode == null) {
			throw new IllegalArgumentException();
		}
