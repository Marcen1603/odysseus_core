...
public class MeasurementCapabiltyDialog extends Dialog {
     ...
     * @param parentShell
     */
    public MeasurementCapabiltyDialog(final Shell parent, final URI uri, final SDFAttribute attribute) {
        super(parent);
    ...
    protected Control createDialogArea(final Composite parent) {
        ...
        gd = new GridData();
        final int lblForConditionWidth = lblForCondition.computeSize(SWT.DEFAULT, SWT.DEFAULT).x;
        gd.horizontalSpan = 2;
        ...
        this.cmbForProperty = new Combo(container, SWT.VERTICAL | SWT.DROP_DOWN | SWT.BORDER | SWT.READ_ONLY);
        gd = new GridData();
        final int cmbForPropertyWidth = this.cmbForProperty.computeSize(SWT.DEFAULT, SWT.DEFAULT).x;
        gd.horizontalSpan = 2;
        gd.widthHint = Math.min(cmbForPropertyWidth, maxWidth);
        gd.horizontalAlignment = GridData.FILL;
        gd.grabExcessHorizontalSpace = true;
        this.cmbForProperty.setLayoutData(gd);
        ...
        this.cmbConditionProperty = new Combo(container, SWT.VERTICAL | SWT.DROP_DOWN | SWT.BORDER | SWT.READ_ONLY);
        gd = new GridData();
        final int cmbConditionPropertyWidth = this.cmbConditionProperty.computeSize(SWT.DEFAULT, SWT.DEFAULT).x;
        gd.horizontalSpan = 2;
        gd.widthHint = Math.min(cmbConditionPropertyWidth, maxWidth);
        gd.horizontalAlignment = GridData.FILL;
        gd.grabExcessHorizontalSpace = true;
        this.cmbConditionProperty.setLayoutData(gd);
        ...
        gd = new GridData();
        final int txtAttributeFunctionWidth = this.txtConditionExpression.computeSize(SWT.DEFAULT, SWT.DEFAULT).x;
        gd.horizontalSpan = 2;
        gd.widthHint = Math.min(txtAttributeFunctionWidth, maxWidth);
        gd.horizontalAlignment = GridData.FILL;
        gd.grabExcessHorizontalSpace = true;
        this.txtConditionExpression.setLayoutData(gd);
        // txtConditionExpression.setVisible(false);
        // txtConditionExpression.setEnabled(false);
        ...
        gd = new GridData();
        final int cmbMeasurementPropertyWidth = this.cmbMeasurementProperty.computeSize(SWT.DEFAULT, SWT.DEFAULT).x;
        gd.horizontalSpan = 2;
        ...
        gd = new GridData();
        final int txtMeasurementPropertyValueMinWidth = this.txtMeasurementPropertyExpression.computeSize(SWT.DEFAULT, SWT.DEFAULT).x;
        gd.horizontalSpan = 2;
        gd.widthHint = Math.min(txtMeasurementPropertyValueMinWidth, maxWidth);
        gd.horizontalAlignment = GridData.FILL;
        gd.grabExcessHorizontalSpace = true;
        this.txtMeasurementPropertyExpression.setLayoutData(gd);
    ...
    private void saveInput() {
        this.property = (Property) this.cmbForProperty.getData(this.cmbForProperty.getItem(this.cmbForProperty.getSelectionIndex()));

        final Property conditionProperty = (Property) this.cmbConditionProperty.getData(this.cmbConditionProperty.getItem(this.cmbConditionProperty.getSelectionIndex()));
        // if (this.txtConditionExpression.isEnabled()) {
        final String attributeFunction = this.txtConditionExpression.getText();
        this.condition = new ExpressionCondition(URI.create(this.uri + "/" + conditionProperty.getName()), conditionProperty, attributeFunction);
        // } else {
        ...
        final SSNMeasurementProperty measurementProperty = (SSNMeasurementProperty) this.cmbMeasurementProperty.getData(this.cmbMeasurementProperty.getItem(this.cmbMeasurementProperty
                .getSelectionIndex()));
        final String measurementPropertyExpression = this.txtMeasurementPropertyExpression.getText();

        this.measurementPropery = new MeasurementProperty(URI.create(this.uri + "/" + conditionProperty.getName() + "/" + measurementProperty.name()), measurementProperty.getResource(),
