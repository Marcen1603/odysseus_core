 ...
 * 
 */
public abstract class AbstractHistogramSeriesChart extends AbstractJFreeChart<Double, ITimeInterval> {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractHistogramSeriesChart.class);
    ...
    protected DynamicHistogramDataset dataset = new DynamicHistogramDataset();
    ...
    private int binCount = DEFAULT_BINS;
    private String histogramType = HistogramType.FREQUENCY.toString();
    ...
    public void reloadChart() {
        ...
        this.dataset.setBinCount(binCount);
        if (this.histogramType.equalsIgnoreCase(HistogramType.SCALE_AREA_TO_1.toString())) {
            this.dataset.setType(HistogramType.SCALE_AREA_TO_1);
        }
        else if (this.histogramType.equalsIgnoreCase(HistogramType.RELATIVE_FREQUENCY.toString())) {
        ...
        getChart().getXYPlot().getRangeAxis().setLowerBound(0.0);
    ...
    @ChartSetting(name = "Value for time", type = Type.OPTIONS)
    ...
    @ChartSetting(name = "Value for time", type = Type.GET)
    ...
    @ChartSetting(name = "Value for time", type = Type.SET)
    ...
    @ChartSetting(name = "Type of histogram", type = Type.OPTIONS)
    public List<String> getHistogramTypeValues() {
        return getHistogramTypeNamesValues();
    }

    private List<String> getHistogramTypeNamesValues() {
        List<String> values = new ArrayList<String>();
        values.add(HistogramType.FREQUENCY.toString());
        values.add(HistogramType.RELATIVE_FREQUENCY.toString());
        values.add(HistogramType.SCALE_AREA_TO_1.toString());
        return values;
    }

    @ChartSetting(name = "Type of histogram", type = Type.GET)
    public String getHistogramTypeValue() {
        return this.histogramType;
    }

    @ChartSetting(name = "Type of histogram", type = Type.SET)
    public void setHistogramTypeValue(String value) {
    ...
    @ChartSetting(name = "Number of bins", type = Type.SET)
    public void setBinCount(int binCount) {
        this.binCount = binCount;
    }

    @ChartSetting(name = "Number of bins", type = Type.GET)
