...
import de.uniol.inf.is.odysseus.rest2.client.auth.ApiKeyAuth;
import de.uniol.inf.is.odysseus.rest2.client.auth.Authentication;
import de.uniol.inf.is.odysseus.rest2.client.auth.HttpBasicAuth;
import de.uniol.inf.is.odysseus.rest2.client.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-03-20T13:34:31.291+01:00")
public class RestService {
	public static final String HTTP_BASIC_AUTH = "HttpBasicAuth";
	...
	public RestService() {
		...
		authentications.put(O_AUTH, new OAuth());
		// Back fall: use login and password
		authentications.put(HTTP_BASIC_AUTH, new HttpBasicAuth());
	...
	public RestService setHttpClient(Client httpClient) {
	...
	public RestService setBasePath(String basePath) {
	 ...
	 * @return API client
	 */
	public RestService setUserAgent(String userAgent) {
	 ...
	 * @return API client
	 */
	public RestService addDefaultHeader(String key, String value) {
	 ...
	 * @return API client
	 */
	public RestService setDebugging(boolean debugging) {
	 ...
	 * @return API client
	 */
	public RestService setTempFolderPath(String tempFolderPath) {
	 ...
	 * @return API client
	 */
	public RestService setConnectTimeout(int connectionTimeout) {
	 ...
	 * @return API client
	 */
	public RestService setDateFormat(DateFormat dateFormat) {
	...
	public <T> T invokeAPI(String path, String method, List<Pair> queryParams, Object body,
		...
		// if (entry.getValue() instanceof HttpBasicAuth) {
		// HttpBasicAuth bauth = ((HttpBasicAuth)entry.getValue());
		// invocationBuilder =
		// target.request().property(HttpAuthenticationFeature.HTTP_AUTHENTICATION_BASIC_USERNAME,
		// bauth.getUsername())
