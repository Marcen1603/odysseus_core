...
import de.uniol.inf.is.odysseus.rest2.client.api.auth.ApiKeyAuth;
import de.uniol.inf.is.odysseus.rest2.client.api.auth.Authentication;
import de.uniol.inf.is.odysseus.rest2.client.api.auth.HttpBasicAuth;
import okhttp3.Call;
...
public class ApiClient {
	...
	private String basePath = Configuration.getBasePath();
	...
	/*
	 * s Basic constructor for ApiClient
	 */
	public ApiClient() {
		init();
		...
		this.authentications.put("HttpBasicAuth", new HttpBasicAuth());
	...
	public ApiClient setReadTimeout(int readTimeout) {
		this.httpClient = this.httpClient.newBuilder().readTimeout(readTimeout, TimeUnit.MILLISECONDS).build();
		return this;
	}
	...
	public ApiClient setWriteTimeout(int writeTimeout) {
		this.httpClient = this.httpClient.newBuilder().writeTimeout(writeTimeout, TimeUnit.MILLISECONDS).build();
		return this;
	}
	...
	public String parameterToString(Object param) {
		if (param == null) {
			...
			final String jsonStr = this.json.serialize(param);
	...
	public Call buildCall(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams,
		...
		final Request request = buildRequest(path, method, queryParams, collectionQueryParams, body, headerParams,
	...
	public void processHeaderParams(Map<String, String> headerParams, Request.Builder reqBuilder) {
		...
		for (final Entry<String, String> header : this.defaultHeaderMap.entrySet()) {
		...
		try {
			...
			if (!this.verifyingSsl) {
				...
				final Collection<? extends Certificate> certificates = certificateFactory
						.generateCertificates(this.sslCaCert);
			...
			if (this.keyManagers != null || trustManagers != null) {
				...
				this.httpClient = this.httpClient.newBuilder()
						.sslSocketFactory(null, (X509TrustManager) trustManagers[0]).build();
			}
