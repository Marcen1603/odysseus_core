 ...
 * generated by Xtext
 */
package de.uniol.inf.is.odysseus.server.ui.contentassist.antlr;
...
public class StreamingsparqlParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.uniol.inf.is.odysseus.server.ui.contentassist.antlr.internal.InternalStreamingsparqlParser createParser() {
		de.uniol.inf.is.odysseus.server.ui.contentassist.antlr.internal.InternalStreamingsparqlParser result = new de.uniol.inf.is.odysseus.server.ui.contentassist.antlr.internal.InternalStreamingsparqlParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSelectQueryAccess().getAlternatives_5(), "rule__SelectQuery__Alternatives_5");
					...
					put(grammarAccess.getDatasetClauseAccess().getGroup_4_4(), "rule__DatasetClause__Group_4_4__0");
					...
					put(grammarAccess.getSelectQueryAccess().getIsDistinctAssignment_5_0(), "rule__SelectQuery__IsDistinctAssignment_5_0");
					put(grammarAccess.getSelectQueryAccess().getIsReducedAssignment_5_1(), "rule__SelectQuery__IsReducedAssignment_5_1");
					put(grammarAccess.getSelectQueryAccess().getVariablesAssignment_6(), "rule__SelectQuery__VariablesAssignment_6");
					put(grammarAccess.getSelectQueryAccess().getVariablesAssignment_7(), "rule__SelectQuery__VariablesAssignment_7");
					put(grammarAccess.getSelectQueryAccess().getWhereClauseAssignment_8(), "rule__SelectQuery__WhereClauseAssignment_8");
					put(grammarAccess.getSelectQueryAccess().getFilterclauseAssignment_9(), "rule__SelectQuery__FilterclauseAssignment_9");
					put(grammarAccess.getSelectQueryAccess().getAggregateClauseAssignment_10(), "rule__SelectQuery__AggregateClauseAssignment_10");
					put(grammarAccess.getSelectQueryAccess().getFilesinkclauseAssignment_11(), "rule__SelectQuery__FilesinkclauseAssignment_11");
					put(grammarAccess.getAggregateAccess().getAggregationsAssignment_1_1(), "rule__Aggregate__AggregationsAssignment_1_1");
					put(grammarAccess.getAggregateAccess().getGroupbyAssignment_2_1(), "rule__Aggregate__GroupbyAssignment_2_1");
					...
					put(grammarAccess.getDatasetClauseAccess().getTypeAssignment_4_1(), "rule__DatasetClause__TypeAssignment_4_1");
					put(grammarAccess.getDatasetClauseAccess().getSizeAssignment_4_3(), "rule__DatasetClause__SizeAssignment_4_3");
					put(grammarAccess.getDatasetClauseAccess().getAdvanceAssignment_4_4_1(), "rule__DatasetClause__AdvanceAssignment_4_4_1");
					put(grammarAccess.getDatasetClauseAccess().getUnitAssignment_4_5_1(), "rule__DatasetClause__UnitAssignment_4_5_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.uniol.inf.is.odysseus.server.ui.contentassist.antlr.internal.InternalStreamingsparqlParser typedParser = (de.uniol.inf.is.odysseus.server.ui.contentassist.antlr.internal.InternalStreamingsparqlParser) parser;
