...
public final class HorizontalSugiyamaPositioner implements INodePositioner<IPhysicalOperator> {
	...
	private static int getMedian(INodeView<IPhysicalOperator> node, List<INodeView<IPhysicalOperator>> fixedLayerNodes,
			boolean fromTop) {
