...
public class ClientSession  extends AbstractSession implements ISession {


	private static final long serialVersionUID = 3523363132440028382L;
	private String tenantName;

	public ClientSession(final IUser user, final String tenant, final String connection) {
		super(user, null);
