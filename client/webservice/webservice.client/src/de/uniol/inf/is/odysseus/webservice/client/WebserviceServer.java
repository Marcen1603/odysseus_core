...
public interface WebserviceServer {
    ...
    @Action(input = "http://webservice.server.webservice.executor.planmanagement.odysseus.is.inf.uniol.de/WebserviceServer/getNameRequest", output = "http://webservice.server.webservice.executor.planmanagement.odysseus.is.inf.uniol.de/WebserviceServer/getNameResponse", fault = {
        @FaultAction(className = InvalidUserDataException_Exception.class, value = "http://webservice.server.webservice.executor.planmanagement.odysseus.is.inf.uniol.de/WebserviceServer/getName/Fault/InvalidUserDataException")
    })
    ...
    @Action(input = "http://webservice.server.webservice.executor.planmanagement.odysseus.is.inf.uniol.de/WebserviceServer/getOutputSchemaRequest", output = "http://webservice.server.webservice.executor.planmanagement.odysseus.is.inf.uniol.de/WebserviceServer/getOutputSchemaResponse", fault = {
        @FaultAction(className = InvalidUserDataException_Exception.class, value = "http://webservice.server.webservice.executor.planmanagement.odysseus.is.inf.uniol.de/WebserviceServer/getOutputSchema/Fault/InvalidUserDataException"),
        @FaultAction(className = QueryNotExistsException_Exception.class, value = "http://webservice.server.webservice.executor.planmanagement.odysseus.is.inf.uniol.de/WebserviceServer/getOutputSchema/Fault/QueryNotExistsException")
    })
