...
/**
 * <p>Java-Klasse f�r containsStoredProceduresResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="containsStoredProceduresResponse">
 *   &lt;complexContent>
...
@XmlType(name = "containsStoredProceduresResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class ContainsStoredProceduresResponse {
