...
/**
 * <p>Java-Klasse f�r containsViewOrStreamByResourceResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="containsViewOrStreamByResourceResponse">
 *   &lt;complexContent>
...
@XmlType(name = "containsViewOrStreamByResourceResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class ContainsViewOrStreamByResourceResponse {
