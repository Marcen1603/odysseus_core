...
/**
 * <p>Java-Klasse f�r reloadStoredQueriesResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="reloadStoredQueriesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "reloadStoredQueriesResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class ReloadStoredQueriesResponse {
