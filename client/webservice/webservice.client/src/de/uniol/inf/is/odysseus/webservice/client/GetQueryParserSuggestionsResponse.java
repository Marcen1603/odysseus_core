...
/**
 * <p>Java-Klasse f�r getQueryParserSuggestionsResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getQueryParserSuggestionsResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getQueryParserSuggestionsResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetQueryParserSuggestionsResponse {
