...
/**
 * <p>Java-Klasse f�r resumeQueryResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="resumeQueryResponse">
 *   &lt;complexContent>
...
@XmlType(name = "resumeQueryResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class ResumeQueryResponse {
