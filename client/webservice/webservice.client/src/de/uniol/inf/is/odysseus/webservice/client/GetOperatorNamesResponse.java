...
/**
 * <p>Java-Klasse f�r getOperatorNamesResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getOperatorNamesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getOperatorNamesResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetOperatorNamesResponse {
