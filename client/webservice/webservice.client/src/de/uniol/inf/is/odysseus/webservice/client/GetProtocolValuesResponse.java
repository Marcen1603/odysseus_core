...
/**
 * <p>Java-Klasse f�r getProtocolValuesResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getProtocolValuesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getProtocolValuesResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetProtocolValuesResponse {
