...
/**
 * <p>Java-Klasse f�r removeViewOrStreamByNameResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="removeViewOrStreamByNameResponse">
 *   &lt;complexContent>
...
@XmlType(name = "removeViewOrStreamByNameResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class RemoveViewOrStreamByNameResponse {
