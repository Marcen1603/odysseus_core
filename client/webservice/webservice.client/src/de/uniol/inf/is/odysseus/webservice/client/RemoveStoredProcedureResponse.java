...
/**
 * <p>Java-Klasse f�r removeStoredProcedureResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="removeStoredProcedureResponse">
 *   &lt;complexContent>
...
@XmlType(name = "removeStoredProcedureResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class RemoveStoredProcedureResponse {
