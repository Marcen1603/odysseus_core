...
/**
 * <p>Java-Klasse f�r getWindowTypesResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getWindowTypesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getWindowTypesResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetWindowTypesResponse {
