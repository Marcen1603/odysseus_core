...
/**
 * <p>Java-Klasse f�r getTransportValuesResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getTransportValuesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getTransportValuesResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class GetTransportValuesResponse {
