...
/**
 * <p>Java-Klasse f�r suspendQueryResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="suspendQueryResponse">
 *   &lt;complexContent>
...
@XmlType(name = "suspendQueryResponse", propOrder = {
    "_return"
})
@SuppressWarnings(value = { "all" })
public class SuspendQueryResponse {
