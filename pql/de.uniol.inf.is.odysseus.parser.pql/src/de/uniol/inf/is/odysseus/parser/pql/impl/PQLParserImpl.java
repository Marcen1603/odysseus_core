...
public class PQLParserImpl implements PQLParserImplConstants {
  ...
  static final public ILogicalOperator query() throws ParseException {
  ...
  ILogicalOperator result;
    ...
    jj_consume_token(17);
    result = operator(namedOps);
    {if (true) return result;}
    throw new Error("Missing return statement in function");
  }

  static final public void namedOperator(Map < String, ILogicalOperator > namedOps) throws ParseException {
  Token name;
  ILogicalOperator op;
  ...
  static final public Map<String, Object > parameterList() throws ParseException {
  Map<String, Object > parameters = new HashMap< String, Object> ();
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x40,0x80000,0x40,0x200000,0xc200,0x200000,0x40,};
   }
